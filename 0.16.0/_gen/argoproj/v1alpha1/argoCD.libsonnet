{
  ...
  spec: {
    ...
    argoCDAgent: {
      ...
      principal: {
        '#withAllowedNamespaces':: d.fn(help='"AllowedNamespaces is the list of namespaces that the Principal component is allowed to access."', args=[d.arg(name='allowedNamespaces', type=d.T.array)]),
        withAllowedNamespaces(allowedNamespaces): { spec+: { argoCDAgent+: { principal+: { allowedNamespaces: if std.isArray(v=allowedNamespaces) then allowedNamespaces else [allowedNamespaces] } } } },
        '#withAllowedNamespacesMixin':: d.fn(help='"AllowedNamespaces is the list of namespaces that the Principal component is allowed to access."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='allowedNamespaces', type=d.T.array)]),
        withAllowedNamespacesMixin(allowedNamespaces): { spec+: { argoCDAgent+: { principal+: { allowedNamespaces+: if std.isArray(v=allowedNamespaces) then allowedNamespaces else [allowedNamespaces] } } } },
        ...
        '#withJwtAllowGenerate':: d.fn(help='"JWTAllowGenerate is the flag to enable the JWT generation during Argo CD installation."', args=[d.arg(name='jwtAllowGenerate', type=d.T.boolean)]),
        withJwtAllowGenerate(jwtAllowGenerate): { spec+: { argoCDAgent+: { principal+: { jwtAllowGenerate: jwtAllowGenerate } } } },
        '#withLogLevel':: d.fn(help='"LogLevel refers to the log level used by the Principal component. Defaults to info if not configured. Valid options are debug, info, trace, error, and warn."', args=[d.arg(name='logLevel', type=d.T.string)]),
