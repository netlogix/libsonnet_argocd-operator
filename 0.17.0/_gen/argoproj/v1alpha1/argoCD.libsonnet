{
  ...
  spec: {
    ...
    applicationSet: {
      ...
      webhookServer: {
        ...
        route: {
          ...
          tls: {
            ...
            externalCertificate: {
              '#withName':: d.fn(help='"name of the referent.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
              withName(name): { spec+: { applicationSet+: { webhookServer+: { route+: { tls+: { externalCertificate+: { name: name } } } } } } },
            },
      ...
      '#withLogFormat':: d.fn(help='"LogFormat refers to the log format used by the ApplicationSet component. Defaults to ArgoCDDefaultLogFormat if not configured. Valid options are text or json."', args=[d.arg(name='logFormat', type=d.T.string)]),
      withLogFormat(logFormat): { spec+: { applicationSet+: { logFormat: logFormat } } },
    ...
    '#argoCDAgent':: d.obj(help='"ArgoCDAgent defines configurations for the ArgoCD Agent component."'),
    argoCDAgent: {
      '#agent':: d.obj(help='"Agent defines configurations for the Agent component of Argo CD Agent."'),
      agent: {
        '#client':: d.obj(help='"Client defines the client options for the Agent component."'),
        client: {
          '#withEnableCompression':: d.fn(help='"EnableCompression is the flag to enable compression while sending data between Principal and Agent using gRPC"', args=[d.arg(name='enableCompression', type=d.T.boolean)]),
          withEnableCompression(enableCompression): { spec+: { argoCDAgent+: { agent+: { client+: { enableCompression: enableCompression } } } } },
          '#withEnableWebSocket':: d.fn(help='"EnableWebSocket is the flag to enable WebSocket for event streaming"', args=[d.arg(name='enableWebSocket', type=d.T.boolean)]),
          withEnableWebSocket(enableWebSocket): { spec+: { argoCDAgent+: { agent+: { client+: { enableWebSocket: enableWebSocket } } } } },
          '#withKeepAliveInterval':: d.fn(help='"KeepAliveInterval is the interval for keep-alive pings to the principal"', args=[d.arg(name='keepAliveInterval', type=d.T.string)]),
          withKeepAliveInterval(keepAliveInterval): { spec+: { argoCDAgent+: { agent+: { client+: { keepAliveInterval: keepAliveInterval } } } } },
          '#withMode':: d.fn(help='"Mode is the operational mode for the agent (managed or autonomous)"', args=[d.arg(name='mode', type=d.T.string)]),
          withMode(mode): { spec+: { argoCDAgent+: { agent+: { client+: { mode: mode } } } } },
          '#withPrincipalServerAddress':: d.fn(help='"PrincipalServerAddress is the remote address of the principal server to connect to."', args=[d.arg(name='principalServerAddress', type=d.T.string)]),
          withPrincipalServerAddress(principalServerAddress): { spec+: { argoCDAgent+: { agent+: { client+: { principalServerAddress: principalServerAddress } } } } },
          '#withPrincipalServerPort':: d.fn(help='"PrincipalServerPort is the remote port of the principal server to connect to."', args=[d.arg(name='principalServerPort', type=d.T.string)]),
          withPrincipalServerPort(principalServerPort): { spec+: { argoCDAgent+: { agent+: { client+: { principalServerPort: principalServerPort } } } } },
        },
        '#env':: d.obj(help='"Env lets you specify environment for agent pods"'),
        env: {
          '#valueFrom':: d.obj(help="\"Source for the environment variable's value. Cannot be used if value is not empty.\""),
          valueFrom: {
            '#configMapKeyRef':: d.obj(help='"Selects a key of a ConfigMap."'),
        ...
        '#redis':: d.obj(help='"Redis defines the Redis options for the Agent component."'),
        redis: {
          '#withServerAddress':: d.fn(help='"ServerAddress is the address of the Redis server to be used by the PrincAgentipal component."', args=[d.arg(name='serverAddress', type=d.T.string)]),
          withServerAddress(serverAddress): { spec+: { argoCDAgent+: { agent+: { redis+: { serverAddress: serverAddress } } } } },
        },
        '#tls':: d.obj(help='"TLS defines the TLS options for the Agent component."'),
        tls: {
          '#withInsecure':: d.fn(help='"Insecure is the flag to skip TLS certificate validation when connecting to the principal (insecure, for development only)"', args=[d.arg(name='insecure', type=d.T.boolean)]),
          withInsecure(insecure): { spec+: { argoCDAgent+: { agent+: { tls+: { insecure: insecure } } } } },
          '#withRootCASecretName':: d.fn(help='"RootCASecretName is the name of the secret containing the root CA certificate"', args=[d.arg(name='rootCASecretName', type=d.T.string)]),
          withRootCASecretName(rootCASecretName): { spec+: { argoCDAgent+: { agent+: { tls+: { rootCASecretName: rootCASecretName } } } } },
          '#withSecretName':: d.fn(help='"SecretName is the name of the secret containing the agent client TLS certificate"', args=[d.arg(name='secretName', type=d.T.string)]),
          withSecretName(secretName): { spec+: { argoCDAgent+: { agent+: { tls+: { secretName: secretName } } } } },
        },
        '#withCreds':: d.fn(help='"Creds is the credential identifier for the agent authentication"', args=[d.arg(name='creds', type=d.T.string)]),
        withCreds(creds): { spec+: { argoCDAgent+: { agent+: { creds: creds } } } },
        '#withEnabled':: d.fn(help='"Enabled is the flag to enable the Agent component during Argo CD installation. (optional, default `false`)"', args=[d.arg(name='enabled', type=d.T.boolean)]),
        withEnabled(enabled): { spec+: { argoCDAgent+: { agent+: { enabled: enabled } } } },
        '#withEnv':: d.fn(help='"Env lets you specify environment for agent pods"', args=[d.arg(name='env', type=d.T.array)]),
        withEnv(env): { spec+: { argoCDAgent+: { agent+: { env: if std.isArray(v=env) then env else [env] } } } },
        '#withEnvMixin':: d.fn(help='"Env lets you specify environment for agent pods"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='env', type=d.T.array)]),
        withEnvMixin(env): { spec+: { argoCDAgent+: { agent+: { env+: if std.isArray(v=env) then env else [env] } } } },
        '#withImage':: d.fn(help='"Image is the name of Argo CD Agent image"', args=[d.arg(name='image', type=d.T.string)]),
        withImage(image): { spec+: { argoCDAgent+: { agent+: { image: image } } } },
        '#withLogFormat':: d.fn(help='"LogFormat refers to the log format used by the Agent component."', args=[d.arg(name='logFormat', type=d.T.string)]),
        withLogFormat(logFormat): { spec+: { argoCDAgent+: { agent+: { logFormat: logFormat } } } },
        '#withLogLevel':: d.fn(help='"LogLevel refers to the log level used by the Agent component."', args=[d.arg(name='logLevel', type=d.T.string)]),
        withLogLevel(logLevel): { spec+: { argoCDAgent+: { agent+: { logLevel: logLevel } } } },
      },
      '#principal':: d.obj(help='"Principal defines configurations for the Principal component of Argo CD Agent."'),
      principal: {
        '#env':: d.obj(help='"Env lets you specify environment for principal pods"'),
        env: {
          '#valueFrom':: d.obj(help="\"Source for the environment variable's value. Cannot be used if value is not empty.\""),
          valueFrom: {
            '#configMapKeyRef':: d.obj(help='"Selects a key of a ConfigMap."'),
        ...
        '#jwt':: d.obj(help='"JWT defines the JWT options for the Principal component."'),
        jwt: {
          '#withInsecureGenerate':: d.fn(help='"InsecureGenerate is the flag to allow the principal to generate its own private key for signing JWT tokens (insecure)."', args=[d.arg(name='insecureGenerate', type=d.T.boolean)]),
          withInsecureGenerate(insecureGenerate): { spec+: { argoCDAgent+: { principal+: { jwt+: { insecureGenerate: insecureGenerate } } } } },
          '#withSecretName':: d.fn(help='"SecretName is the name of the secret containing the JWT signing key."', args=[d.arg(name='secretName', type=d.T.string)]),
          withSecretName(secretName): { spec+: { argoCDAgent+: { principal+: { jwt+: { secretName: secretName } } } } },
        },
        '#namespace':: d.obj(help='"Namespace is the configuration for the Principal component namespace."'),
        namespace: {
          '#withAllowedNamespaces':: d.fn(help='"AllowedNamespaces is a list of namespaces the principal shall watch and process Argo CD resources in."', args=[d.arg(name='allowedNamespaces', type=d.T.array)]),
          withAllowedNamespaces(allowedNamespaces): { spec+: { argoCDAgent+: { principal+: { namespace+: { allowedNamespaces: if std.isArray(v=allowedNamespaces) then allowedNamespaces else [allowedNamespaces] } } } } },
          '#withAllowedNamespacesMixin':: d.fn(help='"AllowedNamespaces is a list of namespaces the principal shall watch and process Argo CD resources in."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='allowedNamespaces', type=d.T.array)]),
          withAllowedNamespacesMixin(allowedNamespaces): { spec+: { argoCDAgent+: { principal+: { namespace+: { allowedNamespaces+: if std.isArray(v=allowedNamespaces) then allowedNamespaces else [allowedNamespaces] } } } } },
          '#withEnableNamespaceCreate':: d.fn(help='"EnableNamespaceCreate is the flag to enable namespace creation for agents."', args=[d.arg(name='enableNamespaceCreate', type=d.T.boolean)]),
          withEnableNamespaceCreate(enableNamespaceCreate): { spec+: { argoCDAgent+: { principal+: { namespace+: { enableNamespaceCreate: enableNamespaceCreate } } } } },
          '#withNamespaceCreateLabels':: d.fn(help='"NamespaceCreateLabels is the set of labels to apply to namespaces created for agents. Ex: \\"foo=bar,bar=baz\\', args=[d.arg(name='namespaceCreateLabels', type=d.T.array)]),
          withNamespaceCreateLabels(namespaceCreateLabels): { spec+: { argoCDAgent+: { principal+: { namespace+: { namespaceCreateLabels: if std.isArray(v=namespaceCreateLabels) then namespaceCreateLabels else [namespaceCreateLabels] } } } } },
          '#withNamespaceCreateLabelsMixin':: d.fn(help='"NamespaceCreateLabels is the set of labels to apply to namespaces created for agents. Ex: \\"foo=bar,bar=baz\\\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='namespaceCreateLabels', type=d.T.array)]),
          withNamespaceCreateLabelsMixin(namespaceCreateLabels): { spec+: { argoCDAgent+: { principal+: { namespace+: { namespaceCreateLabels+: if std.isArray(v=namespaceCreateLabels) then namespaceCreateLabels else [namespaceCreateLabels] } } } } },
          '#withNamespaceCreatePattern':: d.fn(help='"NamespaceCreatePattern is a regexp pattern to restrict the names of namespaces to be created."', args=[d.arg(name='namespaceCreatePattern', type=d.T.string)]),
          withNamespaceCreatePattern(namespaceCreatePattern): { spec+: { argoCDAgent+: { principal+: { namespace+: { namespaceCreatePattern: namespaceCreatePattern } } } } },
        },
        '#redis':: d.obj(help='"Redis defines the Redis options for the Principal component."'),
        redis: {
          '#withCompressionType':: d.fn(help='"CompressionType is the compression type to be used by Redis."', args=[d.arg(name='compressionType', type=d.T.string)]),
          withCompressionType(compressionType): { spec+: { argoCDAgent+: { principal+: { redis+: { compressionType: compressionType } } } } },
          '#withServerAddress':: d.fn(help='"ServerAddress is the address of the Redis server to be used by the Principal component."', args=[d.arg(name='serverAddress', type=d.T.string)]),
          withServerAddress(serverAddress): { spec+: { argoCDAgent+: { principal+: { redis+: { serverAddress: serverAddress } } } } },
        },
        '#resourceProxy':: d.obj(help='"ResourceProxy defines the Resource Proxy options for the Principal component."'),
        resourceProxy: {
          '#withCaSecretName':: d.fn(help='"CASecretName is the name of the secret containing the CA certificate for the resource proxy."', args=[d.arg(name='caSecretName', type=d.T.string)]),
          withCaSecretName(caSecretName): { spec+: { argoCDAgent+: { principal+: { resourceProxy+: { caSecretName: caSecretName } } } } },
          '#withSecretName':: d.fn(help='"SecretName is the name of the secret containing the TLS certificate and key for the resource proxy."', args=[d.arg(name='secretName', type=d.T.string)]),
          withSecretName(secretName): { spec+: { argoCDAgent+: { principal+: { resourceProxy+: { secretName: secretName } } } } },
        },
        '#server':: d.obj(help='"Server defines the server options for the Principal component."'),
        server: {
          '#route':: d.obj(help='"Route defines the options for the Route backing the ArgoCD Agent component.\\nRoute is disabled only when explicitly configured with Enabled: false"'),
          route: {
            '#withEnabled':: d.fn(help='"Enabled will toggle the creation of the OpenShift Route, ignored in case of non OpenShift cluster.\\nRoute is disabled only when explicitly configured with false"', args=[d.arg(name='enabled', type=d.T.boolean)]),
            withEnabled(enabled): { spec+: { argoCDAgent+: { principal+: { server+: { route+: { enabled: enabled } } } } } },
          },
          '#service':: d.obj(help='"Service defines the options for the Service backing the ArgoCD Agent component.\\nIf not set, type ClusterIP will be used by default."'),
          service: {
            '#withType':: d.fn(help='"Type is the ServiceType to use for the Service resource.\\nIf not set, type ClusterIP will be used by default."', args=[d.arg(name='type', type=d.T.string)]),
            withType(type): { spec+: { argoCDAgent+: { principal+: { server+: { service+: { type: type } } } } } },
          },
          '#withEnableWebSocket':: d.fn(help='"EnableWebSocket is the flag to enable the WebSocket on gRPC to stream events to the Agent."', args=[d.arg(name='enableWebSocket', type=d.T.boolean)]),
          withEnableWebSocket(enableWebSocket): { spec+: { argoCDAgent+: { principal+: { server+: { enableWebSocket: enableWebSocket } } } } },
          '#withKeepAliveMinInterval':: d.fn(help='"KeepAliveMinInterval is the minimum interval between keep-alive messages sent by the Agent to the Principal."', args=[d.arg(name='keepAliveMinInterval', type=d.T.string)]),
          withKeepAliveMinInterval(keepAliveMinInterval): { spec+: { argoCDAgent+: { principal+: { server+: { keepAliveMinInterval: keepAliveMinInterval } } } } },
        },
        '#tls':: d.obj(help='"TLS defines the TLS options for the Principal component."'),
        tls: {
          '#withInsecureGenerate':: d.fn(help='"InsecureGenerate is the flag to allow the principal to generate its own set of TLS cert and key on startup when none are configured"', args=[d.arg(name='insecureGenerate', type=d.T.boolean)]),
          withInsecureGenerate(insecureGenerate): { spec+: { argoCDAgent+: { principal+: { tls+: { insecureGenerate: insecureGenerate } } } } },
          '#withRootCASecretName':: d.fn(help='"RootCASecretName is the name of the secret containing the root CA TLS certificate"', args=[d.arg(name='rootCASecretName', type=d.T.string)]),
          withRootCASecretName(rootCASecretName): { spec+: { argoCDAgent+: { principal+: { tls+: { rootCASecretName: rootCASecretName } } } } },
          '#withSecretName':: d.fn(help='"SecretName is The name of the secret containing the TLS certificate and key."', args=[d.arg(name='secretName', type=d.T.string)]),
          withSecretName(secretName): { spec+: { argoCDAgent+: { principal+: { tls+: { secretName: secretName } } } } },
        },
        '#withAuth':: d.fn(help='"Auth is the authentication method for the Principal component."', args=[d.arg(name='auth', type=d.T.string)]),
        withAuth(auth): { spec+: { argoCDAgent+: { principal+: { auth: auth } } } },
        '#withEnabled':: d.fn(help='"Enabled is the flag to enable the Principal component during Argo CD installation. (optional, default `false`)"', args=[d.arg(name='enabled', type=d.T.boolean)]),
        withEnabled(enabled): { spec+: { argoCDAgent+: { principal+: { enabled: enabled } } } },
        '#withEnv':: d.fn(help='"Env lets you specify environment for principal pods"', args=[d.arg(name='env', type=d.T.array)]),
        withEnv(env): { spec+: { argoCDAgent+: { principal+: { env: if std.isArray(v=env) then env else [env] } } } },
        '#withEnvMixin':: d.fn(help='"Env lets you specify environment for principal pods"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='env', type=d.T.array)]),
        withEnvMixin(env): { spec+: { argoCDAgent+: { principal+: { env+: if std.isArray(v=env) then env else [env] } } } },
        '#withImage':: d.fn(help='"Image is the name of Argo CD Agent image"', args=[d.arg(name='image', type=d.T.string)]),
        withImage(image): { spec+: { argoCDAgent+: { principal+: { image: image } } } },
        '#withLogFormat':: d.fn(help='"LogFormat refers to the log format used by the Principal component."', args=[d.arg(name='logFormat', type=d.T.string)]),
        withLogFormat(logFormat): { spec+: { argoCDAgent+: { principal+: { logFormat: logFormat } } } },
        '#withLogLevel':: d.fn(help='"LogLevel refers to the log level used by the Principal component."', args=[d.arg(name='logLevel', type=d.T.string)]),
        withLogLevel(logLevel): { spec+: { argoCDAgent+: { principal+: { logLevel: logLevel } } } },
      },
    },
    ...
    banner: {
      ...
      '#withPermanent':: d.fn(help='"Permanent defines if the banner should be displayed permanently or only for a certain period of time"', args=[d.arg(name='permanent', type=d.T.boolean)]),
      withPermanent(permanent): { spec+: { banner+: { permanent: permanent } } },
      '#withPosition':: d.fn(help='"Position defines the position of the banner in the UI"', args=[d.arg(name='position', type=d.T.string)]),
      withPosition(position): { spec+: { banner+: { position: position } } },
    ...
    '#dex':: d.obj(help='"Deprecated field. Support dropped in v1beta1 version.\\nDex defines the Dex server options for ArgoCD."'),
    dex: {
      ...
      resources: {
        ...
        '#withClaims':: d.fn(help='"Claims lists the names of resources, defined in spec.resourceClaims,\\nthat are used by this container.\\n\\nThis is an alpha field and requires enabling the\\nDynamicResourceAllocation feature gate.\\n\\nThis field is immutable. It can only be set for containers."', args=[d.arg(name='claims', type=d.T.array)]),
        withClaims(claims): { spec+: { dex+: { resources+: { claims: if std.isArray(v=claims) then claims else [claims] } } } },
        '#withClaimsMixin':: d.fn(help='"Claims lists the names of resources, defined in spec.resourceClaims,\\nthat are used by this container.\\n\\nThis is an alpha field and requires enabling the\\nDynamicResourceAllocation feature gate.\\n\\nThis field is immutable. It can only be set for containers."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='claims', type=d.T.array)]),
        withClaimsMixin(claims): { spec+: { dex+: { resources+: { claims+: if std.isArray(v=claims) then claims else [claims] } } } },
        '#withLimits':: d.fn(help='"Limits describes the maximum amount of compute resources allowed.\\nMore info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"', args=[d.arg(name='limits', type=d.T.object)]),
        withLimits(limits): { spec+: { dex+: { resources+: { limits: limits } } } },
        '#withLimitsMixin':: d.fn(help='"Limits describes the maximum amount of compute resources allowed.\\nMore info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='limits', type=d.T.object)]),
        withLimitsMixin(limits): { spec+: { dex+: { resources+: { limits+: limits } } } },
        '#withRequests':: d.fn(help='"Requests describes the minimum amount of compute resources required.\\nIf Requests is omitted for a container, it defaults to Limits if that is explicitly specified,\\notherwise to an implementation-defined value. Requests cannot exceed Limits.\\nMore info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"', args=[d.arg(name='requests', type=d.T.object)]),
        withRequests(requests): { spec+: { dex+: { resources+: { requests: requests } } } },
        '#withRequestsMixin':: d.fn(help='"Requests describes the minimum amount of compute resources required.\\nIf Requests is omitted for a container, it defaults to Limits if that is explicitly specified,\\notherwise to an implementation-defined value. Requests cannot exceed Limits.\\nMore info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='requests', type=d.T.object)]),
        withRequestsMixin(requests): { spec+: { dex+: { resources+: { requests+: requests } } } },
      },
      '#withConfig':: d.fn(help='"Config is the dex connector configuration."', args=[d.arg(name='config', type=d.T.string)]),
      withConfig(config): { spec+: { dex+: { config: config } } },
      '#withGroups':: d.fn(help='"Optional list of required groups a user must be a member of"', args=[d.arg(name='groups', type=d.T.array)]),
      withGroups(groups): { spec+: { dex+: { groups: if std.isArray(v=groups) then groups else [groups] } } },
      ...
      withGroupsMixin(groups): { spec+: { dex+: { groups+: if std.isArray(v=groups) then groups else [groups] } } },
      '#withImage':: d.fn(help='"Image is the Dex container image."', args=[d.arg(name='image', type=d.T.string)]),
      withImage(image): { spec+: { dex+: { image: image } } },
      ...
      withOpenShiftOAuth(openShiftOAuth): { spec+: { dex+: { openShiftOAuth: openShiftOAuth } } },
      '#withVersion':: d.fn(help='"Version is the Dex container image tag."', args=[d.arg(name='version', type=d.T.string)]),
      withVersion(version): { spec+: { dex+: { version: version } } },
    },
    ...
    grafana: {
      ...
      route: {
        ...
        tls: {
          ...
          externalCertificate: {
            '#withName':: d.fn(help='"name of the referent.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { spec+: { grafana+: { route+: { tls+: { externalCertificate+: { name: name } } } } } },
          },
          '#withCaCertificate':: d.fn(help='"caCertificate provides the cert authority certificate contents"', args=[d.arg(name='caCertificate', type=d.T.string)]),
    ...
    '#namespaceManagement':: d.obj(help='"NamespaceManagement defines the list of namespaces that Argo CD is allowed to manage."'),
    namespaceManagement: {
      '#withAllowManagedBy':: d.fn(help='"Whether the namespace can be managed by ArgoCD"', args=[d.arg(name='allowManagedBy', type=d.T.boolean)]),
      withAllowManagedBy(allowManagedBy): { allowManagedBy: allowManagedBy },
      '#withName':: d.fn(help='"Name of the namespace or pattern to be managed"', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { name: name },
    },
    ...
    notifications: {
      ...
      '#withLogformat':: d.fn(help='"LogFormat refers to the log format used by the argocd-notifications. Defaults to ArgoCDDefaultLogFormat if not configured. Valid options are text or json."', args=[d.arg(name='logformat', type=d.T.string)]),
      withLogformat(logformat): { spec+: { notifications+: { logformat: logformat } } },
      ...
      '#withSourceNamespaces':: d.fn(help='"SourceNamespaces is a list of namespaces from which the notifications controller will watch for ArgoCD Application resources."', args=[d.arg(name='sourceNamespaces', type=d.T.array)]),
      withSourceNamespaces(sourceNamespaces): { spec+: { notifications+: { sourceNamespaces: if std.isArray(v=sourceNamespaces) then sourceNamespaces else [sourceNamespaces] } } },
      '#withSourceNamespacesMixin':: d.fn(help='"SourceNamespaces is a list of namespaces from which the notifications controller will watch for ArgoCD Application resources."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='sourceNamespaces', type=d.T.array)]),
      withSourceNamespacesMixin(sourceNamespaces): { spec+: { notifications+: { sourceNamespaces+: if std.isArray(v=sourceNamespaces) then sourceNamespaces else [sourceNamespaces] } } },
    ...
    prometheus: {
      ...
      route: {
        ...
        tls: {
          ...
          externalCertificate: {
            '#withName':: d.fn(help='"name of the referent.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { spec+: { prometheus+: { route+: { tls+: { externalCertificate+: { name: name } } } } } },
          },
          '#withCaCertificate':: d.fn(help='"caCertificate provides the cert authority certificate contents"', args=[d.arg(name='caCertificate', type=d.T.string)]),
    ...
    repo: {
      ...
      '#withSidecarContainers':: d.fn(help='"SidecarContainers defines the list of sidecar containers for the repo\\nserver deployment. If the image field is omitted from a SidecarContainer,\\nthe image for the repo server will be used."', args=[d.arg(name='sidecarContainers', type=d.T.array)]),
      ...
      '#withSidecarContainersMixin':: d.fn(help='"SidecarContainers defines the list of sidecar containers for the repo\\nserver deployment. If the image field is omitted from a SidecarContainer,\\nthe image for the repo server will be used."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='sidecarContainers', type=d.T.array)]),
    ...
    server: {
      ...
      route: {
        ...
        tls: {
          ...
          externalCertificate: {
            '#withName':: d.fn(help='"name of the referent.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { spec+: { server+: { route+: { tls+: { externalCertificate+: { name: name } } } } } },
          },
          '#withCaCertificate':: d.fn(help='"caCertificate provides the cert authority certificate contents"', args=[d.arg(name='caCertificate', type=d.T.string)]),
      ...
      '#withEnableRolloutsUI':: d.fn(help='"EnableRolloutsUI will add the Argo Rollouts UI extension in ArgoCD Dashboard."', args=[d.arg(name='enableRolloutsUI', type=d.T.boolean)]),
      withEnableRolloutsUI(enableRolloutsUI): { spec+: { server+: { enableRolloutsUI: enableRolloutsUI } } },
    ...
    sso: {
      ...
      resources: {
        ...
        '#withClaims':: d.fn(help='"Claims lists the names of resources, defined in spec.resourceClaims,\\nthat are used by this container.\\n\\nThis is an alpha field and requires enabling the\\nDynamicResourceAllocation feature gate.\\n\\nThis field is immutable. It can only be set for containers."', args=[d.arg(name='claims', type=d.T.array)]),
        withClaims(claims): { spec+: { sso+: { resources+: { claims: if std.isArray(v=claims) then claims else [claims] } } } },
        '#withClaimsMixin':: d.fn(help='"Claims lists the names of resources, defined in spec.resourceClaims,\\nthat are used by this container.\\n\\nThis is an alpha field and requires enabling the\\nDynamicResourceAllocation feature gate.\\n\\nThis field is immutable. It can only be set for containers."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='claims', type=d.T.array)]),
        withClaimsMixin(claims): { spec+: { sso+: { resources+: { claims+: if std.isArray(v=claims) then claims else [claims] } } } },
        '#withLimits':: d.fn(help='"Limits describes the maximum amount of compute resources allowed.\\nMore info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"', args=[d.arg(name='limits', type=d.T.object)]),
        withLimits(limits): { spec+: { sso+: { resources+: { limits: limits } } } },
        '#withLimitsMixin':: d.fn(help='"Limits describes the maximum amount of compute resources allowed.\\nMore info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='limits', type=d.T.object)]),
        withLimitsMixin(limits): { spec+: { sso+: { resources+: { limits+: limits } } } },
        '#withRequests':: d.fn(help='"Requests describes the minimum amount of compute resources required.\\nIf Requests is omitted for a container, it defaults to Limits if that is explicitly specified,\\notherwise to an implementation-defined value. Requests cannot exceed Limits.\\nMore info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"', args=[d.arg(name='requests', type=d.T.object)]),
        withRequests(requests): { spec+: { sso+: { resources+: { requests: requests } } } },
        '#withRequestsMixin':: d.fn(help='"Requests describes the minimum amount of compute resources required.\\nIf Requests is omitted for a container, it defaults to Limits if that is explicitly specified,\\notherwise to an implementation-defined value. Requests cannot exceed Limits.\\nMore info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='requests', type=d.T.object)]),
        withRequestsMixin(requests): { spec+: { sso+: { resources+: { requests+: requests } } } },
      },
      '#withImage':: d.fn(help='"Deprecated field. Support dropped in v1beta1 version.\\nImage is the SSO container image."', args=[d.arg(name='image', type=d.T.string)]),
      withImage(image): { spec+: { sso+: { image: image } } },
      ...
      '#withVerifyTLS':: d.fn(help='"Deprecated field. Support dropped in v1beta1 version.\\nVerifyTLS set to false disables strict TLS validation."', args=[d.arg(name='verifyTLS', type=d.T.boolean)]),
      withVerifyTLS(verifyTLS): { spec+: { sso+: { verifyTLS: verifyTLS } } },
      '#withVersion':: d.fn(help='"Deprecated field. Support dropped in v1beta1 version.\\nVersion is the SSO container image tag."', args=[d.arg(name='version', type=d.T.string)]),
      withVersion(version): { spec+: { sso+: { version: version } } },
    },
    ...
    '#withConfigManagementPlugins':: d.fn(help="\"Deprecated: ConfigManagementPlugins field is no longer supported. Argo CD now requires plugins to be defined as sidecar containers of repo server component. See '.spec.repo.sidecarContainers'. ConfigManagementPlugins was previously used to specify additional config management plugins.\"", args=[d.arg(name='configManagementPlugins', type=d.T.string)]),
    ...
    '#withImagePullPolicy':: d.fn(help="\"ImagePullPolicy is the image pull policy for all ArgoCD components.\\nValid values are Always, IfNotPresent, Never. If not specified, defaults to the operator's global setting.\"", args=[d.arg(name='imagePullPolicy', type=d.T.string)]),
    ...
    '#withInstallationID':: d.fn(help='"InstallationID uniquely identifies an Argo CD instance in multi-instance clusters."', args=[d.arg(name='installationID', type=d.T.string)]),
    withInstallationID(installationID): { spec+: { installationID: installationID } },
    ...
    '#withNamespaceManagement':: d.fn(help='"NamespaceManagement defines the list of namespaces that Argo CD is allowed to manage."', args=[d.arg(name='namespaceManagement', type=d.T.array)]),
    withNamespaceManagement(namespaceManagement): { spec+: { namespaceManagement: if std.isArray(v=namespaceManagement) then namespaceManagement else [namespaceManagement] } },
    '#withNamespaceManagementMixin':: d.fn(help='"NamespaceManagement defines the list of namespaces that Argo CD is allowed to manage."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='namespaceManagement', type=d.T.array)]),
    withNamespaceManagementMixin(namespaceManagement): { spec+: { namespaceManagement+: if std.isArray(v=namespaceManagement) then namespaceManagement else [namespaceManagement] } },
    ...
    '#withResourceCustomizations':: d.fn(help='"Deprecated field. Support dropped in v1beta1 version.\\nResourceCustomizations customizes resource behavior. Keys are in the form: group/Kind. Please note that this is being deprecated in favor of ResourceHealthChecks, ResourceIgnoreDifferences, and ResourceActions."', args=[d.arg(name='resourceCustomizations', type=d.T.string)]),
    withResourceCustomizations(resourceCustomizations): { spec+: { resourceCustomizations: resourceCustomizations } },
