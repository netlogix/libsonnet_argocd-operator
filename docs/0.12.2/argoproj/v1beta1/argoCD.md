---
permalink: /0.12.2/argoproj/v1beta1/argoCD/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.applicationSet`](#obj-specapplicationset)
    * [`fn withEnabled(enabled)`](#fn-specapplicationsetwithenabled)
    ...
    * [`fn withScmProviders(scmProviders)`](#fn-specapplicationsetwithscmproviders)
    * [`fn withScmProvidersMixin(scmProviders)`](#fn-specapplicationsetwithscmprovidersmixin)
    * [`fn withScmRootCAConfigMap(scmRootCAConfigMap)`](#fn-specapplicationsetwithscmrootcaconfigmap)
    * [`fn withSourceNamespaces(sourceNamespaces)`](#fn-specapplicationsetwithsourcenamespaces)
    * [`fn withSourceNamespacesMixin(sourceNamespaces)`](#fn-specapplicationsetwithsourcenamespacesmixin)
  ...
  * [`obj spec.controller`](#obj-speccontroller)
    ...
    * [`fn withEnabled(enabled)`](#fn-speccontrollerwithenabled)
    * [`fn withEnv(env)`](#fn-speccontrollerwithenv)
    * [`fn withEnvMixin(env)`](#fn-speccontrollerwithenvmixin)
    * [`fn withExtraCommandArgs(extraCommandArgs)`](#fn-speccontrollerwithextracommandargs)
    * [`fn withExtraCommandArgsMixin(extraCommandArgs)`](#fn-speccontrollerwithextracommandargsmixin)
    * [`fn withInitContainers(initContainers)`](#fn-speccontrollerwithinitcontainers)
    * [`fn withInitContainersMixin(initContainers)`](#fn-speccontrollerwithinitcontainersmixin)
    ...
    * [`fn withSidecarContainers(sidecarContainers)`](#fn-speccontrollerwithsidecarcontainers)
    * [`fn withSidecarContainersMixin(sidecarContainers)`](#fn-speccontrollerwithsidecarcontainersmixin)
    * [`fn withVolumeMounts(volumeMounts)`](#fn-speccontrollerwithvolumemounts)
    * [`fn withVolumeMountsMixin(volumeMounts)`](#fn-speccontrollerwithvolumemountsmixin)
    * [`fn withVolumes(volumes)`](#fn-speccontrollerwithvolumes)
    * [`fn withVolumesMixin(volumes)`](#fn-speccontrollerwithvolumesmixin)
    ...
    * [`obj spec.controller.initContainers`](#obj-speccontrollerinitcontainers)
      * [`fn withArgs(args)`](#fn-speccontrollerinitcontainerswithargs)
      * [`fn withArgsMixin(args)`](#fn-speccontrollerinitcontainerswithargsmixin)
      * [`fn withCommand(command)`](#fn-speccontrollerinitcontainerswithcommand)
      * [`fn withCommandMixin(command)`](#fn-speccontrollerinitcontainerswithcommandmixin)
      * [`fn withEnv(env)`](#fn-speccontrollerinitcontainerswithenv)
      * [`fn withEnvFrom(envFrom)`](#fn-speccontrollerinitcontainerswithenvfrom)
      * [`fn withEnvFromMixin(envFrom)`](#fn-speccontrollerinitcontainerswithenvfrommixin)
      * [`fn withEnvMixin(env)`](#fn-speccontrollerinitcontainerswithenvmixin)
      * [`fn withImage(image)`](#fn-speccontrollerinitcontainerswithimage)
      * [`fn withImagePullPolicy(imagePullPolicy)`](#fn-speccontrollerinitcontainerswithimagepullpolicy)
      * [`fn withName(name)`](#fn-speccontrollerinitcontainerswithname)
      * [`fn withPorts(ports)`](#fn-speccontrollerinitcontainerswithports)
      * [`fn withPortsMixin(ports)`](#fn-speccontrollerinitcontainerswithportsmixin)
      * [`fn withResizePolicy(resizePolicy)`](#fn-speccontrollerinitcontainerswithresizepolicy)
      * [`fn withResizePolicyMixin(resizePolicy)`](#fn-speccontrollerinitcontainerswithresizepolicymixin)
      * [`fn withRestartPolicy(restartPolicy)`](#fn-speccontrollerinitcontainerswithrestartpolicy)
      * [`fn withStdin(stdin)`](#fn-speccontrollerinitcontainerswithstdin)
      * [`fn withStdinOnce(stdinOnce)`](#fn-speccontrollerinitcontainerswithstdinonce)
      * [`fn withTerminationMessagePath(terminationMessagePath)`](#fn-speccontrollerinitcontainerswithterminationmessagepath)
      * [`fn withTerminationMessagePolicy(terminationMessagePolicy)`](#fn-speccontrollerinitcontainerswithterminationmessagepolicy)
      * [`fn withTty(tty)`](#fn-speccontrollerinitcontainerswithtty)
      * [`fn withVolumeDevices(volumeDevices)`](#fn-speccontrollerinitcontainerswithvolumedevices)
      * [`fn withVolumeDevicesMixin(volumeDevices)`](#fn-speccontrollerinitcontainerswithvolumedevicesmixin)
      * [`fn withVolumeMounts(volumeMounts)`](#fn-speccontrollerinitcontainerswithvolumemounts)
      * [`fn withVolumeMountsMixin(volumeMounts)`](#fn-speccontrollerinitcontainerswithvolumemountsmixin)
      * [`fn withWorkingDir(workingDir)`](#fn-speccontrollerinitcontainerswithworkingdir)
      * [`obj spec.controller.initContainers.env`](#obj-speccontrollerinitcontainersenv)
        * [`fn withName(name)`](#fn-speccontrollerinitcontainersenvwithname)
        * [`fn withValue(value)`](#fn-speccontrollerinitcontainersenvwithvalue)
        * [`obj spec.controller.initContainers.env.valueFrom`](#obj-speccontrollerinitcontainersenvvaluefrom)
          * [`obj spec.controller.initContainers.env.valueFrom.configMapKeyRef`](#obj-speccontrollerinitcontainersenvvaluefromconfigmapkeyref)
            * [`fn withKey(key)`](#fn-speccontrollerinitcontainersenvvaluefromconfigmapkeyrefwithkey)
            * [`fn withName(name)`](#fn-speccontrollerinitcontainersenvvaluefromconfigmapkeyrefwithname)
            * [`fn withOptional(optional)`](#fn-speccontrollerinitcontainersenvvaluefromconfigmapkeyrefwithoptional)
          * [`obj spec.controller.initContainers.env.valueFrom.fieldRef`](#obj-speccontrollerinitcontainersenvvaluefromfieldref)
            * [`fn withApiVersion(apiVersion)`](#fn-speccontrollerinitcontainersenvvaluefromfieldrefwithapiversion)
            * [`fn withFieldPath(fieldPath)`](#fn-speccontrollerinitcontainersenvvaluefromfieldrefwithfieldpath)
          * [`obj spec.controller.initContainers.env.valueFrom.resourceFieldRef`](#obj-speccontrollerinitcontainersenvvaluefromresourcefieldref)
            * [`fn withContainerName(containerName)`](#fn-speccontrollerinitcontainersenvvaluefromresourcefieldrefwithcontainername)
            * [`fn withDivisor(divisor)`](#fn-speccontrollerinitcontainersenvvaluefromresourcefieldrefwithdivisor)
            * [`fn withResource(resource)`](#fn-speccontrollerinitcontainersenvvaluefromresourcefieldrefwithresource)
          * [`obj spec.controller.initContainers.env.valueFrom.secretKeyRef`](#obj-speccontrollerinitcontainersenvvaluefromsecretkeyref)
            * [`fn withKey(key)`](#fn-speccontrollerinitcontainersenvvaluefromsecretkeyrefwithkey)
            * [`fn withName(name)`](#fn-speccontrollerinitcontainersenvvaluefromsecretkeyrefwithname)
            * [`fn withOptional(optional)`](#fn-speccontrollerinitcontainersenvvaluefromsecretkeyrefwithoptional)
      * [`obj spec.controller.initContainers.envFrom`](#obj-speccontrollerinitcontainersenvfrom)
        * [`fn withPrefix(prefix)`](#fn-speccontrollerinitcontainersenvfromwithprefix)
        * [`obj spec.controller.initContainers.envFrom.configMapRef`](#obj-speccontrollerinitcontainersenvfromconfigmapref)
          * [`fn withName(name)`](#fn-speccontrollerinitcontainersenvfromconfigmaprefwithname)
          * [`fn withOptional(optional)`](#fn-speccontrollerinitcontainersenvfromconfigmaprefwithoptional)
        * [`obj spec.controller.initContainers.envFrom.secretRef`](#obj-speccontrollerinitcontainersenvfromsecretref)
          * [`fn withName(name)`](#fn-speccontrollerinitcontainersenvfromsecretrefwithname)
          * [`fn withOptional(optional)`](#fn-speccontrollerinitcontainersenvfromsecretrefwithoptional)
      * [`obj spec.controller.initContainers.lifecycle`](#obj-speccontrollerinitcontainerslifecycle)
        * [`obj spec.controller.initContainers.lifecycle.postStart`](#obj-speccontrollerinitcontainerslifecyclepoststart)
          * [`obj spec.controller.initContainers.lifecycle.postStart.exec`](#obj-speccontrollerinitcontainerslifecyclepoststartexec)
            * [`fn withCommand(command)`](#fn-speccontrollerinitcontainerslifecyclepoststartexecwithcommand)
            * [`fn withCommandMixin(command)`](#fn-speccontrollerinitcontainerslifecyclepoststartexecwithcommandmixin)
          * [`obj spec.controller.initContainers.lifecycle.postStart.httpGet`](#obj-speccontrollerinitcontainerslifecyclepoststarthttpget)
            * [`fn withHost(host)`](#fn-speccontrollerinitcontainerslifecyclepoststarthttpgetwithhost)
            * [`fn withHttpHeaders(httpHeaders)`](#fn-speccontrollerinitcontainerslifecyclepoststarthttpgetwithhttpheaders)
            * [`fn withHttpHeadersMixin(httpHeaders)`](#fn-speccontrollerinitcontainerslifecyclepoststarthttpgetwithhttpheadersmixin)
            * [`fn withPath(path)`](#fn-speccontrollerinitcontainerslifecyclepoststarthttpgetwithpath)
            * [`fn withPort(port)`](#fn-speccontrollerinitcontainerslifecyclepoststarthttpgetwithport)
            * [`fn withScheme(scheme)`](#fn-speccontrollerinitcontainerslifecyclepoststarthttpgetwithscheme)
            * [`obj spec.controller.initContainers.lifecycle.postStart.httpGet.httpHeaders`](#obj-speccontrollerinitcontainerslifecyclepoststarthttpgethttpheaders)
              * [`fn withName(name)`](#fn-speccontrollerinitcontainerslifecyclepoststarthttpgethttpheaderswithname)
              * [`fn withValue(value)`](#fn-speccontrollerinitcontainerslifecyclepoststarthttpgethttpheaderswithvalue)
          * [`obj spec.controller.initContainers.lifecycle.postStart.tcpSocket`](#obj-speccontrollerinitcontainerslifecyclepoststarttcpsocket)
            * [`fn withHost(host)`](#fn-speccontrollerinitcontainerslifecyclepoststarttcpsocketwithhost)
            * [`fn withPort(port)`](#fn-speccontrollerinitcontainerslifecyclepoststarttcpsocketwithport)
        * [`obj spec.controller.initContainers.lifecycle.preStop`](#obj-speccontrollerinitcontainerslifecycleprestop)
          * [`obj spec.controller.initContainers.lifecycle.preStop.exec`](#obj-speccontrollerinitcontainerslifecycleprestopexec)
            * [`fn withCommand(command)`](#fn-speccontrollerinitcontainerslifecycleprestopexecwithcommand)
            * [`fn withCommandMixin(command)`](#fn-speccontrollerinitcontainerslifecycleprestopexecwithcommandmixin)
          * [`obj spec.controller.initContainers.lifecycle.preStop.httpGet`](#obj-speccontrollerinitcontainerslifecycleprestophttpget)
            * [`fn withHost(host)`](#fn-speccontrollerinitcontainerslifecycleprestophttpgetwithhost)
            * [`fn withHttpHeaders(httpHeaders)`](#fn-speccontrollerinitcontainerslifecycleprestophttpgetwithhttpheaders)
            * [`fn withHttpHeadersMixin(httpHeaders)`](#fn-speccontrollerinitcontainerslifecycleprestophttpgetwithhttpheadersmixin)
            * [`fn withPath(path)`](#fn-speccontrollerinitcontainerslifecycleprestophttpgetwithpath)
            * [`fn withPort(port)`](#fn-speccontrollerinitcontainerslifecycleprestophttpgetwithport)
            * [`fn withScheme(scheme)`](#fn-speccontrollerinitcontainerslifecycleprestophttpgetwithscheme)
            * [`obj spec.controller.initContainers.lifecycle.preStop.httpGet.httpHeaders`](#obj-speccontrollerinitcontainerslifecycleprestophttpgethttpheaders)
              * [`fn withName(name)`](#fn-speccontrollerinitcontainerslifecycleprestophttpgethttpheaderswithname)
              * [`fn withValue(value)`](#fn-speccontrollerinitcontainerslifecycleprestophttpgethttpheaderswithvalue)
          * [`obj spec.controller.initContainers.lifecycle.preStop.tcpSocket`](#obj-speccontrollerinitcontainerslifecycleprestoptcpsocket)
            * [`fn withHost(host)`](#fn-speccontrollerinitcontainerslifecycleprestoptcpsocketwithhost)
            * [`fn withPort(port)`](#fn-speccontrollerinitcontainerslifecycleprestoptcpsocketwithport)
      * [`obj spec.controller.initContainers.livenessProbe`](#obj-speccontrollerinitcontainerslivenessprobe)
        * [`fn withFailureThreshold(failureThreshold)`](#fn-speccontrollerinitcontainerslivenessprobewithfailurethreshold)
        * [`fn withInitialDelaySeconds(initialDelaySeconds)`](#fn-speccontrollerinitcontainerslivenessprobewithinitialdelayseconds)
        * [`fn withPeriodSeconds(periodSeconds)`](#fn-speccontrollerinitcontainerslivenessprobewithperiodseconds)
        * [`fn withSuccessThreshold(successThreshold)`](#fn-speccontrollerinitcontainerslivenessprobewithsuccessthreshold)
        * [`fn withTerminationGracePeriodSeconds(terminationGracePeriodSeconds)`](#fn-speccontrollerinitcontainerslivenessprobewithterminationgraceperiodseconds)
        * [`fn withTimeoutSeconds(timeoutSeconds)`](#fn-speccontrollerinitcontainerslivenessprobewithtimeoutseconds)
        * [`obj spec.controller.initContainers.livenessProbe.exec`](#obj-speccontrollerinitcontainerslivenessprobeexec)
          * [`fn withCommand(command)`](#fn-speccontrollerinitcontainerslivenessprobeexecwithcommand)
          * [`fn withCommandMixin(command)`](#fn-speccontrollerinitcontainerslivenessprobeexecwithcommandmixin)
        * [`obj spec.controller.initContainers.livenessProbe.grpc`](#obj-speccontrollerinitcontainerslivenessprobegrpc)
          * [`fn withPort(port)`](#fn-speccontrollerinitcontainerslivenessprobegrpcwithport)
          * [`fn withService(service)`](#fn-speccontrollerinitcontainerslivenessprobegrpcwithservice)
        * [`obj spec.controller.initContainers.livenessProbe.httpGet`](#obj-speccontrollerinitcontainerslivenessprobehttpget)
          * [`fn withHost(host)`](#fn-speccontrollerinitcontainerslivenessprobehttpgetwithhost)
          * [`fn withHttpHeaders(httpHeaders)`](#fn-speccontrollerinitcontainerslivenessprobehttpgetwithhttpheaders)
          * [`fn withHttpHeadersMixin(httpHeaders)`](#fn-speccontrollerinitcontainerslivenessprobehttpgetwithhttpheadersmixin)
          * [`fn withPath(path)`](#fn-speccontrollerinitcontainerslivenessprobehttpgetwithpath)
          * [`fn withPort(port)`](#fn-speccontrollerinitcontainerslivenessprobehttpgetwithport)
          * [`fn withScheme(scheme)`](#fn-speccontrollerinitcontainerslivenessprobehttpgetwithscheme)
          * [`obj spec.controller.initContainers.livenessProbe.httpGet.httpHeaders`](#obj-speccontrollerinitcontainerslivenessprobehttpgethttpheaders)
            * [`fn withName(name)`](#fn-speccontrollerinitcontainerslivenessprobehttpgethttpheaderswithname)
            * [`fn withValue(value)`](#fn-speccontrollerinitcontainerslivenessprobehttpgethttpheaderswithvalue)
        * [`obj spec.controller.initContainers.livenessProbe.tcpSocket`](#obj-speccontrollerinitcontainerslivenessprobetcpsocket)
          * [`fn withHost(host)`](#fn-speccontrollerinitcontainerslivenessprobetcpsocketwithhost)
          * [`fn withPort(port)`](#fn-speccontrollerinitcontainerslivenessprobetcpsocketwithport)
      * [`obj spec.controller.initContainers.ports`](#obj-speccontrollerinitcontainersports)
        * [`fn withContainerPort(containerPort)`](#fn-speccontrollerinitcontainersportswithcontainerport)
        * [`fn withHostIP(hostIP)`](#fn-speccontrollerinitcontainersportswithhostip)
        * [`fn withHostPort(hostPort)`](#fn-speccontrollerinitcontainersportswithhostport)
        * [`fn withName(name)`](#fn-speccontrollerinitcontainersportswithname)
        * [`fn withProtocol(protocol)`](#fn-speccontrollerinitcontainersportswithprotocol)
      * [`obj spec.controller.initContainers.readinessProbe`](#obj-speccontrollerinitcontainersreadinessprobe)
        * [`fn withFailureThreshold(failureThreshold)`](#fn-speccontrollerinitcontainersreadinessprobewithfailurethreshold)
        * [`fn withInitialDelaySeconds(initialDelaySeconds)`](#fn-speccontrollerinitcontainersreadinessprobewithinitialdelayseconds)
        * [`fn withPeriodSeconds(periodSeconds)`](#fn-speccontrollerinitcontainersreadinessprobewithperiodseconds)
        * [`fn withSuccessThreshold(successThreshold)`](#fn-speccontrollerinitcontainersreadinessprobewithsuccessthreshold)
        * [`fn withTerminationGracePeriodSeconds(terminationGracePeriodSeconds)`](#fn-speccontrollerinitcontainersreadinessprobewithterminationgraceperiodseconds)
        * [`fn withTimeoutSeconds(timeoutSeconds)`](#fn-speccontrollerinitcontainersreadinessprobewithtimeoutseconds)
        * [`obj spec.controller.initContainers.readinessProbe.exec`](#obj-speccontrollerinitcontainersreadinessprobeexec)
          * [`fn withCommand(command)`](#fn-speccontrollerinitcontainersreadinessprobeexecwithcommand)
          * [`fn withCommandMixin(command)`](#fn-speccontrollerinitcontainersreadinessprobeexecwithcommandmixin)
        * [`obj spec.controller.initContainers.readinessProbe.grpc`](#obj-speccontrollerinitcontainersreadinessprobegrpc)
          * [`fn withPort(port)`](#fn-speccontrollerinitcontainersreadinessprobegrpcwithport)
          * [`fn withService(service)`](#fn-speccontrollerinitcontainersreadinessprobegrpcwithservice)
        * [`obj spec.controller.initContainers.readinessProbe.httpGet`](#obj-speccontrollerinitcontainersreadinessprobehttpget)
          * [`fn withHost(host)`](#fn-speccontrollerinitcontainersreadinessprobehttpgetwithhost)
          * [`fn withHttpHeaders(httpHeaders)`](#fn-speccontrollerinitcontainersreadinessprobehttpgetwithhttpheaders)
          * [`fn withHttpHeadersMixin(httpHeaders)`](#fn-speccontrollerinitcontainersreadinessprobehttpgetwithhttpheadersmixin)
          * [`fn withPath(path)`](#fn-speccontrollerinitcontainersreadinessprobehttpgetwithpath)
          * [`fn withPort(port)`](#fn-speccontrollerinitcontainersreadinessprobehttpgetwithport)
          * [`fn withScheme(scheme)`](#fn-speccontrollerinitcontainersreadinessprobehttpgetwithscheme)
          * [`obj spec.controller.initContainers.readinessProbe.httpGet.httpHeaders`](#obj-speccontrollerinitcontainersreadinessprobehttpgethttpheaders)
            * [`fn withName(name)`](#fn-speccontrollerinitcontainersreadinessprobehttpgethttpheaderswithname)
            * [`fn withValue(value)`](#fn-speccontrollerinitcontainersreadinessprobehttpgethttpheaderswithvalue)
        * [`obj spec.controller.initContainers.readinessProbe.tcpSocket`](#obj-speccontrollerinitcontainersreadinessprobetcpsocket)
          * [`fn withHost(host)`](#fn-speccontrollerinitcontainersreadinessprobetcpsocketwithhost)
          * [`fn withPort(port)`](#fn-speccontrollerinitcontainersreadinessprobetcpsocketwithport)
      * [`obj spec.controller.initContainers.resizePolicy`](#obj-speccontrollerinitcontainersresizepolicy)
        * [`fn withResourceName(resourceName)`](#fn-speccontrollerinitcontainersresizepolicywithresourcename)
        * [`fn withRestartPolicy(restartPolicy)`](#fn-speccontrollerinitcontainersresizepolicywithrestartpolicy)
      * [`obj spec.controller.initContainers.resources`](#obj-speccontrollerinitcontainersresources)
        * [`fn withClaims(claims)`](#fn-speccontrollerinitcontainersresourceswithclaims)
        * [`fn withClaimsMixin(claims)`](#fn-speccontrollerinitcontainersresourceswithclaimsmixin)
        * [`fn withLimits(limits)`](#fn-speccontrollerinitcontainersresourceswithlimits)
        * [`fn withLimitsMixin(limits)`](#fn-speccontrollerinitcontainersresourceswithlimitsmixin)
        * [`fn withRequests(requests)`](#fn-speccontrollerinitcontainersresourceswithrequests)
        * [`fn withRequestsMixin(requests)`](#fn-speccontrollerinitcontainersresourceswithrequestsmixin)
        * [`obj spec.controller.initContainers.resources.claims`](#obj-speccontrollerinitcontainersresourcesclaims)
          * [`fn withName(name)`](#fn-speccontrollerinitcontainersresourcesclaimswithname)
      * [`obj spec.controller.initContainers.securityContext`](#obj-speccontrollerinitcontainerssecuritycontext)
        * [`fn withAllowPrivilegeEscalation(allowPrivilegeEscalation)`](#fn-speccontrollerinitcontainerssecuritycontextwithallowprivilegeescalation)
        * [`fn withPrivileged(privileged)`](#fn-speccontrollerinitcontainerssecuritycontextwithprivileged)
        * [`fn withProcMount(procMount)`](#fn-speccontrollerinitcontainerssecuritycontextwithprocmount)
        * [`fn withReadOnlyRootFilesystem(readOnlyRootFilesystem)`](#fn-speccontrollerinitcontainerssecuritycontextwithreadonlyrootfilesystem)
        * [`fn withRunAsGroup(runAsGroup)`](#fn-speccontrollerinitcontainerssecuritycontextwithrunasgroup)
        * [`fn withRunAsNonRoot(runAsNonRoot)`](#fn-speccontrollerinitcontainerssecuritycontextwithrunasnonroot)
        * [`fn withRunAsUser(runAsUser)`](#fn-speccontrollerinitcontainerssecuritycontextwithrunasuser)
        * [`obj spec.controller.initContainers.securityContext.capabilities`](#obj-speccontrollerinitcontainerssecuritycontextcapabilities)
          * [`fn withAdd(add)`](#fn-speccontrollerinitcontainerssecuritycontextcapabilitieswithadd)
          * [`fn withAddMixin(add)`](#fn-speccontrollerinitcontainerssecuritycontextcapabilitieswithaddmixin)
          * [`fn withDrop(drop)`](#fn-speccontrollerinitcontainerssecuritycontextcapabilitieswithdrop)
          * [`fn withDropMixin(drop)`](#fn-speccontrollerinitcontainerssecuritycontextcapabilitieswithdropmixin)
        * [`obj spec.controller.initContainers.securityContext.seLinuxOptions`](#obj-speccontrollerinitcontainerssecuritycontextselinuxoptions)
          * [`fn withLevel(level)`](#fn-speccontrollerinitcontainerssecuritycontextselinuxoptionswithlevel)
          * [`fn withRole(role)`](#fn-speccontrollerinitcontainerssecuritycontextselinuxoptionswithrole)
          * [`fn withType(type)`](#fn-speccontrollerinitcontainerssecuritycontextselinuxoptionswithtype)
          * [`fn withUser(user)`](#fn-speccontrollerinitcontainerssecuritycontextselinuxoptionswithuser)
        * [`obj spec.controller.initContainers.securityContext.seccompProfile`](#obj-speccontrollerinitcontainerssecuritycontextseccompprofile)
          * [`fn withLocalhostProfile(localhostProfile)`](#fn-speccontrollerinitcontainerssecuritycontextseccompprofilewithlocalhostprofile)
          * [`fn withType(type)`](#fn-speccontrollerinitcontainerssecuritycontextseccompprofilewithtype)
        * [`obj spec.controller.initContainers.securityContext.windowsOptions`](#obj-speccontrollerinitcontainerssecuritycontextwindowsoptions)
          * [`fn withGmsaCredentialSpec(gmsaCredentialSpec)`](#fn-speccontrollerinitcontainerssecuritycontextwindowsoptionswithgmsacredentialspec)
          * [`fn withGmsaCredentialSpecName(gmsaCredentialSpecName)`](#fn-speccontrollerinitcontainerssecuritycontextwindowsoptionswithgmsacredentialspecname)
          * [`fn withHostProcess(hostProcess)`](#fn-speccontrollerinitcontainerssecuritycontextwindowsoptionswithhostprocess)
          * [`fn withRunAsUserName(runAsUserName)`](#fn-speccontrollerinitcontainerssecuritycontextwindowsoptionswithrunasusername)
      * [`obj spec.controller.initContainers.startupProbe`](#obj-speccontrollerinitcontainersstartupprobe)
        * [`fn withFailureThreshold(failureThreshold)`](#fn-speccontrollerinitcontainersstartupprobewithfailurethreshold)
        * [`fn withInitialDelaySeconds(initialDelaySeconds)`](#fn-speccontrollerinitcontainersstartupprobewithinitialdelayseconds)
        * [`fn withPeriodSeconds(periodSeconds)`](#fn-speccontrollerinitcontainersstartupprobewithperiodseconds)
        * [`fn withSuccessThreshold(successThreshold)`](#fn-speccontrollerinitcontainersstartupprobewithsuccessthreshold)
        * [`fn withTerminationGracePeriodSeconds(terminationGracePeriodSeconds)`](#fn-speccontrollerinitcontainersstartupprobewithterminationgraceperiodseconds)
        * [`fn withTimeoutSeconds(timeoutSeconds)`](#fn-speccontrollerinitcontainersstartupprobewithtimeoutseconds)
        * [`obj spec.controller.initContainers.startupProbe.exec`](#obj-speccontrollerinitcontainersstartupprobeexec)
          * [`fn withCommand(command)`](#fn-speccontrollerinitcontainersstartupprobeexecwithcommand)
          * [`fn withCommandMixin(command)`](#fn-speccontrollerinitcontainersstartupprobeexecwithcommandmixin)
        * [`obj spec.controller.initContainers.startupProbe.grpc`](#obj-speccontrollerinitcontainersstartupprobegrpc)
          * [`fn withPort(port)`](#fn-speccontrollerinitcontainersstartupprobegrpcwithport)
          * [`fn withService(service)`](#fn-speccontrollerinitcontainersstartupprobegrpcwithservice)
        * [`obj spec.controller.initContainers.startupProbe.httpGet`](#obj-speccontrollerinitcontainersstartupprobehttpget)
          * [`fn withHost(host)`](#fn-speccontrollerinitcontainersstartupprobehttpgetwithhost)
          * [`fn withHttpHeaders(httpHeaders)`](#fn-speccontrollerinitcontainersstartupprobehttpgetwithhttpheaders)
          * [`fn withHttpHeadersMixin(httpHeaders)`](#fn-speccontrollerinitcontainersstartupprobehttpgetwithhttpheadersmixin)
          * [`fn withPath(path)`](#fn-speccontrollerinitcontainersstartupprobehttpgetwithpath)
          * [`fn withPort(port)`](#fn-speccontrollerinitcontainersstartupprobehttpgetwithport)
          * [`fn withScheme(scheme)`](#fn-speccontrollerinitcontainersstartupprobehttpgetwithscheme)
          * [`obj spec.controller.initContainers.startupProbe.httpGet.httpHeaders`](#obj-speccontrollerinitcontainersstartupprobehttpgethttpheaders)
            * [`fn withName(name)`](#fn-speccontrollerinitcontainersstartupprobehttpgethttpheaderswithname)
            * [`fn withValue(value)`](#fn-speccontrollerinitcontainersstartupprobehttpgethttpheaderswithvalue)
        * [`obj spec.controller.initContainers.startupProbe.tcpSocket`](#obj-speccontrollerinitcontainersstartupprobetcpsocket)
          * [`fn withHost(host)`](#fn-speccontrollerinitcontainersstartupprobetcpsocketwithhost)
          * [`fn withPort(port)`](#fn-speccontrollerinitcontainersstartupprobetcpsocketwithport)
      * [`obj spec.controller.initContainers.volumeDevices`](#obj-speccontrollerinitcontainersvolumedevices)
        * [`fn withDevicePath(devicePath)`](#fn-speccontrollerinitcontainersvolumedeviceswithdevicepath)
        * [`fn withName(name)`](#fn-speccontrollerinitcontainersvolumedeviceswithname)
      * [`obj spec.controller.initContainers.volumeMounts`](#obj-speccontrollerinitcontainersvolumemounts)
        * [`fn withMountPath(mountPath)`](#fn-speccontrollerinitcontainersvolumemountswithmountpath)
        * [`fn withMountPropagation(mountPropagation)`](#fn-speccontrollerinitcontainersvolumemountswithmountpropagation)
        * [`fn withName(name)`](#fn-speccontrollerinitcontainersvolumemountswithname)
        * [`fn withReadOnly(readOnly)`](#fn-speccontrollerinitcontainersvolumemountswithreadonly)
        * [`fn withSubPath(subPath)`](#fn-speccontrollerinitcontainersvolumemountswithsubpath)
        * [`fn withSubPathExpr(subPathExpr)`](#fn-speccontrollerinitcontainersvolumemountswithsubpathexpr)
    ...
    * [`obj spec.controller.sidecarContainers`](#obj-speccontrollersidecarcontainers)
      * [`fn withArgs(args)`](#fn-speccontrollersidecarcontainerswithargs)
      * [`fn withArgsMixin(args)`](#fn-speccontrollersidecarcontainerswithargsmixin)
      * [`fn withCommand(command)`](#fn-speccontrollersidecarcontainerswithcommand)
      * [`fn withCommandMixin(command)`](#fn-speccontrollersidecarcontainerswithcommandmixin)
      * [`fn withEnv(env)`](#fn-speccontrollersidecarcontainerswithenv)
      * [`fn withEnvFrom(envFrom)`](#fn-speccontrollersidecarcontainerswithenvfrom)
      * [`fn withEnvFromMixin(envFrom)`](#fn-speccontrollersidecarcontainerswithenvfrommixin)
      * [`fn withEnvMixin(env)`](#fn-speccontrollersidecarcontainerswithenvmixin)
      * [`fn withImage(image)`](#fn-speccontrollersidecarcontainerswithimage)
      * [`fn withImagePullPolicy(imagePullPolicy)`](#fn-speccontrollersidecarcontainerswithimagepullpolicy)
      * [`fn withName(name)`](#fn-speccontrollersidecarcontainerswithname)
      * [`fn withPorts(ports)`](#fn-speccontrollersidecarcontainerswithports)
      * [`fn withPortsMixin(ports)`](#fn-speccontrollersidecarcontainerswithportsmixin)
      * [`fn withResizePolicy(resizePolicy)`](#fn-speccontrollersidecarcontainerswithresizepolicy)
      * [`fn withResizePolicyMixin(resizePolicy)`](#fn-speccontrollersidecarcontainerswithresizepolicymixin)
      * [`fn withRestartPolicy(restartPolicy)`](#fn-speccontrollersidecarcontainerswithrestartpolicy)
      * [`fn withStdin(stdin)`](#fn-speccontrollersidecarcontainerswithstdin)
      * [`fn withStdinOnce(stdinOnce)`](#fn-speccontrollersidecarcontainerswithstdinonce)
      * [`fn withTerminationMessagePath(terminationMessagePath)`](#fn-speccontrollersidecarcontainerswithterminationmessagepath)
      * [`fn withTerminationMessagePolicy(terminationMessagePolicy)`](#fn-speccontrollersidecarcontainerswithterminationmessagepolicy)
      * [`fn withTty(tty)`](#fn-speccontrollersidecarcontainerswithtty)
      * [`fn withVolumeDevices(volumeDevices)`](#fn-speccontrollersidecarcontainerswithvolumedevices)
      * [`fn withVolumeDevicesMixin(volumeDevices)`](#fn-speccontrollersidecarcontainerswithvolumedevicesmixin)
      * [`fn withVolumeMounts(volumeMounts)`](#fn-speccontrollersidecarcontainerswithvolumemounts)
      * [`fn withVolumeMountsMixin(volumeMounts)`](#fn-speccontrollersidecarcontainerswithvolumemountsmixin)
      * [`fn withWorkingDir(workingDir)`](#fn-speccontrollersidecarcontainerswithworkingdir)
      * [`obj spec.controller.sidecarContainers.env`](#obj-speccontrollersidecarcontainersenv)
        * [`fn withName(name)`](#fn-speccontrollersidecarcontainersenvwithname)
        * [`fn withValue(value)`](#fn-speccontrollersidecarcontainersenvwithvalue)
        * [`obj spec.controller.sidecarContainers.env.valueFrom`](#obj-speccontrollersidecarcontainersenvvaluefrom)
          * [`obj spec.controller.sidecarContainers.env.valueFrom.configMapKeyRef`](#obj-speccontrollersidecarcontainersenvvaluefromconfigmapkeyref)
            * [`fn withKey(key)`](#fn-speccontrollersidecarcontainersenvvaluefromconfigmapkeyrefwithkey)
            * [`fn withName(name)`](#fn-speccontrollersidecarcontainersenvvaluefromconfigmapkeyrefwithname)
            * [`fn withOptional(optional)`](#fn-speccontrollersidecarcontainersenvvaluefromconfigmapkeyrefwithoptional)
          * [`obj spec.controller.sidecarContainers.env.valueFrom.fieldRef`](#obj-speccontrollersidecarcontainersenvvaluefromfieldref)
            * [`fn withApiVersion(apiVersion)`](#fn-speccontrollersidecarcontainersenvvaluefromfieldrefwithapiversion)
            * [`fn withFieldPath(fieldPath)`](#fn-speccontrollersidecarcontainersenvvaluefromfieldrefwithfieldpath)
          * [`obj spec.controller.sidecarContainers.env.valueFrom.resourceFieldRef`](#obj-speccontrollersidecarcontainersenvvaluefromresourcefieldref)
            * [`fn withContainerName(containerName)`](#fn-speccontrollersidecarcontainersenvvaluefromresourcefieldrefwithcontainername)
            * [`fn withDivisor(divisor)`](#fn-speccontrollersidecarcontainersenvvaluefromresourcefieldrefwithdivisor)
            * [`fn withResource(resource)`](#fn-speccontrollersidecarcontainersenvvaluefromresourcefieldrefwithresource)
          * [`obj spec.controller.sidecarContainers.env.valueFrom.secretKeyRef`](#obj-speccontrollersidecarcontainersenvvaluefromsecretkeyref)
            * [`fn withKey(key)`](#fn-speccontrollersidecarcontainersenvvaluefromsecretkeyrefwithkey)
            * [`fn withName(name)`](#fn-speccontrollersidecarcontainersenvvaluefromsecretkeyrefwithname)
            * [`fn withOptional(optional)`](#fn-speccontrollersidecarcontainersenvvaluefromsecretkeyrefwithoptional)
      * [`obj spec.controller.sidecarContainers.envFrom`](#obj-speccontrollersidecarcontainersenvfrom)
        * [`fn withPrefix(prefix)`](#fn-speccontrollersidecarcontainersenvfromwithprefix)
        * [`obj spec.controller.sidecarContainers.envFrom.configMapRef`](#obj-speccontrollersidecarcontainersenvfromconfigmapref)
          * [`fn withName(name)`](#fn-speccontrollersidecarcontainersenvfromconfigmaprefwithname)
          * [`fn withOptional(optional)`](#fn-speccontrollersidecarcontainersenvfromconfigmaprefwithoptional)
        * [`obj spec.controller.sidecarContainers.envFrom.secretRef`](#obj-speccontrollersidecarcontainersenvfromsecretref)
          * [`fn withName(name)`](#fn-speccontrollersidecarcontainersenvfromsecretrefwithname)
          * [`fn withOptional(optional)`](#fn-speccontrollersidecarcontainersenvfromsecretrefwithoptional)
      * [`obj spec.controller.sidecarContainers.lifecycle`](#obj-speccontrollersidecarcontainerslifecycle)
        * [`obj spec.controller.sidecarContainers.lifecycle.postStart`](#obj-speccontrollersidecarcontainerslifecyclepoststart)
          * [`obj spec.controller.sidecarContainers.lifecycle.postStart.exec`](#obj-speccontrollersidecarcontainerslifecyclepoststartexec)
            * [`fn withCommand(command)`](#fn-speccontrollersidecarcontainerslifecyclepoststartexecwithcommand)
            * [`fn withCommandMixin(command)`](#fn-speccontrollersidecarcontainerslifecyclepoststartexecwithcommandmixin)
          * [`obj spec.controller.sidecarContainers.lifecycle.postStart.httpGet`](#obj-speccontrollersidecarcontainerslifecyclepoststarthttpget)
            * [`fn withHost(host)`](#fn-speccontrollersidecarcontainerslifecyclepoststarthttpgetwithhost)
            * [`fn withHttpHeaders(httpHeaders)`](#fn-speccontrollersidecarcontainerslifecyclepoststarthttpgetwithhttpheaders)
            * [`fn withHttpHeadersMixin(httpHeaders)`](#fn-speccontrollersidecarcontainerslifecyclepoststarthttpgetwithhttpheadersmixin)
            * [`fn withPath(path)`](#fn-speccontrollersidecarcontainerslifecyclepoststarthttpgetwithpath)
            * [`fn withPort(port)`](#fn-speccontrollersidecarcontainerslifecyclepoststarthttpgetwithport)
            * [`fn withScheme(scheme)`](#fn-speccontrollersidecarcontainerslifecyclepoststarthttpgetwithscheme)
            * [`obj spec.controller.sidecarContainers.lifecycle.postStart.httpGet.httpHeaders`](#obj-speccontrollersidecarcontainerslifecyclepoststarthttpgethttpheaders)
              * [`fn withName(name)`](#fn-speccontrollersidecarcontainerslifecyclepoststarthttpgethttpheaderswithname)
              * [`fn withValue(value)`](#fn-speccontrollersidecarcontainerslifecyclepoststarthttpgethttpheaderswithvalue)
          * [`obj spec.controller.sidecarContainers.lifecycle.postStart.tcpSocket`](#obj-speccontrollersidecarcontainerslifecyclepoststarttcpsocket)
            * [`fn withHost(host)`](#fn-speccontrollersidecarcontainerslifecyclepoststarttcpsocketwithhost)
            * [`fn withPort(port)`](#fn-speccontrollersidecarcontainerslifecyclepoststarttcpsocketwithport)
        * [`obj spec.controller.sidecarContainers.lifecycle.preStop`](#obj-speccontrollersidecarcontainerslifecycleprestop)
          * [`obj spec.controller.sidecarContainers.lifecycle.preStop.exec`](#obj-speccontrollersidecarcontainerslifecycleprestopexec)
            * [`fn withCommand(command)`](#fn-speccontrollersidecarcontainerslifecycleprestopexecwithcommand)
            * [`fn withCommandMixin(command)`](#fn-speccontrollersidecarcontainerslifecycleprestopexecwithcommandmixin)
          * [`obj spec.controller.sidecarContainers.lifecycle.preStop.httpGet`](#obj-speccontrollersidecarcontainerslifecycleprestophttpget)
            * [`fn withHost(host)`](#fn-speccontrollersidecarcontainerslifecycleprestophttpgetwithhost)
            * [`fn withHttpHeaders(httpHeaders)`](#fn-speccontrollersidecarcontainerslifecycleprestophttpgetwithhttpheaders)
            * [`fn withHttpHeadersMixin(httpHeaders)`](#fn-speccontrollersidecarcontainerslifecycleprestophttpgetwithhttpheadersmixin)
            * [`fn withPath(path)`](#fn-speccontrollersidecarcontainerslifecycleprestophttpgetwithpath)
            * [`fn withPort(port)`](#fn-speccontrollersidecarcontainerslifecycleprestophttpgetwithport)
            * [`fn withScheme(scheme)`](#fn-speccontrollersidecarcontainerslifecycleprestophttpgetwithscheme)
            * [`obj spec.controller.sidecarContainers.lifecycle.preStop.httpGet.httpHeaders`](#obj-speccontrollersidecarcontainerslifecycleprestophttpgethttpheaders)
              * [`fn withName(name)`](#fn-speccontrollersidecarcontainerslifecycleprestophttpgethttpheaderswithname)
              * [`fn withValue(value)`](#fn-speccontrollersidecarcontainerslifecycleprestophttpgethttpheaderswithvalue)
          * [`obj spec.controller.sidecarContainers.lifecycle.preStop.tcpSocket`](#obj-speccontrollersidecarcontainerslifecycleprestoptcpsocket)
            * [`fn withHost(host)`](#fn-speccontrollersidecarcontainerslifecycleprestoptcpsocketwithhost)
            * [`fn withPort(port)`](#fn-speccontrollersidecarcontainerslifecycleprestoptcpsocketwithport)
      * [`obj spec.controller.sidecarContainers.livenessProbe`](#obj-speccontrollersidecarcontainerslivenessprobe)
        * [`fn withFailureThreshold(failureThreshold)`](#fn-speccontrollersidecarcontainerslivenessprobewithfailurethreshold)
        * [`fn withInitialDelaySeconds(initialDelaySeconds)`](#fn-speccontrollersidecarcontainerslivenessprobewithinitialdelayseconds)
        * [`fn withPeriodSeconds(periodSeconds)`](#fn-speccontrollersidecarcontainerslivenessprobewithperiodseconds)
        * [`fn withSuccessThreshold(successThreshold)`](#fn-speccontrollersidecarcontainerslivenessprobewithsuccessthreshold)
        * [`fn withTerminationGracePeriodSeconds(terminationGracePeriodSeconds)`](#fn-speccontrollersidecarcontainerslivenessprobewithterminationgraceperiodseconds)
        * [`fn withTimeoutSeconds(timeoutSeconds)`](#fn-speccontrollersidecarcontainerslivenessprobewithtimeoutseconds)
        * [`obj spec.controller.sidecarContainers.livenessProbe.exec`](#obj-speccontrollersidecarcontainerslivenessprobeexec)
          * [`fn withCommand(command)`](#fn-speccontrollersidecarcontainerslivenessprobeexecwithcommand)
          * [`fn withCommandMixin(command)`](#fn-speccontrollersidecarcontainerslivenessprobeexecwithcommandmixin)
        * [`obj spec.controller.sidecarContainers.livenessProbe.grpc`](#obj-speccontrollersidecarcontainerslivenessprobegrpc)
          * [`fn withPort(port)`](#fn-speccontrollersidecarcontainerslivenessprobegrpcwithport)
          * [`fn withService(service)`](#fn-speccontrollersidecarcontainerslivenessprobegrpcwithservice)
        * [`obj spec.controller.sidecarContainers.livenessProbe.httpGet`](#obj-speccontrollersidecarcontainerslivenessprobehttpget)
          * [`fn withHost(host)`](#fn-speccontrollersidecarcontainerslivenessprobehttpgetwithhost)
          * [`fn withHttpHeaders(httpHeaders)`](#fn-speccontrollersidecarcontainerslivenessprobehttpgetwithhttpheaders)
          * [`fn withHttpHeadersMixin(httpHeaders)`](#fn-speccontrollersidecarcontainerslivenessprobehttpgetwithhttpheadersmixin)
          * [`fn withPath(path)`](#fn-speccontrollersidecarcontainerslivenessprobehttpgetwithpath)
          * [`fn withPort(port)`](#fn-speccontrollersidecarcontainerslivenessprobehttpgetwithport)
          * [`fn withScheme(scheme)`](#fn-speccontrollersidecarcontainerslivenessprobehttpgetwithscheme)
          * [`obj spec.controller.sidecarContainers.livenessProbe.httpGet.httpHeaders`](#obj-speccontrollersidecarcontainerslivenessprobehttpgethttpheaders)
            * [`fn withName(name)`](#fn-speccontrollersidecarcontainerslivenessprobehttpgethttpheaderswithname)
            * [`fn withValue(value)`](#fn-speccontrollersidecarcontainerslivenessprobehttpgethttpheaderswithvalue)
        * [`obj spec.controller.sidecarContainers.livenessProbe.tcpSocket`](#obj-speccontrollersidecarcontainerslivenessprobetcpsocket)
          * [`fn withHost(host)`](#fn-speccontrollersidecarcontainerslivenessprobetcpsocketwithhost)
          * [`fn withPort(port)`](#fn-speccontrollersidecarcontainerslivenessprobetcpsocketwithport)
      * [`obj spec.controller.sidecarContainers.ports`](#obj-speccontrollersidecarcontainersports)
        * [`fn withContainerPort(containerPort)`](#fn-speccontrollersidecarcontainersportswithcontainerport)
        * [`fn withHostIP(hostIP)`](#fn-speccontrollersidecarcontainersportswithhostip)
        * [`fn withHostPort(hostPort)`](#fn-speccontrollersidecarcontainersportswithhostport)
        * [`fn withName(name)`](#fn-speccontrollersidecarcontainersportswithname)
        * [`fn withProtocol(protocol)`](#fn-speccontrollersidecarcontainersportswithprotocol)
      * [`obj spec.controller.sidecarContainers.readinessProbe`](#obj-speccontrollersidecarcontainersreadinessprobe)
        * [`fn withFailureThreshold(failureThreshold)`](#fn-speccontrollersidecarcontainersreadinessprobewithfailurethreshold)
        * [`fn withInitialDelaySeconds(initialDelaySeconds)`](#fn-speccontrollersidecarcontainersreadinessprobewithinitialdelayseconds)
        * [`fn withPeriodSeconds(periodSeconds)`](#fn-speccontrollersidecarcontainersreadinessprobewithperiodseconds)
        * [`fn withSuccessThreshold(successThreshold)`](#fn-speccontrollersidecarcontainersreadinessprobewithsuccessthreshold)
        * [`fn withTerminationGracePeriodSeconds(terminationGracePeriodSeconds)`](#fn-speccontrollersidecarcontainersreadinessprobewithterminationgraceperiodseconds)
        * [`fn withTimeoutSeconds(timeoutSeconds)`](#fn-speccontrollersidecarcontainersreadinessprobewithtimeoutseconds)
        * [`obj spec.controller.sidecarContainers.readinessProbe.exec`](#obj-speccontrollersidecarcontainersreadinessprobeexec)
          * [`fn withCommand(command)`](#fn-speccontrollersidecarcontainersreadinessprobeexecwithcommand)
          * [`fn withCommandMixin(command)`](#fn-speccontrollersidecarcontainersreadinessprobeexecwithcommandmixin)
        * [`obj spec.controller.sidecarContainers.readinessProbe.grpc`](#obj-speccontrollersidecarcontainersreadinessprobegrpc)
          * [`fn withPort(port)`](#fn-speccontrollersidecarcontainersreadinessprobegrpcwithport)
          * [`fn withService(service)`](#fn-speccontrollersidecarcontainersreadinessprobegrpcwithservice)
        * [`obj spec.controller.sidecarContainers.readinessProbe.httpGet`](#obj-speccontrollersidecarcontainersreadinessprobehttpget)
          * [`fn withHost(host)`](#fn-speccontrollersidecarcontainersreadinessprobehttpgetwithhost)
          * [`fn withHttpHeaders(httpHeaders)`](#fn-speccontrollersidecarcontainersreadinessprobehttpgetwithhttpheaders)
          * [`fn withHttpHeadersMixin(httpHeaders)`](#fn-speccontrollersidecarcontainersreadinessprobehttpgetwithhttpheadersmixin)
          * [`fn withPath(path)`](#fn-speccontrollersidecarcontainersreadinessprobehttpgetwithpath)
          * [`fn withPort(port)`](#fn-speccontrollersidecarcontainersreadinessprobehttpgetwithport)
          * [`fn withScheme(scheme)`](#fn-speccontrollersidecarcontainersreadinessprobehttpgetwithscheme)
          * [`obj spec.controller.sidecarContainers.readinessProbe.httpGet.httpHeaders`](#obj-speccontrollersidecarcontainersreadinessprobehttpgethttpheaders)
            * [`fn withName(name)`](#fn-speccontrollersidecarcontainersreadinessprobehttpgethttpheaderswithname)
            * [`fn withValue(value)`](#fn-speccontrollersidecarcontainersreadinessprobehttpgethttpheaderswithvalue)
        * [`obj spec.controller.sidecarContainers.readinessProbe.tcpSocket`](#obj-speccontrollersidecarcontainersreadinessprobetcpsocket)
          * [`fn withHost(host)`](#fn-speccontrollersidecarcontainersreadinessprobetcpsocketwithhost)
          * [`fn withPort(port)`](#fn-speccontrollersidecarcontainersreadinessprobetcpsocketwithport)
      * [`obj spec.controller.sidecarContainers.resizePolicy`](#obj-speccontrollersidecarcontainersresizepolicy)
        * [`fn withResourceName(resourceName)`](#fn-speccontrollersidecarcontainersresizepolicywithresourcename)
        * [`fn withRestartPolicy(restartPolicy)`](#fn-speccontrollersidecarcontainersresizepolicywithrestartpolicy)
      * [`obj spec.controller.sidecarContainers.resources`](#obj-speccontrollersidecarcontainersresources)
        * [`fn withClaims(claims)`](#fn-speccontrollersidecarcontainersresourceswithclaims)
        * [`fn withClaimsMixin(claims)`](#fn-speccontrollersidecarcontainersresourceswithclaimsmixin)
        * [`fn withLimits(limits)`](#fn-speccontrollersidecarcontainersresourceswithlimits)
        * [`fn withLimitsMixin(limits)`](#fn-speccontrollersidecarcontainersresourceswithlimitsmixin)
        * [`fn withRequests(requests)`](#fn-speccontrollersidecarcontainersresourceswithrequests)
        * [`fn withRequestsMixin(requests)`](#fn-speccontrollersidecarcontainersresourceswithrequestsmixin)
        * [`obj spec.controller.sidecarContainers.resources.claims`](#obj-speccontrollersidecarcontainersresourcesclaims)
          * [`fn withName(name)`](#fn-speccontrollersidecarcontainersresourcesclaimswithname)
      * [`obj spec.controller.sidecarContainers.securityContext`](#obj-speccontrollersidecarcontainerssecuritycontext)
        * [`fn withAllowPrivilegeEscalation(allowPrivilegeEscalation)`](#fn-speccontrollersidecarcontainerssecuritycontextwithallowprivilegeescalation)
        * [`fn withPrivileged(privileged)`](#fn-speccontrollersidecarcontainerssecuritycontextwithprivileged)
        * [`fn withProcMount(procMount)`](#fn-speccontrollersidecarcontainerssecuritycontextwithprocmount)
        * [`fn withReadOnlyRootFilesystem(readOnlyRootFilesystem)`](#fn-speccontrollersidecarcontainerssecuritycontextwithreadonlyrootfilesystem)
        * [`fn withRunAsGroup(runAsGroup)`](#fn-speccontrollersidecarcontainerssecuritycontextwithrunasgroup)
        * [`fn withRunAsNonRoot(runAsNonRoot)`](#fn-speccontrollersidecarcontainerssecuritycontextwithrunasnonroot)
        * [`fn withRunAsUser(runAsUser)`](#fn-speccontrollersidecarcontainerssecuritycontextwithrunasuser)
        * [`obj spec.controller.sidecarContainers.securityContext.capabilities`](#obj-speccontrollersidecarcontainerssecuritycontextcapabilities)
          * [`fn withAdd(add)`](#fn-speccontrollersidecarcontainerssecuritycontextcapabilitieswithadd)
          * [`fn withAddMixin(add)`](#fn-speccontrollersidecarcontainerssecuritycontextcapabilitieswithaddmixin)
          * [`fn withDrop(drop)`](#fn-speccontrollersidecarcontainerssecuritycontextcapabilitieswithdrop)
          * [`fn withDropMixin(drop)`](#fn-speccontrollersidecarcontainerssecuritycontextcapabilitieswithdropmixin)
        * [`obj spec.controller.sidecarContainers.securityContext.seLinuxOptions`](#obj-speccontrollersidecarcontainerssecuritycontextselinuxoptions)
          * [`fn withLevel(level)`](#fn-speccontrollersidecarcontainerssecuritycontextselinuxoptionswithlevel)
          * [`fn withRole(role)`](#fn-speccontrollersidecarcontainerssecuritycontextselinuxoptionswithrole)
          * [`fn withType(type)`](#fn-speccontrollersidecarcontainerssecuritycontextselinuxoptionswithtype)
          * [`fn withUser(user)`](#fn-speccontrollersidecarcontainerssecuritycontextselinuxoptionswithuser)
        * [`obj spec.controller.sidecarContainers.securityContext.seccompProfile`](#obj-speccontrollersidecarcontainerssecuritycontextseccompprofile)
          * [`fn withLocalhostProfile(localhostProfile)`](#fn-speccontrollersidecarcontainerssecuritycontextseccompprofilewithlocalhostprofile)
          * [`fn withType(type)`](#fn-speccontrollersidecarcontainerssecuritycontextseccompprofilewithtype)
        * [`obj spec.controller.sidecarContainers.securityContext.windowsOptions`](#obj-speccontrollersidecarcontainerssecuritycontextwindowsoptions)
          * [`fn withGmsaCredentialSpec(gmsaCredentialSpec)`](#fn-speccontrollersidecarcontainerssecuritycontextwindowsoptionswithgmsacredentialspec)
          * [`fn withGmsaCredentialSpecName(gmsaCredentialSpecName)`](#fn-speccontrollersidecarcontainerssecuritycontextwindowsoptionswithgmsacredentialspecname)
          * [`fn withHostProcess(hostProcess)`](#fn-speccontrollersidecarcontainerssecuritycontextwindowsoptionswithhostprocess)
          * [`fn withRunAsUserName(runAsUserName)`](#fn-speccontrollersidecarcontainerssecuritycontextwindowsoptionswithrunasusername)
      * [`obj spec.controller.sidecarContainers.startupProbe`](#obj-speccontrollersidecarcontainersstartupprobe)
        * [`fn withFailureThreshold(failureThreshold)`](#fn-speccontrollersidecarcontainersstartupprobewithfailurethreshold)
        * [`fn withInitialDelaySeconds(initialDelaySeconds)`](#fn-speccontrollersidecarcontainersstartupprobewithinitialdelayseconds)
        * [`fn withPeriodSeconds(periodSeconds)`](#fn-speccontrollersidecarcontainersstartupprobewithperiodseconds)
        * [`fn withSuccessThreshold(successThreshold)`](#fn-speccontrollersidecarcontainersstartupprobewithsuccessthreshold)
        * [`fn withTerminationGracePeriodSeconds(terminationGracePeriodSeconds)`](#fn-speccontrollersidecarcontainersstartupprobewithterminationgraceperiodseconds)
        * [`fn withTimeoutSeconds(timeoutSeconds)`](#fn-speccontrollersidecarcontainersstartupprobewithtimeoutseconds)
        * [`obj spec.controller.sidecarContainers.startupProbe.exec`](#obj-speccontrollersidecarcontainersstartupprobeexec)
          * [`fn withCommand(command)`](#fn-speccontrollersidecarcontainersstartupprobeexecwithcommand)
          * [`fn withCommandMixin(command)`](#fn-speccontrollersidecarcontainersstartupprobeexecwithcommandmixin)
        * [`obj spec.controller.sidecarContainers.startupProbe.grpc`](#obj-speccontrollersidecarcontainersstartupprobegrpc)
          * [`fn withPort(port)`](#fn-speccontrollersidecarcontainersstartupprobegrpcwithport)
          * [`fn withService(service)`](#fn-speccontrollersidecarcontainersstartupprobegrpcwithservice)
        * [`obj spec.controller.sidecarContainers.startupProbe.httpGet`](#obj-speccontrollersidecarcontainersstartupprobehttpget)
          * [`fn withHost(host)`](#fn-speccontrollersidecarcontainersstartupprobehttpgetwithhost)
          * [`fn withHttpHeaders(httpHeaders)`](#fn-speccontrollersidecarcontainersstartupprobehttpgetwithhttpheaders)
          * [`fn withHttpHeadersMixin(httpHeaders)`](#fn-speccontrollersidecarcontainersstartupprobehttpgetwithhttpheadersmixin)
          * [`fn withPath(path)`](#fn-speccontrollersidecarcontainersstartupprobehttpgetwithpath)
          * [`fn withPort(port)`](#fn-speccontrollersidecarcontainersstartupprobehttpgetwithport)
          * [`fn withScheme(scheme)`](#fn-speccontrollersidecarcontainersstartupprobehttpgetwithscheme)
          * [`obj spec.controller.sidecarContainers.startupProbe.httpGet.httpHeaders`](#obj-speccontrollersidecarcontainersstartupprobehttpgethttpheaders)
            * [`fn withName(name)`](#fn-speccontrollersidecarcontainersstartupprobehttpgethttpheaderswithname)
            * [`fn withValue(value)`](#fn-speccontrollersidecarcontainersstartupprobehttpgethttpheaderswithvalue)
        * [`obj spec.controller.sidecarContainers.startupProbe.tcpSocket`](#obj-speccontrollersidecarcontainersstartupprobetcpsocket)
          * [`fn withHost(host)`](#fn-speccontrollersidecarcontainersstartupprobetcpsocketwithhost)
          * [`fn withPort(port)`](#fn-speccontrollersidecarcontainersstartupprobetcpsocketwithport)
      * [`obj spec.controller.sidecarContainers.volumeDevices`](#obj-speccontrollersidecarcontainersvolumedevices)
        * [`fn withDevicePath(devicePath)`](#fn-speccontrollersidecarcontainersvolumedeviceswithdevicepath)
        * [`fn withName(name)`](#fn-speccontrollersidecarcontainersvolumedeviceswithname)
      * [`obj spec.controller.sidecarContainers.volumeMounts`](#obj-speccontrollersidecarcontainersvolumemounts)
        * [`fn withMountPath(mountPath)`](#fn-speccontrollersidecarcontainersvolumemountswithmountpath)
        * [`fn withMountPropagation(mountPropagation)`](#fn-speccontrollersidecarcontainersvolumemountswithmountpropagation)
        * [`fn withName(name)`](#fn-speccontrollersidecarcontainersvolumemountswithname)
        * [`fn withReadOnly(readOnly)`](#fn-speccontrollersidecarcontainersvolumemountswithreadonly)
        * [`fn withSubPath(subPath)`](#fn-speccontrollersidecarcontainersvolumemountswithsubpath)
        * [`fn withSubPathExpr(subPathExpr)`](#fn-speccontrollersidecarcontainersvolumemountswithsubpathexpr)
    * [`obj spec.controller.volumeMounts`](#obj-speccontrollervolumemounts)
      * [`fn withMountPath(mountPath)`](#fn-speccontrollervolumemountswithmountpath)
      * [`fn withMountPropagation(mountPropagation)`](#fn-speccontrollervolumemountswithmountpropagation)
      * [`fn withName(name)`](#fn-speccontrollervolumemountswithname)
      * [`fn withReadOnly(readOnly)`](#fn-speccontrollervolumemountswithreadonly)
      * [`fn withSubPath(subPath)`](#fn-speccontrollervolumemountswithsubpath)
      * [`fn withSubPathExpr(subPathExpr)`](#fn-speccontrollervolumemountswithsubpathexpr)
    * [`obj spec.controller.volumes`](#obj-speccontrollervolumes)
      * [`fn withName(name)`](#fn-speccontrollervolumeswithname)
      * [`obj spec.controller.volumes.awsElasticBlockStore`](#obj-speccontrollervolumesawselasticblockstore)
        * [`fn withFsType(fsType)`](#fn-speccontrollervolumesawselasticblockstorewithfstype)
        * [`fn withPartition(partition)`](#fn-speccontrollervolumesawselasticblockstorewithpartition)
        * [`fn withReadOnly(readOnly)`](#fn-speccontrollervolumesawselasticblockstorewithreadonly)
        * [`fn withVolumeID(volumeID)`](#fn-speccontrollervolumesawselasticblockstorewithvolumeid)
      * [`obj spec.controller.volumes.azureDisk`](#obj-speccontrollervolumesazuredisk)
        * [`fn withCachingMode(cachingMode)`](#fn-speccontrollervolumesazurediskwithcachingmode)
        * [`fn withDiskName(diskName)`](#fn-speccontrollervolumesazurediskwithdiskname)
        * [`fn withDiskURI(diskURI)`](#fn-speccontrollervolumesazurediskwithdiskuri)
        * [`fn withFsType(fsType)`](#fn-speccontrollervolumesazurediskwithfstype)
        * [`fn withKind(kind)`](#fn-speccontrollervolumesazurediskwithkind)
        * [`fn withReadOnly(readOnly)`](#fn-speccontrollervolumesazurediskwithreadonly)
      * [`obj spec.controller.volumes.azureFile`](#obj-speccontrollervolumesazurefile)
        * [`fn withReadOnly(readOnly)`](#fn-speccontrollervolumesazurefilewithreadonly)
        * [`fn withSecretName(secretName)`](#fn-speccontrollervolumesazurefilewithsecretname)
        * [`fn withShareName(shareName)`](#fn-speccontrollervolumesazurefilewithsharename)
      * [`obj spec.controller.volumes.cephfs`](#obj-speccontrollervolumescephfs)
        * [`fn withMonitors(monitors)`](#fn-speccontrollervolumescephfswithmonitors)
        * [`fn withMonitorsMixin(monitors)`](#fn-speccontrollervolumescephfswithmonitorsmixin)
        * [`fn withPath(path)`](#fn-speccontrollervolumescephfswithpath)
        * [`fn withReadOnly(readOnly)`](#fn-speccontrollervolumescephfswithreadonly)
        * [`fn withSecretFile(secretFile)`](#fn-speccontrollervolumescephfswithsecretfile)
        * [`fn withUser(user)`](#fn-speccontrollervolumescephfswithuser)
        * [`obj spec.controller.volumes.cephfs.secretRef`](#obj-speccontrollervolumescephfssecretref)
          * [`fn withName(name)`](#fn-speccontrollervolumescephfssecretrefwithname)
      * [`obj spec.controller.volumes.cinder`](#obj-speccontrollervolumescinder)
        * [`fn withFsType(fsType)`](#fn-speccontrollervolumescinderwithfstype)
        * [`fn withReadOnly(readOnly)`](#fn-speccontrollervolumescinderwithreadonly)
        * [`fn withVolumeID(volumeID)`](#fn-speccontrollervolumescinderwithvolumeid)
        * [`obj spec.controller.volumes.cinder.secretRef`](#obj-speccontrollervolumescindersecretref)
          * [`fn withName(name)`](#fn-speccontrollervolumescindersecretrefwithname)
      * [`obj spec.controller.volumes.configMap`](#obj-speccontrollervolumesconfigmap)
        * [`fn withDefaultMode(defaultMode)`](#fn-speccontrollervolumesconfigmapwithdefaultmode)
        * [`fn withItems(items)`](#fn-speccontrollervolumesconfigmapwithitems)
        * [`fn withItemsMixin(items)`](#fn-speccontrollervolumesconfigmapwithitemsmixin)
        * [`fn withName(name)`](#fn-speccontrollervolumesconfigmapwithname)
        * [`fn withOptional(optional)`](#fn-speccontrollervolumesconfigmapwithoptional)
        * [`obj spec.controller.volumes.configMap.items`](#obj-speccontrollervolumesconfigmapitems)
          * [`fn withKey(key)`](#fn-speccontrollervolumesconfigmapitemswithkey)
          * [`fn withMode(mode)`](#fn-speccontrollervolumesconfigmapitemswithmode)
          * [`fn withPath(path)`](#fn-speccontrollervolumesconfigmapitemswithpath)
      * [`obj spec.controller.volumes.csi`](#obj-speccontrollervolumescsi)
        * [`fn withDriver(driver)`](#fn-speccontrollervolumescsiwithdriver)
        * [`fn withFsType(fsType)`](#fn-speccontrollervolumescsiwithfstype)
        * [`fn withReadOnly(readOnly)`](#fn-speccontrollervolumescsiwithreadonly)
        * [`fn withVolumeAttributes(volumeAttributes)`](#fn-speccontrollervolumescsiwithvolumeattributes)
        * [`fn withVolumeAttributesMixin(volumeAttributes)`](#fn-speccontrollervolumescsiwithvolumeattributesmixin)
        * [`obj spec.controller.volumes.csi.nodePublishSecretRef`](#obj-speccontrollervolumescsinodepublishsecretref)
          * [`fn withName(name)`](#fn-speccontrollervolumescsinodepublishsecretrefwithname)
      * [`obj spec.controller.volumes.downwardAPI`](#obj-speccontrollervolumesdownwardapi)
        * [`fn withDefaultMode(defaultMode)`](#fn-speccontrollervolumesdownwardapiwithdefaultmode)
        * [`fn withItems(items)`](#fn-speccontrollervolumesdownwardapiwithitems)
        * [`fn withItemsMixin(items)`](#fn-speccontrollervolumesdownwardapiwithitemsmixin)
        * [`obj spec.controller.volumes.downwardAPI.items`](#obj-speccontrollervolumesdownwardapiitems)
          * [`fn withMode(mode)`](#fn-speccontrollervolumesdownwardapiitemswithmode)
          * [`fn withPath(path)`](#fn-speccontrollervolumesdownwardapiitemswithpath)
          * [`obj spec.controller.volumes.downwardAPI.items.fieldRef`](#obj-speccontrollervolumesdownwardapiitemsfieldref)
            * [`fn withApiVersion(apiVersion)`](#fn-speccontrollervolumesdownwardapiitemsfieldrefwithapiversion)
            * [`fn withFieldPath(fieldPath)`](#fn-speccontrollervolumesdownwardapiitemsfieldrefwithfieldpath)
          * [`obj spec.controller.volumes.downwardAPI.items.resourceFieldRef`](#obj-speccontrollervolumesdownwardapiitemsresourcefieldref)
            * [`fn withContainerName(containerName)`](#fn-speccontrollervolumesdownwardapiitemsresourcefieldrefwithcontainername)
            * [`fn withDivisor(divisor)`](#fn-speccontrollervolumesdownwardapiitemsresourcefieldrefwithdivisor)
            * [`fn withResource(resource)`](#fn-speccontrollervolumesdownwardapiitemsresourcefieldrefwithresource)
      * [`obj spec.controller.volumes.emptyDir`](#obj-speccontrollervolumesemptydir)
        * [`fn withMedium(medium)`](#fn-speccontrollervolumesemptydirwithmedium)
        * [`fn withSizeLimit(sizeLimit)`](#fn-speccontrollervolumesemptydirwithsizelimit)
      * [`obj spec.controller.volumes.ephemeral`](#obj-speccontrollervolumesephemeral)
        * [`obj spec.controller.volumes.ephemeral.volumeClaimTemplate`](#obj-speccontrollervolumesephemeralvolumeclaimtemplate)
          * [`fn withMetadata(metadata)`](#fn-speccontrollervolumesephemeralvolumeclaimtemplatewithmetadata)
          * [`fn withMetadataMixin(metadata)`](#fn-speccontrollervolumesephemeralvolumeclaimtemplatewithmetadatamixin)
          * [`obj spec.controller.volumes.ephemeral.volumeClaimTemplate.spec`](#obj-speccontrollervolumesephemeralvolumeclaimtemplatespec)
            * [`fn withAccessModes(accessModes)`](#fn-speccontrollervolumesephemeralvolumeclaimtemplatespecwithaccessmodes)
            * [`fn withAccessModesMixin(accessModes)`](#fn-speccontrollervolumesephemeralvolumeclaimtemplatespecwithaccessmodesmixin)
            * [`fn withStorageClassName(storageClassName)`](#fn-speccontrollervolumesephemeralvolumeclaimtemplatespecwithstorageclassname)
            * [`fn withVolumeMode(volumeMode)`](#fn-speccontrollervolumesephemeralvolumeclaimtemplatespecwithvolumemode)
            * [`fn withVolumeName(volumeName)`](#fn-speccontrollervolumesephemeralvolumeclaimtemplatespecwithvolumename)
            * [`obj spec.controller.volumes.ephemeral.volumeClaimTemplate.spec.dataSource`](#obj-speccontrollervolumesephemeralvolumeclaimtemplatespecdatasource)
              * [`fn withApiGroup(apiGroup)`](#fn-speccontrollervolumesephemeralvolumeclaimtemplatespecdatasourcewithapigroup)
              * [`fn withKind(kind)`](#fn-speccontrollervolumesephemeralvolumeclaimtemplatespecdatasourcewithkind)
              * [`fn withName(name)`](#fn-speccontrollervolumesephemeralvolumeclaimtemplatespecdatasourcewithname)
            * [`obj spec.controller.volumes.ephemeral.volumeClaimTemplate.spec.dataSourceRef`](#obj-speccontrollervolumesephemeralvolumeclaimtemplatespecdatasourceref)
              * [`fn withApiGroup(apiGroup)`](#fn-speccontrollervolumesephemeralvolumeclaimtemplatespecdatasourcerefwithapigroup)
              * [`fn withKind(kind)`](#fn-speccontrollervolumesephemeralvolumeclaimtemplatespecdatasourcerefwithkind)
              * [`fn withName(name)`](#fn-speccontrollervolumesephemeralvolumeclaimtemplatespecdatasourcerefwithname)
              * [`fn withNamespace(namespace)`](#fn-speccontrollervolumesephemeralvolumeclaimtemplatespecdatasourcerefwithnamespace)
            * [`obj spec.controller.volumes.ephemeral.volumeClaimTemplate.spec.resources`](#obj-speccontrollervolumesephemeralvolumeclaimtemplatespecresources)
              * [`fn withClaims(claims)`](#fn-speccontrollervolumesephemeralvolumeclaimtemplatespecresourceswithclaims)
              * [`fn withClaimsMixin(claims)`](#fn-speccontrollervolumesephemeralvolumeclaimtemplatespecresourceswithclaimsmixin)
              * [`fn withLimits(limits)`](#fn-speccontrollervolumesephemeralvolumeclaimtemplatespecresourceswithlimits)
              * [`fn withLimitsMixin(limits)`](#fn-speccontrollervolumesephemeralvolumeclaimtemplatespecresourceswithlimitsmixin)
              * [`fn withRequests(requests)`](#fn-speccontrollervolumesephemeralvolumeclaimtemplatespecresourceswithrequests)
              * [`fn withRequestsMixin(requests)`](#fn-speccontrollervolumesephemeralvolumeclaimtemplatespecresourceswithrequestsmixin)
              * [`obj spec.controller.volumes.ephemeral.volumeClaimTemplate.spec.resources.claims`](#obj-speccontrollervolumesephemeralvolumeclaimtemplatespecresourcesclaims)
                * [`fn withName(name)`](#fn-speccontrollervolumesephemeralvolumeclaimtemplatespecresourcesclaimswithname)
            * [`obj spec.controller.volumes.ephemeral.volumeClaimTemplate.spec.selector`](#obj-speccontrollervolumesephemeralvolumeclaimtemplatespecselector)
              * [`fn withMatchExpressions(matchExpressions)`](#fn-speccontrollervolumesephemeralvolumeclaimtemplatespecselectorwithmatchexpressions)
              * [`fn withMatchExpressionsMixin(matchExpressions)`](#fn-speccontrollervolumesephemeralvolumeclaimtemplatespecselectorwithmatchexpressionsmixin)
              * [`fn withMatchLabels(matchLabels)`](#fn-speccontrollervolumesephemeralvolumeclaimtemplatespecselectorwithmatchlabels)
              * [`fn withMatchLabelsMixin(matchLabels)`](#fn-speccontrollervolumesephemeralvolumeclaimtemplatespecselectorwithmatchlabelsmixin)
              * [`obj spec.controller.volumes.ephemeral.volumeClaimTemplate.spec.selector.matchExpressions`](#obj-speccontrollervolumesephemeralvolumeclaimtemplatespecselectormatchexpressions)
                * [`fn withKey(key)`](#fn-speccontrollervolumesephemeralvolumeclaimtemplatespecselectormatchexpressionswithkey)
                * [`fn withOperator(operator)`](#fn-speccontrollervolumesephemeralvolumeclaimtemplatespecselectormatchexpressionswithoperator)
                * [`fn withValues(values)`](#fn-speccontrollervolumesephemeralvolumeclaimtemplatespecselectormatchexpressionswithvalues)
                * [`fn withValuesMixin(values)`](#fn-speccontrollervolumesephemeralvolumeclaimtemplatespecselectormatchexpressionswithvaluesmixin)
      * [`obj spec.controller.volumes.fc`](#obj-speccontrollervolumesfc)
        * [`fn withFsType(fsType)`](#fn-speccontrollervolumesfcwithfstype)
        * [`fn withLun(lun)`](#fn-speccontrollervolumesfcwithlun)
        * [`fn withReadOnly(readOnly)`](#fn-speccontrollervolumesfcwithreadonly)
        * [`fn withTargetWWNs(targetWWNs)`](#fn-speccontrollervolumesfcwithtargetwwns)
        * [`fn withTargetWWNsMixin(targetWWNs)`](#fn-speccontrollervolumesfcwithtargetwwnsmixin)
        * [`fn withWwids(wwids)`](#fn-speccontrollervolumesfcwithwwids)
        * [`fn withWwidsMixin(wwids)`](#fn-speccontrollervolumesfcwithwwidsmixin)
      * [`obj spec.controller.volumes.flexVolume`](#obj-speccontrollervolumesflexvolume)
        * [`fn withDriver(driver)`](#fn-speccontrollervolumesflexvolumewithdriver)
        * [`fn withFsType(fsType)`](#fn-speccontrollervolumesflexvolumewithfstype)
        * [`fn withOptions(options)`](#fn-speccontrollervolumesflexvolumewithoptions)
        * [`fn withOptionsMixin(options)`](#fn-speccontrollervolumesflexvolumewithoptionsmixin)
        * [`fn withReadOnly(readOnly)`](#fn-speccontrollervolumesflexvolumewithreadonly)
        * [`obj spec.controller.volumes.flexVolume.secretRef`](#obj-speccontrollervolumesflexvolumesecretref)
          * [`fn withName(name)`](#fn-speccontrollervolumesflexvolumesecretrefwithname)
      * [`obj spec.controller.volumes.flocker`](#obj-speccontrollervolumesflocker)
        * [`fn withDatasetName(datasetName)`](#fn-speccontrollervolumesflockerwithdatasetname)
        * [`fn withDatasetUUID(datasetUUID)`](#fn-speccontrollervolumesflockerwithdatasetuuid)
      * [`obj spec.controller.volumes.gcePersistentDisk`](#obj-speccontrollervolumesgcepersistentdisk)
        * [`fn withFsType(fsType)`](#fn-speccontrollervolumesgcepersistentdiskwithfstype)
        * [`fn withPartition(partition)`](#fn-speccontrollervolumesgcepersistentdiskwithpartition)
        * [`fn withPdName(pdName)`](#fn-speccontrollervolumesgcepersistentdiskwithpdname)
        * [`fn withReadOnly(readOnly)`](#fn-speccontrollervolumesgcepersistentdiskwithreadonly)
      * [`obj spec.controller.volumes.gitRepo`](#obj-speccontrollervolumesgitrepo)
        * [`fn withDirectory(directory)`](#fn-speccontrollervolumesgitrepowithdirectory)
        * [`fn withRepository(repository)`](#fn-speccontrollervolumesgitrepowithrepository)
        * [`fn withRevision(revision)`](#fn-speccontrollervolumesgitrepowithrevision)
      * [`obj spec.controller.volumes.glusterfs`](#obj-speccontrollervolumesglusterfs)
        * [`fn withEndpoints(endpoints)`](#fn-speccontrollervolumesglusterfswithendpoints)
        * [`fn withPath(path)`](#fn-speccontrollervolumesglusterfswithpath)
        * [`fn withReadOnly(readOnly)`](#fn-speccontrollervolumesglusterfswithreadonly)
      * [`obj spec.controller.volumes.hostPath`](#obj-speccontrollervolumeshostpath)
        * [`fn withPath(path)`](#fn-speccontrollervolumeshostpathwithpath)
        * [`fn withType(type)`](#fn-speccontrollervolumeshostpathwithtype)
      * [`obj spec.controller.volumes.iscsi`](#obj-speccontrollervolumesiscsi)
        * [`fn withChapAuthDiscovery(chapAuthDiscovery)`](#fn-speccontrollervolumesiscsiwithchapauthdiscovery)
        * [`fn withChapAuthSession(chapAuthSession)`](#fn-speccontrollervolumesiscsiwithchapauthsession)
        * [`fn withFsType(fsType)`](#fn-speccontrollervolumesiscsiwithfstype)
        * [`fn withInitiatorName(initiatorName)`](#fn-speccontrollervolumesiscsiwithinitiatorname)
        * [`fn withIqn(iqn)`](#fn-speccontrollervolumesiscsiwithiqn)
        * [`fn withIscsiInterface(iscsiInterface)`](#fn-speccontrollervolumesiscsiwithiscsiinterface)
        * [`fn withLun(lun)`](#fn-speccontrollervolumesiscsiwithlun)
        * [`fn withPortals(portals)`](#fn-speccontrollervolumesiscsiwithportals)
        * [`fn withPortalsMixin(portals)`](#fn-speccontrollervolumesiscsiwithportalsmixin)
        * [`fn withReadOnly(readOnly)`](#fn-speccontrollervolumesiscsiwithreadonly)
        * [`fn withTargetPortal(targetPortal)`](#fn-speccontrollervolumesiscsiwithtargetportal)
        * [`obj spec.controller.volumes.iscsi.secretRef`](#obj-speccontrollervolumesiscsisecretref)
          * [`fn withName(name)`](#fn-speccontrollervolumesiscsisecretrefwithname)
      * [`obj spec.controller.volumes.nfs`](#obj-speccontrollervolumesnfs)
        * [`fn withPath(path)`](#fn-speccontrollervolumesnfswithpath)
        * [`fn withReadOnly(readOnly)`](#fn-speccontrollervolumesnfswithreadonly)
        * [`fn withServer(server)`](#fn-speccontrollervolumesnfswithserver)
      * [`obj spec.controller.volumes.persistentVolumeClaim`](#obj-speccontrollervolumespersistentvolumeclaim)
        * [`fn withClaimName(claimName)`](#fn-speccontrollervolumespersistentvolumeclaimwithclaimname)
        * [`fn withReadOnly(readOnly)`](#fn-speccontrollervolumespersistentvolumeclaimwithreadonly)
      * [`obj spec.controller.volumes.photonPersistentDisk`](#obj-speccontrollervolumesphotonpersistentdisk)
        * [`fn withFsType(fsType)`](#fn-speccontrollervolumesphotonpersistentdiskwithfstype)
        * [`fn withPdID(pdID)`](#fn-speccontrollervolumesphotonpersistentdiskwithpdid)
      * [`obj spec.controller.volumes.portworxVolume`](#obj-speccontrollervolumesportworxvolume)
        * [`fn withFsType(fsType)`](#fn-speccontrollervolumesportworxvolumewithfstype)
        * [`fn withReadOnly(readOnly)`](#fn-speccontrollervolumesportworxvolumewithreadonly)
        * [`fn withVolumeID(volumeID)`](#fn-speccontrollervolumesportworxvolumewithvolumeid)
      * [`obj spec.controller.volumes.projected`](#obj-speccontrollervolumesprojected)
        * [`fn withDefaultMode(defaultMode)`](#fn-speccontrollervolumesprojectedwithdefaultmode)
        * [`fn withSources(sources)`](#fn-speccontrollervolumesprojectedwithsources)
        * [`fn withSourcesMixin(sources)`](#fn-speccontrollervolumesprojectedwithsourcesmixin)
        * [`obj spec.controller.volumes.projected.sources`](#obj-speccontrollervolumesprojectedsources)
          * [`obj spec.controller.volumes.projected.sources.configMap`](#obj-speccontrollervolumesprojectedsourcesconfigmap)
            * [`fn withItems(items)`](#fn-speccontrollervolumesprojectedsourcesconfigmapwithitems)
            * [`fn withItemsMixin(items)`](#fn-speccontrollervolumesprojectedsourcesconfigmapwithitemsmixin)
            * [`fn withName(name)`](#fn-speccontrollervolumesprojectedsourcesconfigmapwithname)
            * [`fn withOptional(optional)`](#fn-speccontrollervolumesprojectedsourcesconfigmapwithoptional)
            * [`obj spec.controller.volumes.projected.sources.configMap.items`](#obj-speccontrollervolumesprojectedsourcesconfigmapitems)
              * [`fn withKey(key)`](#fn-speccontrollervolumesprojectedsourcesconfigmapitemswithkey)
              * [`fn withMode(mode)`](#fn-speccontrollervolumesprojectedsourcesconfigmapitemswithmode)
              * [`fn withPath(path)`](#fn-speccontrollervolumesprojectedsourcesconfigmapitemswithpath)
          * [`obj spec.controller.volumes.projected.sources.downwardAPI`](#obj-speccontrollervolumesprojectedsourcesdownwardapi)
            * [`fn withItems(items)`](#fn-speccontrollervolumesprojectedsourcesdownwardapiwithitems)
            * [`fn withItemsMixin(items)`](#fn-speccontrollervolumesprojectedsourcesdownwardapiwithitemsmixin)
            * [`obj spec.controller.volumes.projected.sources.downwardAPI.items`](#obj-speccontrollervolumesprojectedsourcesdownwardapiitems)
              * [`fn withMode(mode)`](#fn-speccontrollervolumesprojectedsourcesdownwardapiitemswithmode)
              * [`fn withPath(path)`](#fn-speccontrollervolumesprojectedsourcesdownwardapiitemswithpath)
              * [`obj spec.controller.volumes.projected.sources.downwardAPI.items.fieldRef`](#obj-speccontrollervolumesprojectedsourcesdownwardapiitemsfieldref)
                * [`fn withApiVersion(apiVersion)`](#fn-speccontrollervolumesprojectedsourcesdownwardapiitemsfieldrefwithapiversion)
                * [`fn withFieldPath(fieldPath)`](#fn-speccontrollervolumesprojectedsourcesdownwardapiitemsfieldrefwithfieldpath)
              * [`obj spec.controller.volumes.projected.sources.downwardAPI.items.resourceFieldRef`](#obj-speccontrollervolumesprojectedsourcesdownwardapiitemsresourcefieldref)
                * [`fn withContainerName(containerName)`](#fn-speccontrollervolumesprojectedsourcesdownwardapiitemsresourcefieldrefwithcontainername)
                * [`fn withDivisor(divisor)`](#fn-speccontrollervolumesprojectedsourcesdownwardapiitemsresourcefieldrefwithdivisor)
                * [`fn withResource(resource)`](#fn-speccontrollervolumesprojectedsourcesdownwardapiitemsresourcefieldrefwithresource)
          * [`obj spec.controller.volumes.projected.sources.secret`](#obj-speccontrollervolumesprojectedsourcessecret)
            * [`fn withItems(items)`](#fn-speccontrollervolumesprojectedsourcessecretwithitems)
            * [`fn withItemsMixin(items)`](#fn-speccontrollervolumesprojectedsourcessecretwithitemsmixin)
            * [`fn withName(name)`](#fn-speccontrollervolumesprojectedsourcessecretwithname)
            * [`fn withOptional(optional)`](#fn-speccontrollervolumesprojectedsourcessecretwithoptional)
            * [`obj spec.controller.volumes.projected.sources.secret.items`](#obj-speccontrollervolumesprojectedsourcessecretitems)
              * [`fn withKey(key)`](#fn-speccontrollervolumesprojectedsourcessecretitemswithkey)
              * [`fn withMode(mode)`](#fn-speccontrollervolumesprojectedsourcessecretitemswithmode)
              * [`fn withPath(path)`](#fn-speccontrollervolumesprojectedsourcessecretitemswithpath)
          * [`obj spec.controller.volumes.projected.sources.serviceAccountToken`](#obj-speccontrollervolumesprojectedsourcesserviceaccounttoken)
            * [`fn withAudience(audience)`](#fn-speccontrollervolumesprojectedsourcesserviceaccounttokenwithaudience)
            * [`fn withExpirationSeconds(expirationSeconds)`](#fn-speccontrollervolumesprojectedsourcesserviceaccounttokenwithexpirationseconds)
            * [`fn withPath(path)`](#fn-speccontrollervolumesprojectedsourcesserviceaccounttokenwithpath)
      * [`obj spec.controller.volumes.quobyte`](#obj-speccontrollervolumesquobyte)
        * [`fn withGroup(group)`](#fn-speccontrollervolumesquobytewithgroup)
        * [`fn withReadOnly(readOnly)`](#fn-speccontrollervolumesquobytewithreadonly)
        * [`fn withRegistry(registry)`](#fn-speccontrollervolumesquobytewithregistry)
        * [`fn withTenant(tenant)`](#fn-speccontrollervolumesquobytewithtenant)
        * [`fn withUser(user)`](#fn-speccontrollervolumesquobytewithuser)
        * [`fn withVolume(volume)`](#fn-speccontrollervolumesquobytewithvolume)
      * [`obj spec.controller.volumes.rbd`](#obj-speccontrollervolumesrbd)
        * [`fn withFsType(fsType)`](#fn-speccontrollervolumesrbdwithfstype)
        * [`fn withImage(image)`](#fn-speccontrollervolumesrbdwithimage)
        * [`fn withKeyring(keyring)`](#fn-speccontrollervolumesrbdwithkeyring)
        * [`fn withMonitors(monitors)`](#fn-speccontrollervolumesrbdwithmonitors)
        * [`fn withMonitorsMixin(monitors)`](#fn-speccontrollervolumesrbdwithmonitorsmixin)
        * [`fn withPool(pool)`](#fn-speccontrollervolumesrbdwithpool)
        * [`fn withReadOnly(readOnly)`](#fn-speccontrollervolumesrbdwithreadonly)
        * [`fn withUser(user)`](#fn-speccontrollervolumesrbdwithuser)
        * [`obj spec.controller.volumes.rbd.secretRef`](#obj-speccontrollervolumesrbdsecretref)
          * [`fn withName(name)`](#fn-speccontrollervolumesrbdsecretrefwithname)
      * [`obj spec.controller.volumes.scaleIO`](#obj-speccontrollervolumesscaleio)
        * [`fn withFsType(fsType)`](#fn-speccontrollervolumesscaleiowithfstype)
        * [`fn withGateway(gateway)`](#fn-speccontrollervolumesscaleiowithgateway)
        * [`fn withProtectionDomain(protectionDomain)`](#fn-speccontrollervolumesscaleiowithprotectiondomain)
        * [`fn withReadOnly(readOnly)`](#fn-speccontrollervolumesscaleiowithreadonly)
        * [`fn withSslEnabled(sslEnabled)`](#fn-speccontrollervolumesscaleiowithsslenabled)
        * [`fn withStorageMode(storageMode)`](#fn-speccontrollervolumesscaleiowithstoragemode)
        * [`fn withStoragePool(storagePool)`](#fn-speccontrollervolumesscaleiowithstoragepool)
        * [`fn withSystem(system)`](#fn-speccontrollervolumesscaleiowithsystem)
        * [`fn withVolumeName(volumeName)`](#fn-speccontrollervolumesscaleiowithvolumename)
        * [`obj spec.controller.volumes.scaleIO.secretRef`](#obj-speccontrollervolumesscaleiosecretref)
          * [`fn withName(name)`](#fn-speccontrollervolumesscaleiosecretrefwithname)
      * [`obj spec.controller.volumes.secret`](#obj-speccontrollervolumessecret)
        * [`fn withDefaultMode(defaultMode)`](#fn-speccontrollervolumessecretwithdefaultmode)
        * [`fn withItems(items)`](#fn-speccontrollervolumessecretwithitems)
        * [`fn withItemsMixin(items)`](#fn-speccontrollervolumessecretwithitemsmixin)
        * [`fn withOptional(optional)`](#fn-speccontrollervolumessecretwithoptional)
        * [`fn withSecretName(secretName)`](#fn-speccontrollervolumessecretwithsecretname)
        * [`obj spec.controller.volumes.secret.items`](#obj-speccontrollervolumessecretitems)
          * [`fn withKey(key)`](#fn-speccontrollervolumessecretitemswithkey)
          * [`fn withMode(mode)`](#fn-speccontrollervolumessecretitemswithmode)
          * [`fn withPath(path)`](#fn-speccontrollervolumessecretitemswithpath)
      * [`obj spec.controller.volumes.storageos`](#obj-speccontrollervolumesstorageos)
        * [`fn withFsType(fsType)`](#fn-speccontrollervolumesstorageoswithfstype)
        * [`fn withReadOnly(readOnly)`](#fn-speccontrollervolumesstorageoswithreadonly)
        * [`fn withVolumeName(volumeName)`](#fn-speccontrollervolumesstorageoswithvolumename)
        * [`fn withVolumeNamespace(volumeNamespace)`](#fn-speccontrollervolumesstorageoswithvolumenamespace)
        * [`obj spec.controller.volumes.storageos.secretRef`](#obj-speccontrollervolumesstorageossecretref)
          * [`fn withName(name)`](#fn-speccontrollervolumesstorageossecretrefwithname)
      * [`obj spec.controller.volumes.vsphereVolume`](#obj-speccontrollervolumesvspherevolume)
        * [`fn withFsType(fsType)`](#fn-speccontrollervolumesvspherevolumewithfstype)
        * [`fn withStoragePolicyID(storagePolicyID)`](#fn-speccontrollervolumesvspherevolumewithstoragepolicyid)
        * [`fn withStoragePolicyName(storagePolicyName)`](#fn-speccontrollervolumesvspherevolumewithstoragepolicyname)
        * [`fn withVolumePath(volumePath)`](#fn-speccontrollervolumesvspherevolumewithvolumepath)
  ...
  * [`obj spec.redis`](#obj-specredis)
    ...
    * [`fn withEnabled(enabled)`](#fn-specrediswithenabled)
    * [`fn withImage(image)`](#fn-specrediswithimage)
    * [`fn withRemote(remote)`](#fn-specrediswithremote)
  ...
  * [`obj spec.repo`](#obj-specrepo)
    ...
    * [`fn withEnabled(enabled)`](#fn-specrepowithenabled)
    ...
    * [`fn withRemote(remote)`](#fn-specrepowithremote)
  ...
  * [`obj spec.server`](#obj-specserver)
    * [`fn withEnabled(enabled)`](#fn-specserverwithenabled)
    ...
    * [`fn withInitContainers(initContainers)`](#fn-specserverwithinitcontainers)
    * [`fn withInitContainersMixin(initContainers)`](#fn-specserverwithinitcontainersmixin)
    ...
    * [`fn withSidecarContainers(sidecarContainers)`](#fn-specserverwithsidecarcontainers)
    * [`fn withSidecarContainersMixin(sidecarContainers)`](#fn-specserverwithsidecarcontainersmixin)
    * [`fn withVolumeMounts(volumeMounts)`](#fn-specserverwithvolumemounts)
    * [`fn withVolumeMountsMixin(volumeMounts)`](#fn-specserverwithvolumemountsmixin)
    * [`fn withVolumes(volumes)`](#fn-specserverwithvolumes)
    * [`fn withVolumesMixin(volumes)`](#fn-specserverwithvolumesmixin)
    ...
    * [`obj spec.server.initContainers`](#obj-specserverinitcontainers)
      * [`fn withArgs(args)`](#fn-specserverinitcontainerswithargs)
      * [`fn withArgsMixin(args)`](#fn-specserverinitcontainerswithargsmixin)
      * [`fn withCommand(command)`](#fn-specserverinitcontainerswithcommand)
      * [`fn withCommandMixin(command)`](#fn-specserverinitcontainerswithcommandmixin)
      * [`fn withEnv(env)`](#fn-specserverinitcontainerswithenv)
      * [`fn withEnvFrom(envFrom)`](#fn-specserverinitcontainerswithenvfrom)
      * [`fn withEnvFromMixin(envFrom)`](#fn-specserverinitcontainerswithenvfrommixin)
      * [`fn withEnvMixin(env)`](#fn-specserverinitcontainerswithenvmixin)
      * [`fn withImage(image)`](#fn-specserverinitcontainerswithimage)
      * [`fn withImagePullPolicy(imagePullPolicy)`](#fn-specserverinitcontainerswithimagepullpolicy)
      * [`fn withName(name)`](#fn-specserverinitcontainerswithname)
      * [`fn withPorts(ports)`](#fn-specserverinitcontainerswithports)
      * [`fn withPortsMixin(ports)`](#fn-specserverinitcontainerswithportsmixin)
      * [`fn withResizePolicy(resizePolicy)`](#fn-specserverinitcontainerswithresizepolicy)
      * [`fn withResizePolicyMixin(resizePolicy)`](#fn-specserverinitcontainerswithresizepolicymixin)
      * [`fn withRestartPolicy(restartPolicy)`](#fn-specserverinitcontainerswithrestartpolicy)
      * [`fn withStdin(stdin)`](#fn-specserverinitcontainerswithstdin)
      * [`fn withStdinOnce(stdinOnce)`](#fn-specserverinitcontainerswithstdinonce)
      * [`fn withTerminationMessagePath(terminationMessagePath)`](#fn-specserverinitcontainerswithterminationmessagepath)
      * [`fn withTerminationMessagePolicy(terminationMessagePolicy)`](#fn-specserverinitcontainerswithterminationmessagepolicy)
      * [`fn withTty(tty)`](#fn-specserverinitcontainerswithtty)
      * [`fn withVolumeDevices(volumeDevices)`](#fn-specserverinitcontainerswithvolumedevices)
      * [`fn withVolumeDevicesMixin(volumeDevices)`](#fn-specserverinitcontainerswithvolumedevicesmixin)
      * [`fn withVolumeMounts(volumeMounts)`](#fn-specserverinitcontainerswithvolumemounts)
      * [`fn withVolumeMountsMixin(volumeMounts)`](#fn-specserverinitcontainerswithvolumemountsmixin)
      * [`fn withWorkingDir(workingDir)`](#fn-specserverinitcontainerswithworkingdir)
      * [`obj spec.server.initContainers.env`](#obj-specserverinitcontainersenv)
        * [`fn withName(name)`](#fn-specserverinitcontainersenvwithname)
        * [`fn withValue(value)`](#fn-specserverinitcontainersenvwithvalue)
        * [`obj spec.server.initContainers.env.valueFrom`](#obj-specserverinitcontainersenvvaluefrom)
          * [`obj spec.server.initContainers.env.valueFrom.configMapKeyRef`](#obj-specserverinitcontainersenvvaluefromconfigmapkeyref)
            * [`fn withKey(key)`](#fn-specserverinitcontainersenvvaluefromconfigmapkeyrefwithkey)
            * [`fn withName(name)`](#fn-specserverinitcontainersenvvaluefromconfigmapkeyrefwithname)
            * [`fn withOptional(optional)`](#fn-specserverinitcontainersenvvaluefromconfigmapkeyrefwithoptional)
          * [`obj spec.server.initContainers.env.valueFrom.fieldRef`](#obj-specserverinitcontainersenvvaluefromfieldref)
            * [`fn withApiVersion(apiVersion)`](#fn-specserverinitcontainersenvvaluefromfieldrefwithapiversion)
            * [`fn withFieldPath(fieldPath)`](#fn-specserverinitcontainersenvvaluefromfieldrefwithfieldpath)
          * [`obj spec.server.initContainers.env.valueFrom.resourceFieldRef`](#obj-specserverinitcontainersenvvaluefromresourcefieldref)
            * [`fn withContainerName(containerName)`](#fn-specserverinitcontainersenvvaluefromresourcefieldrefwithcontainername)
            * [`fn withDivisor(divisor)`](#fn-specserverinitcontainersenvvaluefromresourcefieldrefwithdivisor)
            * [`fn withResource(resource)`](#fn-specserverinitcontainersenvvaluefromresourcefieldrefwithresource)
          * [`obj spec.server.initContainers.env.valueFrom.secretKeyRef`](#obj-specserverinitcontainersenvvaluefromsecretkeyref)
            * [`fn withKey(key)`](#fn-specserverinitcontainersenvvaluefromsecretkeyrefwithkey)
            * [`fn withName(name)`](#fn-specserverinitcontainersenvvaluefromsecretkeyrefwithname)
            * [`fn withOptional(optional)`](#fn-specserverinitcontainersenvvaluefromsecretkeyrefwithoptional)
      * [`obj spec.server.initContainers.envFrom`](#obj-specserverinitcontainersenvfrom)
        * [`fn withPrefix(prefix)`](#fn-specserverinitcontainersenvfromwithprefix)
        * [`obj spec.server.initContainers.envFrom.configMapRef`](#obj-specserverinitcontainersenvfromconfigmapref)
          * [`fn withName(name)`](#fn-specserverinitcontainersenvfromconfigmaprefwithname)
          * [`fn withOptional(optional)`](#fn-specserverinitcontainersenvfromconfigmaprefwithoptional)
        * [`obj spec.server.initContainers.envFrom.secretRef`](#obj-specserverinitcontainersenvfromsecretref)
          * [`fn withName(name)`](#fn-specserverinitcontainersenvfromsecretrefwithname)
          * [`fn withOptional(optional)`](#fn-specserverinitcontainersenvfromsecretrefwithoptional)
      * [`obj spec.server.initContainers.lifecycle`](#obj-specserverinitcontainerslifecycle)
        * [`obj spec.server.initContainers.lifecycle.postStart`](#obj-specserverinitcontainerslifecyclepoststart)
          * [`obj spec.server.initContainers.lifecycle.postStart.exec`](#obj-specserverinitcontainerslifecyclepoststartexec)
            * [`fn withCommand(command)`](#fn-specserverinitcontainerslifecyclepoststartexecwithcommand)
            * [`fn withCommandMixin(command)`](#fn-specserverinitcontainerslifecyclepoststartexecwithcommandmixin)
          * [`obj spec.server.initContainers.lifecycle.postStart.httpGet`](#obj-specserverinitcontainerslifecyclepoststarthttpget)
            * [`fn withHost(host)`](#fn-specserverinitcontainerslifecyclepoststarthttpgetwithhost)
            * [`fn withHttpHeaders(httpHeaders)`](#fn-specserverinitcontainerslifecyclepoststarthttpgetwithhttpheaders)
            * [`fn withHttpHeadersMixin(httpHeaders)`](#fn-specserverinitcontainerslifecyclepoststarthttpgetwithhttpheadersmixin)
            * [`fn withPath(path)`](#fn-specserverinitcontainerslifecyclepoststarthttpgetwithpath)
            * [`fn withPort(port)`](#fn-specserverinitcontainerslifecyclepoststarthttpgetwithport)
            * [`fn withScheme(scheme)`](#fn-specserverinitcontainerslifecyclepoststarthttpgetwithscheme)
            * [`obj spec.server.initContainers.lifecycle.postStart.httpGet.httpHeaders`](#obj-specserverinitcontainerslifecyclepoststarthttpgethttpheaders)
              * [`fn withName(name)`](#fn-specserverinitcontainerslifecyclepoststarthttpgethttpheaderswithname)
              * [`fn withValue(value)`](#fn-specserverinitcontainerslifecyclepoststarthttpgethttpheaderswithvalue)
          * [`obj spec.server.initContainers.lifecycle.postStart.tcpSocket`](#obj-specserverinitcontainerslifecyclepoststarttcpsocket)
            * [`fn withHost(host)`](#fn-specserverinitcontainerslifecyclepoststarttcpsocketwithhost)
            * [`fn withPort(port)`](#fn-specserverinitcontainerslifecyclepoststarttcpsocketwithport)
        * [`obj spec.server.initContainers.lifecycle.preStop`](#obj-specserverinitcontainerslifecycleprestop)
          * [`obj spec.server.initContainers.lifecycle.preStop.exec`](#obj-specserverinitcontainerslifecycleprestopexec)
            * [`fn withCommand(command)`](#fn-specserverinitcontainerslifecycleprestopexecwithcommand)
            * [`fn withCommandMixin(command)`](#fn-specserverinitcontainerslifecycleprestopexecwithcommandmixin)
          * [`obj spec.server.initContainers.lifecycle.preStop.httpGet`](#obj-specserverinitcontainerslifecycleprestophttpget)
            * [`fn withHost(host)`](#fn-specserverinitcontainerslifecycleprestophttpgetwithhost)
            * [`fn withHttpHeaders(httpHeaders)`](#fn-specserverinitcontainerslifecycleprestophttpgetwithhttpheaders)
            * [`fn withHttpHeadersMixin(httpHeaders)`](#fn-specserverinitcontainerslifecycleprestophttpgetwithhttpheadersmixin)
            * [`fn withPath(path)`](#fn-specserverinitcontainerslifecycleprestophttpgetwithpath)
            * [`fn withPort(port)`](#fn-specserverinitcontainerslifecycleprestophttpgetwithport)
            * [`fn withScheme(scheme)`](#fn-specserverinitcontainerslifecycleprestophttpgetwithscheme)
            * [`obj spec.server.initContainers.lifecycle.preStop.httpGet.httpHeaders`](#obj-specserverinitcontainerslifecycleprestophttpgethttpheaders)
              * [`fn withName(name)`](#fn-specserverinitcontainerslifecycleprestophttpgethttpheaderswithname)
              * [`fn withValue(value)`](#fn-specserverinitcontainerslifecycleprestophttpgethttpheaderswithvalue)
          * [`obj spec.server.initContainers.lifecycle.preStop.tcpSocket`](#obj-specserverinitcontainerslifecycleprestoptcpsocket)
            * [`fn withHost(host)`](#fn-specserverinitcontainerslifecycleprestoptcpsocketwithhost)
            * [`fn withPort(port)`](#fn-specserverinitcontainerslifecycleprestoptcpsocketwithport)
      * [`obj spec.server.initContainers.livenessProbe`](#obj-specserverinitcontainerslivenessprobe)
        * [`fn withFailureThreshold(failureThreshold)`](#fn-specserverinitcontainerslivenessprobewithfailurethreshold)
        * [`fn withInitialDelaySeconds(initialDelaySeconds)`](#fn-specserverinitcontainerslivenessprobewithinitialdelayseconds)
        * [`fn withPeriodSeconds(periodSeconds)`](#fn-specserverinitcontainerslivenessprobewithperiodseconds)
        * [`fn withSuccessThreshold(successThreshold)`](#fn-specserverinitcontainerslivenessprobewithsuccessthreshold)
        * [`fn withTerminationGracePeriodSeconds(terminationGracePeriodSeconds)`](#fn-specserverinitcontainerslivenessprobewithterminationgraceperiodseconds)
        * [`fn withTimeoutSeconds(timeoutSeconds)`](#fn-specserverinitcontainerslivenessprobewithtimeoutseconds)
        * [`obj spec.server.initContainers.livenessProbe.exec`](#obj-specserverinitcontainerslivenessprobeexec)
          * [`fn withCommand(command)`](#fn-specserverinitcontainerslivenessprobeexecwithcommand)
          * [`fn withCommandMixin(command)`](#fn-specserverinitcontainerslivenessprobeexecwithcommandmixin)
        * [`obj spec.server.initContainers.livenessProbe.grpc`](#obj-specserverinitcontainerslivenessprobegrpc)
          * [`fn withPort(port)`](#fn-specserverinitcontainerslivenessprobegrpcwithport)
          * [`fn withService(service)`](#fn-specserverinitcontainerslivenessprobegrpcwithservice)
        * [`obj spec.server.initContainers.livenessProbe.httpGet`](#obj-specserverinitcontainerslivenessprobehttpget)
          * [`fn withHost(host)`](#fn-specserverinitcontainerslivenessprobehttpgetwithhost)
          * [`fn withHttpHeaders(httpHeaders)`](#fn-specserverinitcontainerslivenessprobehttpgetwithhttpheaders)
          * [`fn withHttpHeadersMixin(httpHeaders)`](#fn-specserverinitcontainerslivenessprobehttpgetwithhttpheadersmixin)
          * [`fn withPath(path)`](#fn-specserverinitcontainerslivenessprobehttpgetwithpath)
          * [`fn withPort(port)`](#fn-specserverinitcontainerslivenessprobehttpgetwithport)
          * [`fn withScheme(scheme)`](#fn-specserverinitcontainerslivenessprobehttpgetwithscheme)
          * [`obj spec.server.initContainers.livenessProbe.httpGet.httpHeaders`](#obj-specserverinitcontainerslivenessprobehttpgethttpheaders)
            * [`fn withName(name)`](#fn-specserverinitcontainerslivenessprobehttpgethttpheaderswithname)
            * [`fn withValue(value)`](#fn-specserverinitcontainerslivenessprobehttpgethttpheaderswithvalue)
        * [`obj spec.server.initContainers.livenessProbe.tcpSocket`](#obj-specserverinitcontainerslivenessprobetcpsocket)
          * [`fn withHost(host)`](#fn-specserverinitcontainerslivenessprobetcpsocketwithhost)
          * [`fn withPort(port)`](#fn-specserverinitcontainerslivenessprobetcpsocketwithport)
      * [`obj spec.server.initContainers.ports`](#obj-specserverinitcontainersports)
        * [`fn withContainerPort(containerPort)`](#fn-specserverinitcontainersportswithcontainerport)
        * [`fn withHostIP(hostIP)`](#fn-specserverinitcontainersportswithhostip)
        * [`fn withHostPort(hostPort)`](#fn-specserverinitcontainersportswithhostport)
        * [`fn withName(name)`](#fn-specserverinitcontainersportswithname)
        * [`fn withProtocol(protocol)`](#fn-specserverinitcontainersportswithprotocol)
      * [`obj spec.server.initContainers.readinessProbe`](#obj-specserverinitcontainersreadinessprobe)
        * [`fn withFailureThreshold(failureThreshold)`](#fn-specserverinitcontainersreadinessprobewithfailurethreshold)
        * [`fn withInitialDelaySeconds(initialDelaySeconds)`](#fn-specserverinitcontainersreadinessprobewithinitialdelayseconds)
        * [`fn withPeriodSeconds(periodSeconds)`](#fn-specserverinitcontainersreadinessprobewithperiodseconds)
        * [`fn withSuccessThreshold(successThreshold)`](#fn-specserverinitcontainersreadinessprobewithsuccessthreshold)
        * [`fn withTerminationGracePeriodSeconds(terminationGracePeriodSeconds)`](#fn-specserverinitcontainersreadinessprobewithterminationgraceperiodseconds)
        * [`fn withTimeoutSeconds(timeoutSeconds)`](#fn-specserverinitcontainersreadinessprobewithtimeoutseconds)
        * [`obj spec.server.initContainers.readinessProbe.exec`](#obj-specserverinitcontainersreadinessprobeexec)
          * [`fn withCommand(command)`](#fn-specserverinitcontainersreadinessprobeexecwithcommand)
          * [`fn withCommandMixin(command)`](#fn-specserverinitcontainersreadinessprobeexecwithcommandmixin)
        * [`obj spec.server.initContainers.readinessProbe.grpc`](#obj-specserverinitcontainersreadinessprobegrpc)
          * [`fn withPort(port)`](#fn-specserverinitcontainersreadinessprobegrpcwithport)
          * [`fn withService(service)`](#fn-specserverinitcontainersreadinessprobegrpcwithservice)
        * [`obj spec.server.initContainers.readinessProbe.httpGet`](#obj-specserverinitcontainersreadinessprobehttpget)
          * [`fn withHost(host)`](#fn-specserverinitcontainersreadinessprobehttpgetwithhost)
          * [`fn withHttpHeaders(httpHeaders)`](#fn-specserverinitcontainersreadinessprobehttpgetwithhttpheaders)
          * [`fn withHttpHeadersMixin(httpHeaders)`](#fn-specserverinitcontainersreadinessprobehttpgetwithhttpheadersmixin)
          * [`fn withPath(path)`](#fn-specserverinitcontainersreadinessprobehttpgetwithpath)
          * [`fn withPort(port)`](#fn-specserverinitcontainersreadinessprobehttpgetwithport)
          * [`fn withScheme(scheme)`](#fn-specserverinitcontainersreadinessprobehttpgetwithscheme)
          * [`obj spec.server.initContainers.readinessProbe.httpGet.httpHeaders`](#obj-specserverinitcontainersreadinessprobehttpgethttpheaders)
            * [`fn withName(name)`](#fn-specserverinitcontainersreadinessprobehttpgethttpheaderswithname)
            * [`fn withValue(value)`](#fn-specserverinitcontainersreadinessprobehttpgethttpheaderswithvalue)
        * [`obj spec.server.initContainers.readinessProbe.tcpSocket`](#obj-specserverinitcontainersreadinessprobetcpsocket)
          * [`fn withHost(host)`](#fn-specserverinitcontainersreadinessprobetcpsocketwithhost)
          * [`fn withPort(port)`](#fn-specserverinitcontainersreadinessprobetcpsocketwithport)
      * [`obj spec.server.initContainers.resizePolicy`](#obj-specserverinitcontainersresizepolicy)
        * [`fn withResourceName(resourceName)`](#fn-specserverinitcontainersresizepolicywithresourcename)
        * [`fn withRestartPolicy(restartPolicy)`](#fn-specserverinitcontainersresizepolicywithrestartpolicy)
      * [`obj spec.server.initContainers.resources`](#obj-specserverinitcontainersresources)
        * [`fn withClaims(claims)`](#fn-specserverinitcontainersresourceswithclaims)
        * [`fn withClaimsMixin(claims)`](#fn-specserverinitcontainersresourceswithclaimsmixin)
        * [`fn withLimits(limits)`](#fn-specserverinitcontainersresourceswithlimits)
        * [`fn withLimitsMixin(limits)`](#fn-specserverinitcontainersresourceswithlimitsmixin)
        * [`fn withRequests(requests)`](#fn-specserverinitcontainersresourceswithrequests)
        * [`fn withRequestsMixin(requests)`](#fn-specserverinitcontainersresourceswithrequestsmixin)
        * [`obj spec.server.initContainers.resources.claims`](#obj-specserverinitcontainersresourcesclaims)
          * [`fn withName(name)`](#fn-specserverinitcontainersresourcesclaimswithname)
      * [`obj spec.server.initContainers.securityContext`](#obj-specserverinitcontainerssecuritycontext)
        * [`fn withAllowPrivilegeEscalation(allowPrivilegeEscalation)`](#fn-specserverinitcontainerssecuritycontextwithallowprivilegeescalation)
        * [`fn withPrivileged(privileged)`](#fn-specserverinitcontainerssecuritycontextwithprivileged)
        * [`fn withProcMount(procMount)`](#fn-specserverinitcontainerssecuritycontextwithprocmount)
        * [`fn withReadOnlyRootFilesystem(readOnlyRootFilesystem)`](#fn-specserverinitcontainerssecuritycontextwithreadonlyrootfilesystem)
        * [`fn withRunAsGroup(runAsGroup)`](#fn-specserverinitcontainerssecuritycontextwithrunasgroup)
        * [`fn withRunAsNonRoot(runAsNonRoot)`](#fn-specserverinitcontainerssecuritycontextwithrunasnonroot)
        * [`fn withRunAsUser(runAsUser)`](#fn-specserverinitcontainerssecuritycontextwithrunasuser)
        * [`obj spec.server.initContainers.securityContext.capabilities`](#obj-specserverinitcontainerssecuritycontextcapabilities)
          * [`fn withAdd(add)`](#fn-specserverinitcontainerssecuritycontextcapabilitieswithadd)
          * [`fn withAddMixin(add)`](#fn-specserverinitcontainerssecuritycontextcapabilitieswithaddmixin)
          * [`fn withDrop(drop)`](#fn-specserverinitcontainerssecuritycontextcapabilitieswithdrop)
          * [`fn withDropMixin(drop)`](#fn-specserverinitcontainerssecuritycontextcapabilitieswithdropmixin)
        * [`obj spec.server.initContainers.securityContext.seLinuxOptions`](#obj-specserverinitcontainerssecuritycontextselinuxoptions)
          * [`fn withLevel(level)`](#fn-specserverinitcontainerssecuritycontextselinuxoptionswithlevel)
          * [`fn withRole(role)`](#fn-specserverinitcontainerssecuritycontextselinuxoptionswithrole)
          * [`fn withType(type)`](#fn-specserverinitcontainerssecuritycontextselinuxoptionswithtype)
          * [`fn withUser(user)`](#fn-specserverinitcontainerssecuritycontextselinuxoptionswithuser)
        * [`obj spec.server.initContainers.securityContext.seccompProfile`](#obj-specserverinitcontainerssecuritycontextseccompprofile)
          * [`fn withLocalhostProfile(localhostProfile)`](#fn-specserverinitcontainerssecuritycontextseccompprofilewithlocalhostprofile)
          * [`fn withType(type)`](#fn-specserverinitcontainerssecuritycontextseccompprofilewithtype)
        * [`obj spec.server.initContainers.securityContext.windowsOptions`](#obj-specserverinitcontainerssecuritycontextwindowsoptions)
          * [`fn withGmsaCredentialSpec(gmsaCredentialSpec)`](#fn-specserverinitcontainerssecuritycontextwindowsoptionswithgmsacredentialspec)
          * [`fn withGmsaCredentialSpecName(gmsaCredentialSpecName)`](#fn-specserverinitcontainerssecuritycontextwindowsoptionswithgmsacredentialspecname)
          * [`fn withHostProcess(hostProcess)`](#fn-specserverinitcontainerssecuritycontextwindowsoptionswithhostprocess)
          * [`fn withRunAsUserName(runAsUserName)`](#fn-specserverinitcontainerssecuritycontextwindowsoptionswithrunasusername)
      * [`obj spec.server.initContainers.startupProbe`](#obj-specserverinitcontainersstartupprobe)
        * [`fn withFailureThreshold(failureThreshold)`](#fn-specserverinitcontainersstartupprobewithfailurethreshold)
        * [`fn withInitialDelaySeconds(initialDelaySeconds)`](#fn-specserverinitcontainersstartupprobewithinitialdelayseconds)
        * [`fn withPeriodSeconds(periodSeconds)`](#fn-specserverinitcontainersstartupprobewithperiodseconds)
        * [`fn withSuccessThreshold(successThreshold)`](#fn-specserverinitcontainersstartupprobewithsuccessthreshold)
        * [`fn withTerminationGracePeriodSeconds(terminationGracePeriodSeconds)`](#fn-specserverinitcontainersstartupprobewithterminationgraceperiodseconds)
        * [`fn withTimeoutSeconds(timeoutSeconds)`](#fn-specserverinitcontainersstartupprobewithtimeoutseconds)
        * [`obj spec.server.initContainers.startupProbe.exec`](#obj-specserverinitcontainersstartupprobeexec)
          * [`fn withCommand(command)`](#fn-specserverinitcontainersstartupprobeexecwithcommand)
          * [`fn withCommandMixin(command)`](#fn-specserverinitcontainersstartupprobeexecwithcommandmixin)
        * [`obj spec.server.initContainers.startupProbe.grpc`](#obj-specserverinitcontainersstartupprobegrpc)
          * [`fn withPort(port)`](#fn-specserverinitcontainersstartupprobegrpcwithport)
          * [`fn withService(service)`](#fn-specserverinitcontainersstartupprobegrpcwithservice)
        * [`obj spec.server.initContainers.startupProbe.httpGet`](#obj-specserverinitcontainersstartupprobehttpget)
          * [`fn withHost(host)`](#fn-specserverinitcontainersstartupprobehttpgetwithhost)
          * [`fn withHttpHeaders(httpHeaders)`](#fn-specserverinitcontainersstartupprobehttpgetwithhttpheaders)
          * [`fn withHttpHeadersMixin(httpHeaders)`](#fn-specserverinitcontainersstartupprobehttpgetwithhttpheadersmixin)
          * [`fn withPath(path)`](#fn-specserverinitcontainersstartupprobehttpgetwithpath)
          * [`fn withPort(port)`](#fn-specserverinitcontainersstartupprobehttpgetwithport)
          * [`fn withScheme(scheme)`](#fn-specserverinitcontainersstartupprobehttpgetwithscheme)
          * [`obj spec.server.initContainers.startupProbe.httpGet.httpHeaders`](#obj-specserverinitcontainersstartupprobehttpgethttpheaders)
            * [`fn withName(name)`](#fn-specserverinitcontainersstartupprobehttpgethttpheaderswithname)
            * [`fn withValue(value)`](#fn-specserverinitcontainersstartupprobehttpgethttpheaderswithvalue)
        * [`obj spec.server.initContainers.startupProbe.tcpSocket`](#obj-specserverinitcontainersstartupprobetcpsocket)
          * [`fn withHost(host)`](#fn-specserverinitcontainersstartupprobetcpsocketwithhost)
          * [`fn withPort(port)`](#fn-specserverinitcontainersstartupprobetcpsocketwithport)
      * [`obj spec.server.initContainers.volumeDevices`](#obj-specserverinitcontainersvolumedevices)
        * [`fn withDevicePath(devicePath)`](#fn-specserverinitcontainersvolumedeviceswithdevicepath)
        * [`fn withName(name)`](#fn-specserverinitcontainersvolumedeviceswithname)
      * [`obj spec.server.initContainers.volumeMounts`](#obj-specserverinitcontainersvolumemounts)
        * [`fn withMountPath(mountPath)`](#fn-specserverinitcontainersvolumemountswithmountpath)
        * [`fn withMountPropagation(mountPropagation)`](#fn-specserverinitcontainersvolumemountswithmountpropagation)
        * [`fn withName(name)`](#fn-specserverinitcontainersvolumemountswithname)
        * [`fn withReadOnly(readOnly)`](#fn-specserverinitcontainersvolumemountswithreadonly)
        * [`fn withSubPath(subPath)`](#fn-specserverinitcontainersvolumemountswithsubpath)
        * [`fn withSubPathExpr(subPathExpr)`](#fn-specserverinitcontainersvolumemountswithsubpathexpr)
    ...
    * [`obj spec.server.sidecarContainers`](#obj-specserversidecarcontainers)
      * [`fn withArgs(args)`](#fn-specserversidecarcontainerswithargs)
      * [`fn withArgsMixin(args)`](#fn-specserversidecarcontainerswithargsmixin)
      * [`fn withCommand(command)`](#fn-specserversidecarcontainerswithcommand)
      * [`fn withCommandMixin(command)`](#fn-specserversidecarcontainerswithcommandmixin)
      * [`fn withEnv(env)`](#fn-specserversidecarcontainerswithenv)
      * [`fn withEnvFrom(envFrom)`](#fn-specserversidecarcontainerswithenvfrom)
      * [`fn withEnvFromMixin(envFrom)`](#fn-specserversidecarcontainerswithenvfrommixin)
      * [`fn withEnvMixin(env)`](#fn-specserversidecarcontainerswithenvmixin)
      * [`fn withImage(image)`](#fn-specserversidecarcontainerswithimage)
      * [`fn withImagePullPolicy(imagePullPolicy)`](#fn-specserversidecarcontainerswithimagepullpolicy)
      * [`fn withName(name)`](#fn-specserversidecarcontainerswithname)
      * [`fn withPorts(ports)`](#fn-specserversidecarcontainerswithports)
      * [`fn withPortsMixin(ports)`](#fn-specserversidecarcontainerswithportsmixin)
      * [`fn withResizePolicy(resizePolicy)`](#fn-specserversidecarcontainerswithresizepolicy)
      * [`fn withResizePolicyMixin(resizePolicy)`](#fn-specserversidecarcontainerswithresizepolicymixin)
      * [`fn withRestartPolicy(restartPolicy)`](#fn-specserversidecarcontainerswithrestartpolicy)
      * [`fn withStdin(stdin)`](#fn-specserversidecarcontainerswithstdin)
      * [`fn withStdinOnce(stdinOnce)`](#fn-specserversidecarcontainerswithstdinonce)
      * [`fn withTerminationMessagePath(terminationMessagePath)`](#fn-specserversidecarcontainerswithterminationmessagepath)
      * [`fn withTerminationMessagePolicy(terminationMessagePolicy)`](#fn-specserversidecarcontainerswithterminationmessagepolicy)
      * [`fn withTty(tty)`](#fn-specserversidecarcontainerswithtty)
      * [`fn withVolumeDevices(volumeDevices)`](#fn-specserversidecarcontainerswithvolumedevices)
      * [`fn withVolumeDevicesMixin(volumeDevices)`](#fn-specserversidecarcontainerswithvolumedevicesmixin)
      * [`fn withVolumeMounts(volumeMounts)`](#fn-specserversidecarcontainerswithvolumemounts)
      * [`fn withVolumeMountsMixin(volumeMounts)`](#fn-specserversidecarcontainerswithvolumemountsmixin)
      * [`fn withWorkingDir(workingDir)`](#fn-specserversidecarcontainerswithworkingdir)
      * [`obj spec.server.sidecarContainers.env`](#obj-specserversidecarcontainersenv)
        * [`fn withName(name)`](#fn-specserversidecarcontainersenvwithname)
        * [`fn withValue(value)`](#fn-specserversidecarcontainersenvwithvalue)
        * [`obj spec.server.sidecarContainers.env.valueFrom`](#obj-specserversidecarcontainersenvvaluefrom)
          * [`obj spec.server.sidecarContainers.env.valueFrom.configMapKeyRef`](#obj-specserversidecarcontainersenvvaluefromconfigmapkeyref)
            * [`fn withKey(key)`](#fn-specserversidecarcontainersenvvaluefromconfigmapkeyrefwithkey)
            * [`fn withName(name)`](#fn-specserversidecarcontainersenvvaluefromconfigmapkeyrefwithname)
            * [`fn withOptional(optional)`](#fn-specserversidecarcontainersenvvaluefromconfigmapkeyrefwithoptional)
          * [`obj spec.server.sidecarContainers.env.valueFrom.fieldRef`](#obj-specserversidecarcontainersenvvaluefromfieldref)
            * [`fn withApiVersion(apiVersion)`](#fn-specserversidecarcontainersenvvaluefromfieldrefwithapiversion)
            * [`fn withFieldPath(fieldPath)`](#fn-specserversidecarcontainersenvvaluefromfieldrefwithfieldpath)
          * [`obj spec.server.sidecarContainers.env.valueFrom.resourceFieldRef`](#obj-specserversidecarcontainersenvvaluefromresourcefieldref)
            * [`fn withContainerName(containerName)`](#fn-specserversidecarcontainersenvvaluefromresourcefieldrefwithcontainername)
            * [`fn withDivisor(divisor)`](#fn-specserversidecarcontainersenvvaluefromresourcefieldrefwithdivisor)
            * [`fn withResource(resource)`](#fn-specserversidecarcontainersenvvaluefromresourcefieldrefwithresource)
          * [`obj spec.server.sidecarContainers.env.valueFrom.secretKeyRef`](#obj-specserversidecarcontainersenvvaluefromsecretkeyref)
            * [`fn withKey(key)`](#fn-specserversidecarcontainersenvvaluefromsecretkeyrefwithkey)
            * [`fn withName(name)`](#fn-specserversidecarcontainersenvvaluefromsecretkeyrefwithname)
            * [`fn withOptional(optional)`](#fn-specserversidecarcontainersenvvaluefromsecretkeyrefwithoptional)
      * [`obj spec.server.sidecarContainers.envFrom`](#obj-specserversidecarcontainersenvfrom)
        * [`fn withPrefix(prefix)`](#fn-specserversidecarcontainersenvfromwithprefix)
        * [`obj spec.server.sidecarContainers.envFrom.configMapRef`](#obj-specserversidecarcontainersenvfromconfigmapref)
          * [`fn withName(name)`](#fn-specserversidecarcontainersenvfromconfigmaprefwithname)
          * [`fn withOptional(optional)`](#fn-specserversidecarcontainersenvfromconfigmaprefwithoptional)
        * [`obj spec.server.sidecarContainers.envFrom.secretRef`](#obj-specserversidecarcontainersenvfromsecretref)
          * [`fn withName(name)`](#fn-specserversidecarcontainersenvfromsecretrefwithname)
          * [`fn withOptional(optional)`](#fn-specserversidecarcontainersenvfromsecretrefwithoptional)
      * [`obj spec.server.sidecarContainers.lifecycle`](#obj-specserversidecarcontainerslifecycle)
        * [`obj spec.server.sidecarContainers.lifecycle.postStart`](#obj-specserversidecarcontainerslifecyclepoststart)
          * [`obj spec.server.sidecarContainers.lifecycle.postStart.exec`](#obj-specserversidecarcontainerslifecyclepoststartexec)
            * [`fn withCommand(command)`](#fn-specserversidecarcontainerslifecyclepoststartexecwithcommand)
            * [`fn withCommandMixin(command)`](#fn-specserversidecarcontainerslifecyclepoststartexecwithcommandmixin)
          * [`obj spec.server.sidecarContainers.lifecycle.postStart.httpGet`](#obj-specserversidecarcontainerslifecyclepoststarthttpget)
            * [`fn withHost(host)`](#fn-specserversidecarcontainerslifecyclepoststarthttpgetwithhost)
            * [`fn withHttpHeaders(httpHeaders)`](#fn-specserversidecarcontainerslifecyclepoststarthttpgetwithhttpheaders)
            * [`fn withHttpHeadersMixin(httpHeaders)`](#fn-specserversidecarcontainerslifecyclepoststarthttpgetwithhttpheadersmixin)
            * [`fn withPath(path)`](#fn-specserversidecarcontainerslifecyclepoststarthttpgetwithpath)
            * [`fn withPort(port)`](#fn-specserversidecarcontainerslifecyclepoststarthttpgetwithport)
            * [`fn withScheme(scheme)`](#fn-specserversidecarcontainerslifecyclepoststarthttpgetwithscheme)
            * [`obj spec.server.sidecarContainers.lifecycle.postStart.httpGet.httpHeaders`](#obj-specserversidecarcontainerslifecyclepoststarthttpgethttpheaders)
              * [`fn withName(name)`](#fn-specserversidecarcontainerslifecyclepoststarthttpgethttpheaderswithname)
              * [`fn withValue(value)`](#fn-specserversidecarcontainerslifecyclepoststarthttpgethttpheaderswithvalue)
          * [`obj spec.server.sidecarContainers.lifecycle.postStart.tcpSocket`](#obj-specserversidecarcontainerslifecyclepoststarttcpsocket)
            * [`fn withHost(host)`](#fn-specserversidecarcontainerslifecyclepoststarttcpsocketwithhost)
            * [`fn withPort(port)`](#fn-specserversidecarcontainerslifecyclepoststarttcpsocketwithport)
        * [`obj spec.server.sidecarContainers.lifecycle.preStop`](#obj-specserversidecarcontainerslifecycleprestop)
          * [`obj spec.server.sidecarContainers.lifecycle.preStop.exec`](#obj-specserversidecarcontainerslifecycleprestopexec)
            * [`fn withCommand(command)`](#fn-specserversidecarcontainerslifecycleprestopexecwithcommand)
            * [`fn withCommandMixin(command)`](#fn-specserversidecarcontainerslifecycleprestopexecwithcommandmixin)
          * [`obj spec.server.sidecarContainers.lifecycle.preStop.httpGet`](#obj-specserversidecarcontainerslifecycleprestophttpget)
            * [`fn withHost(host)`](#fn-specserversidecarcontainerslifecycleprestophttpgetwithhost)
            * [`fn withHttpHeaders(httpHeaders)`](#fn-specserversidecarcontainerslifecycleprestophttpgetwithhttpheaders)
            * [`fn withHttpHeadersMixin(httpHeaders)`](#fn-specserversidecarcontainerslifecycleprestophttpgetwithhttpheadersmixin)
            * [`fn withPath(path)`](#fn-specserversidecarcontainerslifecycleprestophttpgetwithpath)
            * [`fn withPort(port)`](#fn-specserversidecarcontainerslifecycleprestophttpgetwithport)
            * [`fn withScheme(scheme)`](#fn-specserversidecarcontainerslifecycleprestophttpgetwithscheme)
            * [`obj spec.server.sidecarContainers.lifecycle.preStop.httpGet.httpHeaders`](#obj-specserversidecarcontainerslifecycleprestophttpgethttpheaders)
              * [`fn withName(name)`](#fn-specserversidecarcontainerslifecycleprestophttpgethttpheaderswithname)
              * [`fn withValue(value)`](#fn-specserversidecarcontainerslifecycleprestophttpgethttpheaderswithvalue)
          * [`obj spec.server.sidecarContainers.lifecycle.preStop.tcpSocket`](#obj-specserversidecarcontainerslifecycleprestoptcpsocket)
            * [`fn withHost(host)`](#fn-specserversidecarcontainerslifecycleprestoptcpsocketwithhost)
            * [`fn withPort(port)`](#fn-specserversidecarcontainerslifecycleprestoptcpsocketwithport)
      * [`obj spec.server.sidecarContainers.livenessProbe`](#obj-specserversidecarcontainerslivenessprobe)
        * [`fn withFailureThreshold(failureThreshold)`](#fn-specserversidecarcontainerslivenessprobewithfailurethreshold)
        * [`fn withInitialDelaySeconds(initialDelaySeconds)`](#fn-specserversidecarcontainerslivenessprobewithinitialdelayseconds)
        * [`fn withPeriodSeconds(periodSeconds)`](#fn-specserversidecarcontainerslivenessprobewithperiodseconds)
        * [`fn withSuccessThreshold(successThreshold)`](#fn-specserversidecarcontainerslivenessprobewithsuccessthreshold)
        * [`fn withTerminationGracePeriodSeconds(terminationGracePeriodSeconds)`](#fn-specserversidecarcontainerslivenessprobewithterminationgraceperiodseconds)
        * [`fn withTimeoutSeconds(timeoutSeconds)`](#fn-specserversidecarcontainerslivenessprobewithtimeoutseconds)
        * [`obj spec.server.sidecarContainers.livenessProbe.exec`](#obj-specserversidecarcontainerslivenessprobeexec)
          * [`fn withCommand(command)`](#fn-specserversidecarcontainerslivenessprobeexecwithcommand)
          * [`fn withCommandMixin(command)`](#fn-specserversidecarcontainerslivenessprobeexecwithcommandmixin)
        * [`obj spec.server.sidecarContainers.livenessProbe.grpc`](#obj-specserversidecarcontainerslivenessprobegrpc)
          * [`fn withPort(port)`](#fn-specserversidecarcontainerslivenessprobegrpcwithport)
          * [`fn withService(service)`](#fn-specserversidecarcontainerslivenessprobegrpcwithservice)
        * [`obj spec.server.sidecarContainers.livenessProbe.httpGet`](#obj-specserversidecarcontainerslivenessprobehttpget)
          * [`fn withHost(host)`](#fn-specserversidecarcontainerslivenessprobehttpgetwithhost)
          * [`fn withHttpHeaders(httpHeaders)`](#fn-specserversidecarcontainerslivenessprobehttpgetwithhttpheaders)
          * [`fn withHttpHeadersMixin(httpHeaders)`](#fn-specserversidecarcontainerslivenessprobehttpgetwithhttpheadersmixin)
          * [`fn withPath(path)`](#fn-specserversidecarcontainerslivenessprobehttpgetwithpath)
          * [`fn withPort(port)`](#fn-specserversidecarcontainerslivenessprobehttpgetwithport)
          * [`fn withScheme(scheme)`](#fn-specserversidecarcontainerslivenessprobehttpgetwithscheme)
          * [`obj spec.server.sidecarContainers.livenessProbe.httpGet.httpHeaders`](#obj-specserversidecarcontainerslivenessprobehttpgethttpheaders)
            * [`fn withName(name)`](#fn-specserversidecarcontainerslivenessprobehttpgethttpheaderswithname)
            * [`fn withValue(value)`](#fn-specserversidecarcontainerslivenessprobehttpgethttpheaderswithvalue)
        * [`obj spec.server.sidecarContainers.livenessProbe.tcpSocket`](#obj-specserversidecarcontainerslivenessprobetcpsocket)
          * [`fn withHost(host)`](#fn-specserversidecarcontainerslivenessprobetcpsocketwithhost)
          * [`fn withPort(port)`](#fn-specserversidecarcontainerslivenessprobetcpsocketwithport)
      * [`obj spec.server.sidecarContainers.ports`](#obj-specserversidecarcontainersports)
        * [`fn withContainerPort(containerPort)`](#fn-specserversidecarcontainersportswithcontainerport)
        * [`fn withHostIP(hostIP)`](#fn-specserversidecarcontainersportswithhostip)
        * [`fn withHostPort(hostPort)`](#fn-specserversidecarcontainersportswithhostport)
        * [`fn withName(name)`](#fn-specserversidecarcontainersportswithname)
        * [`fn withProtocol(protocol)`](#fn-specserversidecarcontainersportswithprotocol)
      * [`obj spec.server.sidecarContainers.readinessProbe`](#obj-specserversidecarcontainersreadinessprobe)
        * [`fn withFailureThreshold(failureThreshold)`](#fn-specserversidecarcontainersreadinessprobewithfailurethreshold)
        * [`fn withInitialDelaySeconds(initialDelaySeconds)`](#fn-specserversidecarcontainersreadinessprobewithinitialdelayseconds)
        * [`fn withPeriodSeconds(periodSeconds)`](#fn-specserversidecarcontainersreadinessprobewithperiodseconds)
        * [`fn withSuccessThreshold(successThreshold)`](#fn-specserversidecarcontainersreadinessprobewithsuccessthreshold)
        * [`fn withTerminationGracePeriodSeconds(terminationGracePeriodSeconds)`](#fn-specserversidecarcontainersreadinessprobewithterminationgraceperiodseconds)
        * [`fn withTimeoutSeconds(timeoutSeconds)`](#fn-specserversidecarcontainersreadinessprobewithtimeoutseconds)
        * [`obj spec.server.sidecarContainers.readinessProbe.exec`](#obj-specserversidecarcontainersreadinessprobeexec)
          * [`fn withCommand(command)`](#fn-specserversidecarcontainersreadinessprobeexecwithcommand)
          * [`fn withCommandMixin(command)`](#fn-specserversidecarcontainersreadinessprobeexecwithcommandmixin)
        * [`obj spec.server.sidecarContainers.readinessProbe.grpc`](#obj-specserversidecarcontainersreadinessprobegrpc)
          * [`fn withPort(port)`](#fn-specserversidecarcontainersreadinessprobegrpcwithport)
          * [`fn withService(service)`](#fn-specserversidecarcontainersreadinessprobegrpcwithservice)
        * [`obj spec.server.sidecarContainers.readinessProbe.httpGet`](#obj-specserversidecarcontainersreadinessprobehttpget)
          * [`fn withHost(host)`](#fn-specserversidecarcontainersreadinessprobehttpgetwithhost)
          * [`fn withHttpHeaders(httpHeaders)`](#fn-specserversidecarcontainersreadinessprobehttpgetwithhttpheaders)
          * [`fn withHttpHeadersMixin(httpHeaders)`](#fn-specserversidecarcontainersreadinessprobehttpgetwithhttpheadersmixin)
          * [`fn withPath(path)`](#fn-specserversidecarcontainersreadinessprobehttpgetwithpath)
          * [`fn withPort(port)`](#fn-specserversidecarcontainersreadinessprobehttpgetwithport)
          * [`fn withScheme(scheme)`](#fn-specserversidecarcontainersreadinessprobehttpgetwithscheme)
          * [`obj spec.server.sidecarContainers.readinessProbe.httpGet.httpHeaders`](#obj-specserversidecarcontainersreadinessprobehttpgethttpheaders)
            * [`fn withName(name)`](#fn-specserversidecarcontainersreadinessprobehttpgethttpheaderswithname)
            * [`fn withValue(value)`](#fn-specserversidecarcontainersreadinessprobehttpgethttpheaderswithvalue)
        * [`obj spec.server.sidecarContainers.readinessProbe.tcpSocket`](#obj-specserversidecarcontainersreadinessprobetcpsocket)
          * [`fn withHost(host)`](#fn-specserversidecarcontainersreadinessprobetcpsocketwithhost)
          * [`fn withPort(port)`](#fn-specserversidecarcontainersreadinessprobetcpsocketwithport)
      * [`obj spec.server.sidecarContainers.resizePolicy`](#obj-specserversidecarcontainersresizepolicy)
        * [`fn withResourceName(resourceName)`](#fn-specserversidecarcontainersresizepolicywithresourcename)
        * [`fn withRestartPolicy(restartPolicy)`](#fn-specserversidecarcontainersresizepolicywithrestartpolicy)
      * [`obj spec.server.sidecarContainers.resources`](#obj-specserversidecarcontainersresources)
        * [`fn withClaims(claims)`](#fn-specserversidecarcontainersresourceswithclaims)
        * [`fn withClaimsMixin(claims)`](#fn-specserversidecarcontainersresourceswithclaimsmixin)
        * [`fn withLimits(limits)`](#fn-specserversidecarcontainersresourceswithlimits)
        * [`fn withLimitsMixin(limits)`](#fn-specserversidecarcontainersresourceswithlimitsmixin)
        * [`fn withRequests(requests)`](#fn-specserversidecarcontainersresourceswithrequests)
        * [`fn withRequestsMixin(requests)`](#fn-specserversidecarcontainersresourceswithrequestsmixin)
        * [`obj spec.server.sidecarContainers.resources.claims`](#obj-specserversidecarcontainersresourcesclaims)
          * [`fn withName(name)`](#fn-specserversidecarcontainersresourcesclaimswithname)
      * [`obj spec.server.sidecarContainers.securityContext`](#obj-specserversidecarcontainerssecuritycontext)
        * [`fn withAllowPrivilegeEscalation(allowPrivilegeEscalation)`](#fn-specserversidecarcontainerssecuritycontextwithallowprivilegeescalation)
        * [`fn withPrivileged(privileged)`](#fn-specserversidecarcontainerssecuritycontextwithprivileged)
        * [`fn withProcMount(procMount)`](#fn-specserversidecarcontainerssecuritycontextwithprocmount)
        * [`fn withReadOnlyRootFilesystem(readOnlyRootFilesystem)`](#fn-specserversidecarcontainerssecuritycontextwithreadonlyrootfilesystem)
        * [`fn withRunAsGroup(runAsGroup)`](#fn-specserversidecarcontainerssecuritycontextwithrunasgroup)
        * [`fn withRunAsNonRoot(runAsNonRoot)`](#fn-specserversidecarcontainerssecuritycontextwithrunasnonroot)
        * [`fn withRunAsUser(runAsUser)`](#fn-specserversidecarcontainerssecuritycontextwithrunasuser)
        * [`obj spec.server.sidecarContainers.securityContext.capabilities`](#obj-specserversidecarcontainerssecuritycontextcapabilities)
          * [`fn withAdd(add)`](#fn-specserversidecarcontainerssecuritycontextcapabilitieswithadd)
          * [`fn withAddMixin(add)`](#fn-specserversidecarcontainerssecuritycontextcapabilitieswithaddmixin)
          * [`fn withDrop(drop)`](#fn-specserversidecarcontainerssecuritycontextcapabilitieswithdrop)
          * [`fn withDropMixin(drop)`](#fn-specserversidecarcontainerssecuritycontextcapabilitieswithdropmixin)
        * [`obj spec.server.sidecarContainers.securityContext.seLinuxOptions`](#obj-specserversidecarcontainerssecuritycontextselinuxoptions)
          * [`fn withLevel(level)`](#fn-specserversidecarcontainerssecuritycontextselinuxoptionswithlevel)
          * [`fn withRole(role)`](#fn-specserversidecarcontainerssecuritycontextselinuxoptionswithrole)
          * [`fn withType(type)`](#fn-specserversidecarcontainerssecuritycontextselinuxoptionswithtype)
          * [`fn withUser(user)`](#fn-specserversidecarcontainerssecuritycontextselinuxoptionswithuser)
        * [`obj spec.server.sidecarContainers.securityContext.seccompProfile`](#obj-specserversidecarcontainerssecuritycontextseccompprofile)
          * [`fn withLocalhostProfile(localhostProfile)`](#fn-specserversidecarcontainerssecuritycontextseccompprofilewithlocalhostprofile)
          * [`fn withType(type)`](#fn-specserversidecarcontainerssecuritycontextseccompprofilewithtype)
        * [`obj spec.server.sidecarContainers.securityContext.windowsOptions`](#obj-specserversidecarcontainerssecuritycontextwindowsoptions)
          * [`fn withGmsaCredentialSpec(gmsaCredentialSpec)`](#fn-specserversidecarcontainerssecuritycontextwindowsoptionswithgmsacredentialspec)
          * [`fn withGmsaCredentialSpecName(gmsaCredentialSpecName)`](#fn-specserversidecarcontainerssecuritycontextwindowsoptionswithgmsacredentialspecname)
          * [`fn withHostProcess(hostProcess)`](#fn-specserversidecarcontainerssecuritycontextwindowsoptionswithhostprocess)
          * [`fn withRunAsUserName(runAsUserName)`](#fn-specserversidecarcontainerssecuritycontextwindowsoptionswithrunasusername)
      * [`obj spec.server.sidecarContainers.startupProbe`](#obj-specserversidecarcontainersstartupprobe)
        * [`fn withFailureThreshold(failureThreshold)`](#fn-specserversidecarcontainersstartupprobewithfailurethreshold)
        * [`fn withInitialDelaySeconds(initialDelaySeconds)`](#fn-specserversidecarcontainersstartupprobewithinitialdelayseconds)
        * [`fn withPeriodSeconds(periodSeconds)`](#fn-specserversidecarcontainersstartupprobewithperiodseconds)
        * [`fn withSuccessThreshold(successThreshold)`](#fn-specserversidecarcontainersstartupprobewithsuccessthreshold)
        * [`fn withTerminationGracePeriodSeconds(terminationGracePeriodSeconds)`](#fn-specserversidecarcontainersstartupprobewithterminationgraceperiodseconds)
        * [`fn withTimeoutSeconds(timeoutSeconds)`](#fn-specserversidecarcontainersstartupprobewithtimeoutseconds)
        * [`obj spec.server.sidecarContainers.startupProbe.exec`](#obj-specserversidecarcontainersstartupprobeexec)
          * [`fn withCommand(command)`](#fn-specserversidecarcontainersstartupprobeexecwithcommand)
          * [`fn withCommandMixin(command)`](#fn-specserversidecarcontainersstartupprobeexecwithcommandmixin)
        * [`obj spec.server.sidecarContainers.startupProbe.grpc`](#obj-specserversidecarcontainersstartupprobegrpc)
          * [`fn withPort(port)`](#fn-specserversidecarcontainersstartupprobegrpcwithport)
          * [`fn withService(service)`](#fn-specserversidecarcontainersstartupprobegrpcwithservice)
        * [`obj spec.server.sidecarContainers.startupProbe.httpGet`](#obj-specserversidecarcontainersstartupprobehttpget)
          * [`fn withHost(host)`](#fn-specserversidecarcontainersstartupprobehttpgetwithhost)
          * [`fn withHttpHeaders(httpHeaders)`](#fn-specserversidecarcontainersstartupprobehttpgetwithhttpheaders)
          * [`fn withHttpHeadersMixin(httpHeaders)`](#fn-specserversidecarcontainersstartupprobehttpgetwithhttpheadersmixin)
          * [`fn withPath(path)`](#fn-specserversidecarcontainersstartupprobehttpgetwithpath)
          * [`fn withPort(port)`](#fn-specserversidecarcontainersstartupprobehttpgetwithport)
          * [`fn withScheme(scheme)`](#fn-specserversidecarcontainersstartupprobehttpgetwithscheme)
          * [`obj spec.server.sidecarContainers.startupProbe.httpGet.httpHeaders`](#obj-specserversidecarcontainersstartupprobehttpgethttpheaders)
            * [`fn withName(name)`](#fn-specserversidecarcontainersstartupprobehttpgethttpheaderswithname)
            * [`fn withValue(value)`](#fn-specserversidecarcontainersstartupprobehttpgethttpheaderswithvalue)
        * [`obj spec.server.sidecarContainers.startupProbe.tcpSocket`](#obj-specserversidecarcontainersstartupprobetcpsocket)
          * [`fn withHost(host)`](#fn-specserversidecarcontainersstartupprobetcpsocketwithhost)
          * [`fn withPort(port)`](#fn-specserversidecarcontainersstartupprobetcpsocketwithport)
      * [`obj spec.server.sidecarContainers.volumeDevices`](#obj-specserversidecarcontainersvolumedevices)
        * [`fn withDevicePath(devicePath)`](#fn-specserversidecarcontainersvolumedeviceswithdevicepath)
        * [`fn withName(name)`](#fn-specserversidecarcontainersvolumedeviceswithname)
      * [`obj spec.server.sidecarContainers.volumeMounts`](#obj-specserversidecarcontainersvolumemounts)
        * [`fn withMountPath(mountPath)`](#fn-specserversidecarcontainersvolumemountswithmountpath)
        * [`fn withMountPropagation(mountPropagation)`](#fn-specserversidecarcontainersvolumemountswithmountpropagation)
        * [`fn withName(name)`](#fn-specserversidecarcontainersvolumemountswithname)
        * [`fn withReadOnly(readOnly)`](#fn-specserversidecarcontainersvolumemountswithreadonly)
        * [`fn withSubPath(subPath)`](#fn-specserversidecarcontainersvolumemountswithsubpath)
        * [`fn withSubPathExpr(subPathExpr)`](#fn-specserversidecarcontainersvolumemountswithsubpathexpr)
    * [`obj spec.server.volumeMounts`](#obj-specservervolumemounts)
      * [`fn withMountPath(mountPath)`](#fn-specservervolumemountswithmountpath)
      * [`fn withMountPropagation(mountPropagation)`](#fn-specservervolumemountswithmountpropagation)
      * [`fn withName(name)`](#fn-specservervolumemountswithname)
      * [`fn withReadOnly(readOnly)`](#fn-specservervolumemountswithreadonly)
      * [`fn withSubPath(subPath)`](#fn-specservervolumemountswithsubpath)
      * [`fn withSubPathExpr(subPathExpr)`](#fn-specservervolumemountswithsubpathexpr)
    * [`obj spec.server.volumes`](#obj-specservervolumes)
      * [`fn withName(name)`](#fn-specservervolumeswithname)
      * [`obj spec.server.volumes.awsElasticBlockStore`](#obj-specservervolumesawselasticblockstore)
        * [`fn withFsType(fsType)`](#fn-specservervolumesawselasticblockstorewithfstype)
        * [`fn withPartition(partition)`](#fn-specservervolumesawselasticblockstorewithpartition)
        * [`fn withReadOnly(readOnly)`](#fn-specservervolumesawselasticblockstorewithreadonly)
        * [`fn withVolumeID(volumeID)`](#fn-specservervolumesawselasticblockstorewithvolumeid)
      * [`obj spec.server.volumes.azureDisk`](#obj-specservervolumesazuredisk)
        * [`fn withCachingMode(cachingMode)`](#fn-specservervolumesazurediskwithcachingmode)
        * [`fn withDiskName(diskName)`](#fn-specservervolumesazurediskwithdiskname)
        * [`fn withDiskURI(diskURI)`](#fn-specservervolumesazurediskwithdiskuri)
        * [`fn withFsType(fsType)`](#fn-specservervolumesazurediskwithfstype)
        * [`fn withKind(kind)`](#fn-specservervolumesazurediskwithkind)
        * [`fn withReadOnly(readOnly)`](#fn-specservervolumesazurediskwithreadonly)
      * [`obj spec.server.volumes.azureFile`](#obj-specservervolumesazurefile)
        * [`fn withReadOnly(readOnly)`](#fn-specservervolumesazurefilewithreadonly)
        * [`fn withSecretName(secretName)`](#fn-specservervolumesazurefilewithsecretname)
        * [`fn withShareName(shareName)`](#fn-specservervolumesazurefilewithsharename)
      * [`obj spec.server.volumes.cephfs`](#obj-specservervolumescephfs)
        * [`fn withMonitors(monitors)`](#fn-specservervolumescephfswithmonitors)
        * [`fn withMonitorsMixin(monitors)`](#fn-specservervolumescephfswithmonitorsmixin)
        * [`fn withPath(path)`](#fn-specservervolumescephfswithpath)
        * [`fn withReadOnly(readOnly)`](#fn-specservervolumescephfswithreadonly)
        * [`fn withSecretFile(secretFile)`](#fn-specservervolumescephfswithsecretfile)
        * [`fn withUser(user)`](#fn-specservervolumescephfswithuser)
        * [`obj spec.server.volumes.cephfs.secretRef`](#obj-specservervolumescephfssecretref)
          * [`fn withName(name)`](#fn-specservervolumescephfssecretrefwithname)
      * [`obj spec.server.volumes.cinder`](#obj-specservervolumescinder)
        * [`fn withFsType(fsType)`](#fn-specservervolumescinderwithfstype)
        * [`fn withReadOnly(readOnly)`](#fn-specservervolumescinderwithreadonly)
        * [`fn withVolumeID(volumeID)`](#fn-specservervolumescinderwithvolumeid)
        * [`obj spec.server.volumes.cinder.secretRef`](#obj-specservervolumescindersecretref)
          * [`fn withName(name)`](#fn-specservervolumescindersecretrefwithname)
      * [`obj spec.server.volumes.configMap`](#obj-specservervolumesconfigmap)
        * [`fn withDefaultMode(defaultMode)`](#fn-specservervolumesconfigmapwithdefaultmode)
        * [`fn withItems(items)`](#fn-specservervolumesconfigmapwithitems)
        * [`fn withItemsMixin(items)`](#fn-specservervolumesconfigmapwithitemsmixin)
        * [`fn withName(name)`](#fn-specservervolumesconfigmapwithname)
        * [`fn withOptional(optional)`](#fn-specservervolumesconfigmapwithoptional)
        * [`obj spec.server.volumes.configMap.items`](#obj-specservervolumesconfigmapitems)
          * [`fn withKey(key)`](#fn-specservervolumesconfigmapitemswithkey)
          * [`fn withMode(mode)`](#fn-specservervolumesconfigmapitemswithmode)
          * [`fn withPath(path)`](#fn-specservervolumesconfigmapitemswithpath)
      * [`obj spec.server.volumes.csi`](#obj-specservervolumescsi)
        * [`fn withDriver(driver)`](#fn-specservervolumescsiwithdriver)
        * [`fn withFsType(fsType)`](#fn-specservervolumescsiwithfstype)
        * [`fn withReadOnly(readOnly)`](#fn-specservervolumescsiwithreadonly)
        * [`fn withVolumeAttributes(volumeAttributes)`](#fn-specservervolumescsiwithvolumeattributes)
        * [`fn withVolumeAttributesMixin(volumeAttributes)`](#fn-specservervolumescsiwithvolumeattributesmixin)
        * [`obj spec.server.volumes.csi.nodePublishSecretRef`](#obj-specservervolumescsinodepublishsecretref)
          * [`fn withName(name)`](#fn-specservervolumescsinodepublishsecretrefwithname)
      * [`obj spec.server.volumes.downwardAPI`](#obj-specservervolumesdownwardapi)
        * [`fn withDefaultMode(defaultMode)`](#fn-specservervolumesdownwardapiwithdefaultmode)
        * [`fn withItems(items)`](#fn-specservervolumesdownwardapiwithitems)
        * [`fn withItemsMixin(items)`](#fn-specservervolumesdownwardapiwithitemsmixin)
        * [`obj spec.server.volumes.downwardAPI.items`](#obj-specservervolumesdownwardapiitems)
          * [`fn withMode(mode)`](#fn-specservervolumesdownwardapiitemswithmode)
          * [`fn withPath(path)`](#fn-specservervolumesdownwardapiitemswithpath)
          * [`obj spec.server.volumes.downwardAPI.items.fieldRef`](#obj-specservervolumesdownwardapiitemsfieldref)
            * [`fn withApiVersion(apiVersion)`](#fn-specservervolumesdownwardapiitemsfieldrefwithapiversion)
            * [`fn withFieldPath(fieldPath)`](#fn-specservervolumesdownwardapiitemsfieldrefwithfieldpath)
          * [`obj spec.server.volumes.downwardAPI.items.resourceFieldRef`](#obj-specservervolumesdownwardapiitemsresourcefieldref)
            * [`fn withContainerName(containerName)`](#fn-specservervolumesdownwardapiitemsresourcefieldrefwithcontainername)
            * [`fn withDivisor(divisor)`](#fn-specservervolumesdownwardapiitemsresourcefieldrefwithdivisor)
            * [`fn withResource(resource)`](#fn-specservervolumesdownwardapiitemsresourcefieldrefwithresource)
      * [`obj spec.server.volumes.emptyDir`](#obj-specservervolumesemptydir)
        * [`fn withMedium(medium)`](#fn-specservervolumesemptydirwithmedium)
        * [`fn withSizeLimit(sizeLimit)`](#fn-specservervolumesemptydirwithsizelimit)
      * [`obj spec.server.volumes.ephemeral`](#obj-specservervolumesephemeral)
        * [`obj spec.server.volumes.ephemeral.volumeClaimTemplate`](#obj-specservervolumesephemeralvolumeclaimtemplate)
          * [`fn withMetadata(metadata)`](#fn-specservervolumesephemeralvolumeclaimtemplatewithmetadata)
          * [`fn withMetadataMixin(metadata)`](#fn-specservervolumesephemeralvolumeclaimtemplatewithmetadatamixin)
          * [`obj spec.server.volumes.ephemeral.volumeClaimTemplate.spec`](#obj-specservervolumesephemeralvolumeclaimtemplatespec)
            * [`fn withAccessModes(accessModes)`](#fn-specservervolumesephemeralvolumeclaimtemplatespecwithaccessmodes)
            * [`fn withAccessModesMixin(accessModes)`](#fn-specservervolumesephemeralvolumeclaimtemplatespecwithaccessmodesmixin)
            * [`fn withStorageClassName(storageClassName)`](#fn-specservervolumesephemeralvolumeclaimtemplatespecwithstorageclassname)
            * [`fn withVolumeMode(volumeMode)`](#fn-specservervolumesephemeralvolumeclaimtemplatespecwithvolumemode)
            * [`fn withVolumeName(volumeName)`](#fn-specservervolumesephemeralvolumeclaimtemplatespecwithvolumename)
            * [`obj spec.server.volumes.ephemeral.volumeClaimTemplate.spec.dataSource`](#obj-specservervolumesephemeralvolumeclaimtemplatespecdatasource)
              * [`fn withApiGroup(apiGroup)`](#fn-specservervolumesephemeralvolumeclaimtemplatespecdatasourcewithapigroup)
              * [`fn withKind(kind)`](#fn-specservervolumesephemeralvolumeclaimtemplatespecdatasourcewithkind)
              * [`fn withName(name)`](#fn-specservervolumesephemeralvolumeclaimtemplatespecdatasourcewithname)
            * [`obj spec.server.volumes.ephemeral.volumeClaimTemplate.spec.dataSourceRef`](#obj-specservervolumesephemeralvolumeclaimtemplatespecdatasourceref)
              * [`fn withApiGroup(apiGroup)`](#fn-specservervolumesephemeralvolumeclaimtemplatespecdatasourcerefwithapigroup)
              * [`fn withKind(kind)`](#fn-specservervolumesephemeralvolumeclaimtemplatespecdatasourcerefwithkind)
              * [`fn withName(name)`](#fn-specservervolumesephemeralvolumeclaimtemplatespecdatasourcerefwithname)
              * [`fn withNamespace(namespace)`](#fn-specservervolumesephemeralvolumeclaimtemplatespecdatasourcerefwithnamespace)
            * [`obj spec.server.volumes.ephemeral.volumeClaimTemplate.spec.resources`](#obj-specservervolumesephemeralvolumeclaimtemplatespecresources)
              * [`fn withClaims(claims)`](#fn-specservervolumesephemeralvolumeclaimtemplatespecresourceswithclaims)
              * [`fn withClaimsMixin(claims)`](#fn-specservervolumesephemeralvolumeclaimtemplatespecresourceswithclaimsmixin)
              * [`fn withLimits(limits)`](#fn-specservervolumesephemeralvolumeclaimtemplatespecresourceswithlimits)
              * [`fn withLimitsMixin(limits)`](#fn-specservervolumesephemeralvolumeclaimtemplatespecresourceswithlimitsmixin)
              * [`fn withRequests(requests)`](#fn-specservervolumesephemeralvolumeclaimtemplatespecresourceswithrequests)
              * [`fn withRequestsMixin(requests)`](#fn-specservervolumesephemeralvolumeclaimtemplatespecresourceswithrequestsmixin)
              * [`obj spec.server.volumes.ephemeral.volumeClaimTemplate.spec.resources.claims`](#obj-specservervolumesephemeralvolumeclaimtemplatespecresourcesclaims)
                * [`fn withName(name)`](#fn-specservervolumesephemeralvolumeclaimtemplatespecresourcesclaimswithname)
            * [`obj spec.server.volumes.ephemeral.volumeClaimTemplate.spec.selector`](#obj-specservervolumesephemeralvolumeclaimtemplatespecselector)
              * [`fn withMatchExpressions(matchExpressions)`](#fn-specservervolumesephemeralvolumeclaimtemplatespecselectorwithmatchexpressions)
              * [`fn withMatchExpressionsMixin(matchExpressions)`](#fn-specservervolumesephemeralvolumeclaimtemplatespecselectorwithmatchexpressionsmixin)
              * [`fn withMatchLabels(matchLabels)`](#fn-specservervolumesephemeralvolumeclaimtemplatespecselectorwithmatchlabels)
              * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specservervolumesephemeralvolumeclaimtemplatespecselectorwithmatchlabelsmixin)
              * [`obj spec.server.volumes.ephemeral.volumeClaimTemplate.spec.selector.matchExpressions`](#obj-specservervolumesephemeralvolumeclaimtemplatespecselectormatchexpressions)
                * [`fn withKey(key)`](#fn-specservervolumesephemeralvolumeclaimtemplatespecselectormatchexpressionswithkey)
                * [`fn withOperator(operator)`](#fn-specservervolumesephemeralvolumeclaimtemplatespecselectormatchexpressionswithoperator)
                * [`fn withValues(values)`](#fn-specservervolumesephemeralvolumeclaimtemplatespecselectormatchexpressionswithvalues)
                * [`fn withValuesMixin(values)`](#fn-specservervolumesephemeralvolumeclaimtemplatespecselectormatchexpressionswithvaluesmixin)
      * [`obj spec.server.volumes.fc`](#obj-specservervolumesfc)
        * [`fn withFsType(fsType)`](#fn-specservervolumesfcwithfstype)
        * [`fn withLun(lun)`](#fn-specservervolumesfcwithlun)
        * [`fn withReadOnly(readOnly)`](#fn-specservervolumesfcwithreadonly)
        * [`fn withTargetWWNs(targetWWNs)`](#fn-specservervolumesfcwithtargetwwns)
        * [`fn withTargetWWNsMixin(targetWWNs)`](#fn-specservervolumesfcwithtargetwwnsmixin)
        * [`fn withWwids(wwids)`](#fn-specservervolumesfcwithwwids)
        * [`fn withWwidsMixin(wwids)`](#fn-specservervolumesfcwithwwidsmixin)
      * [`obj spec.server.volumes.flexVolume`](#obj-specservervolumesflexvolume)
        * [`fn withDriver(driver)`](#fn-specservervolumesflexvolumewithdriver)
        * [`fn withFsType(fsType)`](#fn-specservervolumesflexvolumewithfstype)
        * [`fn withOptions(options)`](#fn-specservervolumesflexvolumewithoptions)
        * [`fn withOptionsMixin(options)`](#fn-specservervolumesflexvolumewithoptionsmixin)
        * [`fn withReadOnly(readOnly)`](#fn-specservervolumesflexvolumewithreadonly)
        * [`obj spec.server.volumes.flexVolume.secretRef`](#obj-specservervolumesflexvolumesecretref)
          * [`fn withName(name)`](#fn-specservervolumesflexvolumesecretrefwithname)
      * [`obj spec.server.volumes.flocker`](#obj-specservervolumesflocker)
        * [`fn withDatasetName(datasetName)`](#fn-specservervolumesflockerwithdatasetname)
        * [`fn withDatasetUUID(datasetUUID)`](#fn-specservervolumesflockerwithdatasetuuid)
      * [`obj spec.server.volumes.gcePersistentDisk`](#obj-specservervolumesgcepersistentdisk)
        * [`fn withFsType(fsType)`](#fn-specservervolumesgcepersistentdiskwithfstype)
        * [`fn withPartition(partition)`](#fn-specservervolumesgcepersistentdiskwithpartition)
        * [`fn withPdName(pdName)`](#fn-specservervolumesgcepersistentdiskwithpdname)
        * [`fn withReadOnly(readOnly)`](#fn-specservervolumesgcepersistentdiskwithreadonly)
      * [`obj spec.server.volumes.gitRepo`](#obj-specservervolumesgitrepo)
        * [`fn withDirectory(directory)`](#fn-specservervolumesgitrepowithdirectory)
        * [`fn withRepository(repository)`](#fn-specservervolumesgitrepowithrepository)
        * [`fn withRevision(revision)`](#fn-specservervolumesgitrepowithrevision)
      * [`obj spec.server.volumes.glusterfs`](#obj-specservervolumesglusterfs)
        * [`fn withEndpoints(endpoints)`](#fn-specservervolumesglusterfswithendpoints)
        * [`fn withPath(path)`](#fn-specservervolumesglusterfswithpath)
        * [`fn withReadOnly(readOnly)`](#fn-specservervolumesglusterfswithreadonly)
      * [`obj spec.server.volumes.hostPath`](#obj-specservervolumeshostpath)
        * [`fn withPath(path)`](#fn-specservervolumeshostpathwithpath)
        * [`fn withType(type)`](#fn-specservervolumeshostpathwithtype)
      * [`obj spec.server.volumes.iscsi`](#obj-specservervolumesiscsi)
        * [`fn withChapAuthDiscovery(chapAuthDiscovery)`](#fn-specservervolumesiscsiwithchapauthdiscovery)
        * [`fn withChapAuthSession(chapAuthSession)`](#fn-specservervolumesiscsiwithchapauthsession)
        * [`fn withFsType(fsType)`](#fn-specservervolumesiscsiwithfstype)
        * [`fn withInitiatorName(initiatorName)`](#fn-specservervolumesiscsiwithinitiatorname)
        * [`fn withIqn(iqn)`](#fn-specservervolumesiscsiwithiqn)
        * [`fn withIscsiInterface(iscsiInterface)`](#fn-specservervolumesiscsiwithiscsiinterface)
        * [`fn withLun(lun)`](#fn-specservervolumesiscsiwithlun)
        * [`fn withPortals(portals)`](#fn-specservervolumesiscsiwithportals)
        * [`fn withPortalsMixin(portals)`](#fn-specservervolumesiscsiwithportalsmixin)
        * [`fn withReadOnly(readOnly)`](#fn-specservervolumesiscsiwithreadonly)
        * [`fn withTargetPortal(targetPortal)`](#fn-specservervolumesiscsiwithtargetportal)
        * [`obj spec.server.volumes.iscsi.secretRef`](#obj-specservervolumesiscsisecretref)
          * [`fn withName(name)`](#fn-specservervolumesiscsisecretrefwithname)
      * [`obj spec.server.volumes.nfs`](#obj-specservervolumesnfs)
        * [`fn withPath(path)`](#fn-specservervolumesnfswithpath)
        * [`fn withReadOnly(readOnly)`](#fn-specservervolumesnfswithreadonly)
        * [`fn withServer(server)`](#fn-specservervolumesnfswithserver)
      * [`obj spec.server.volumes.persistentVolumeClaim`](#obj-specservervolumespersistentvolumeclaim)
        * [`fn withClaimName(claimName)`](#fn-specservervolumespersistentvolumeclaimwithclaimname)
        * [`fn withReadOnly(readOnly)`](#fn-specservervolumespersistentvolumeclaimwithreadonly)
      * [`obj spec.server.volumes.photonPersistentDisk`](#obj-specservervolumesphotonpersistentdisk)
        * [`fn withFsType(fsType)`](#fn-specservervolumesphotonpersistentdiskwithfstype)
        * [`fn withPdID(pdID)`](#fn-specservervolumesphotonpersistentdiskwithpdid)
      * [`obj spec.server.volumes.portworxVolume`](#obj-specservervolumesportworxvolume)
        * [`fn withFsType(fsType)`](#fn-specservervolumesportworxvolumewithfstype)
        * [`fn withReadOnly(readOnly)`](#fn-specservervolumesportworxvolumewithreadonly)
        * [`fn withVolumeID(volumeID)`](#fn-specservervolumesportworxvolumewithvolumeid)
      * [`obj spec.server.volumes.projected`](#obj-specservervolumesprojected)
        * [`fn withDefaultMode(defaultMode)`](#fn-specservervolumesprojectedwithdefaultmode)
        * [`fn withSources(sources)`](#fn-specservervolumesprojectedwithsources)
        * [`fn withSourcesMixin(sources)`](#fn-specservervolumesprojectedwithsourcesmixin)
        * [`obj spec.server.volumes.projected.sources`](#obj-specservervolumesprojectedsources)
          * [`obj spec.server.volumes.projected.sources.configMap`](#obj-specservervolumesprojectedsourcesconfigmap)
            * [`fn withItems(items)`](#fn-specservervolumesprojectedsourcesconfigmapwithitems)
            * [`fn withItemsMixin(items)`](#fn-specservervolumesprojectedsourcesconfigmapwithitemsmixin)
            * [`fn withName(name)`](#fn-specservervolumesprojectedsourcesconfigmapwithname)
            * [`fn withOptional(optional)`](#fn-specservervolumesprojectedsourcesconfigmapwithoptional)
            * [`obj spec.server.volumes.projected.sources.configMap.items`](#obj-specservervolumesprojectedsourcesconfigmapitems)
              * [`fn withKey(key)`](#fn-specservervolumesprojectedsourcesconfigmapitemswithkey)
              * [`fn withMode(mode)`](#fn-specservervolumesprojectedsourcesconfigmapitemswithmode)
              * [`fn withPath(path)`](#fn-specservervolumesprojectedsourcesconfigmapitemswithpath)
          * [`obj spec.server.volumes.projected.sources.downwardAPI`](#obj-specservervolumesprojectedsourcesdownwardapi)
            * [`fn withItems(items)`](#fn-specservervolumesprojectedsourcesdownwardapiwithitems)
            * [`fn withItemsMixin(items)`](#fn-specservervolumesprojectedsourcesdownwardapiwithitemsmixin)
            * [`obj spec.server.volumes.projected.sources.downwardAPI.items`](#obj-specservervolumesprojectedsourcesdownwardapiitems)
              * [`fn withMode(mode)`](#fn-specservervolumesprojectedsourcesdownwardapiitemswithmode)
              * [`fn withPath(path)`](#fn-specservervolumesprojectedsourcesdownwardapiitemswithpath)
              * [`obj spec.server.volumes.projected.sources.downwardAPI.items.fieldRef`](#obj-specservervolumesprojectedsourcesdownwardapiitemsfieldref)
                * [`fn withApiVersion(apiVersion)`](#fn-specservervolumesprojectedsourcesdownwardapiitemsfieldrefwithapiversion)
                * [`fn withFieldPath(fieldPath)`](#fn-specservervolumesprojectedsourcesdownwardapiitemsfieldrefwithfieldpath)
              * [`obj spec.server.volumes.projected.sources.downwardAPI.items.resourceFieldRef`](#obj-specservervolumesprojectedsourcesdownwardapiitemsresourcefieldref)
                * [`fn withContainerName(containerName)`](#fn-specservervolumesprojectedsourcesdownwardapiitemsresourcefieldrefwithcontainername)
                * [`fn withDivisor(divisor)`](#fn-specservervolumesprojectedsourcesdownwardapiitemsresourcefieldrefwithdivisor)
                * [`fn withResource(resource)`](#fn-specservervolumesprojectedsourcesdownwardapiitemsresourcefieldrefwithresource)
          * [`obj spec.server.volumes.projected.sources.secret`](#obj-specservervolumesprojectedsourcessecret)
            * [`fn withItems(items)`](#fn-specservervolumesprojectedsourcessecretwithitems)
            * [`fn withItemsMixin(items)`](#fn-specservervolumesprojectedsourcessecretwithitemsmixin)
            * [`fn withName(name)`](#fn-specservervolumesprojectedsourcessecretwithname)
            * [`fn withOptional(optional)`](#fn-specservervolumesprojectedsourcessecretwithoptional)
            * [`obj spec.server.volumes.projected.sources.secret.items`](#obj-specservervolumesprojectedsourcessecretitems)
              * [`fn withKey(key)`](#fn-specservervolumesprojectedsourcessecretitemswithkey)
              * [`fn withMode(mode)`](#fn-specservervolumesprojectedsourcessecretitemswithmode)
              * [`fn withPath(path)`](#fn-specservervolumesprojectedsourcessecretitemswithpath)
          * [`obj spec.server.volumes.projected.sources.serviceAccountToken`](#obj-specservervolumesprojectedsourcesserviceaccounttoken)
            * [`fn withAudience(audience)`](#fn-specservervolumesprojectedsourcesserviceaccounttokenwithaudience)
            * [`fn withExpirationSeconds(expirationSeconds)`](#fn-specservervolumesprojectedsourcesserviceaccounttokenwithexpirationseconds)
            * [`fn withPath(path)`](#fn-specservervolumesprojectedsourcesserviceaccounttokenwithpath)
      * [`obj spec.server.volumes.quobyte`](#obj-specservervolumesquobyte)
        * [`fn withGroup(group)`](#fn-specservervolumesquobytewithgroup)
        * [`fn withReadOnly(readOnly)`](#fn-specservervolumesquobytewithreadonly)
        * [`fn withRegistry(registry)`](#fn-specservervolumesquobytewithregistry)
        * [`fn withTenant(tenant)`](#fn-specservervolumesquobytewithtenant)
        * [`fn withUser(user)`](#fn-specservervolumesquobytewithuser)
        * [`fn withVolume(volume)`](#fn-specservervolumesquobytewithvolume)
      * [`obj spec.server.volumes.rbd`](#obj-specservervolumesrbd)
        * [`fn withFsType(fsType)`](#fn-specservervolumesrbdwithfstype)
        * [`fn withImage(image)`](#fn-specservervolumesrbdwithimage)
        * [`fn withKeyring(keyring)`](#fn-specservervolumesrbdwithkeyring)
        * [`fn withMonitors(monitors)`](#fn-specservervolumesrbdwithmonitors)
        * [`fn withMonitorsMixin(monitors)`](#fn-specservervolumesrbdwithmonitorsmixin)
        * [`fn withPool(pool)`](#fn-specservervolumesrbdwithpool)
        * [`fn withReadOnly(readOnly)`](#fn-specservervolumesrbdwithreadonly)
        * [`fn withUser(user)`](#fn-specservervolumesrbdwithuser)
        * [`obj spec.server.volumes.rbd.secretRef`](#obj-specservervolumesrbdsecretref)
          * [`fn withName(name)`](#fn-specservervolumesrbdsecretrefwithname)
      * [`obj spec.server.volumes.scaleIO`](#obj-specservervolumesscaleio)
        * [`fn withFsType(fsType)`](#fn-specservervolumesscaleiowithfstype)
        * [`fn withGateway(gateway)`](#fn-specservervolumesscaleiowithgateway)
        * [`fn withProtectionDomain(protectionDomain)`](#fn-specservervolumesscaleiowithprotectiondomain)
        * [`fn withReadOnly(readOnly)`](#fn-specservervolumesscaleiowithreadonly)
        * [`fn withSslEnabled(sslEnabled)`](#fn-specservervolumesscaleiowithsslenabled)
        * [`fn withStorageMode(storageMode)`](#fn-specservervolumesscaleiowithstoragemode)
        * [`fn withStoragePool(storagePool)`](#fn-specservervolumesscaleiowithstoragepool)
        * [`fn withSystem(system)`](#fn-specservervolumesscaleiowithsystem)
        * [`fn withVolumeName(volumeName)`](#fn-specservervolumesscaleiowithvolumename)
        * [`obj spec.server.volumes.scaleIO.secretRef`](#obj-specservervolumesscaleiosecretref)
          * [`fn withName(name)`](#fn-specservervolumesscaleiosecretrefwithname)
      * [`obj spec.server.volumes.secret`](#obj-specservervolumessecret)
        * [`fn withDefaultMode(defaultMode)`](#fn-specservervolumessecretwithdefaultmode)
        * [`fn withItems(items)`](#fn-specservervolumessecretwithitems)
        * [`fn withItemsMixin(items)`](#fn-specservervolumessecretwithitemsmixin)
        * [`fn withOptional(optional)`](#fn-specservervolumessecretwithoptional)
        * [`fn withSecretName(secretName)`](#fn-specservervolumessecretwithsecretname)
        * [`obj spec.server.volumes.secret.items`](#obj-specservervolumessecretitems)
          * [`fn withKey(key)`](#fn-specservervolumessecretitemswithkey)
          * [`fn withMode(mode)`](#fn-specservervolumessecretitemswithmode)
          * [`fn withPath(path)`](#fn-specservervolumessecretitemswithpath)
      * [`obj spec.server.volumes.storageos`](#obj-specservervolumesstorageos)
        * [`fn withFsType(fsType)`](#fn-specservervolumesstorageoswithfstype)
        * [`fn withReadOnly(readOnly)`](#fn-specservervolumesstorageoswithreadonly)
        * [`fn withVolumeName(volumeName)`](#fn-specservervolumesstorageoswithvolumename)
        * [`fn withVolumeNamespace(volumeNamespace)`](#fn-specservervolumesstorageoswithvolumenamespace)
        * [`obj spec.server.volumes.storageos.secretRef`](#obj-specservervolumesstorageossecretref)
          * [`fn withName(name)`](#fn-specservervolumesstorageossecretrefwithname)
      * [`obj spec.server.volumes.vsphereVolume`](#obj-specservervolumesvspherevolume)
        * [`fn withFsType(fsType)`](#fn-specservervolumesvspherevolumewithfstype)
        * [`fn withStoragePolicyID(storagePolicyID)`](#fn-specservervolumesvspherevolumewithstoragepolicyid)
        * [`fn withStoragePolicyName(storagePolicyName)`](#fn-specservervolumesvspherevolumewithstoragepolicyname)
        * [`fn withVolumePath(volumePath)`](#fn-specservervolumesvspherevolumewithvolumepath)
  * [`obj spec.sso`](#obj-specsso)
    ...
    * [`obj spec.sso.dex`](#obj-specssodex)
      ...
      * [`fn withEnv(env)`](#fn-specssodexwithenv)
      * [`fn withEnvMixin(env)`](#fn-specssodexwithenvmixin)
      ...
      * [`obj spec.sso.dex.env`](#obj-specssodexenv)
        * [`fn withName(name)`](#fn-specssodexenvwithname)
        * [`fn withValue(value)`](#fn-specssodexenvwithvalue)
        * [`obj spec.sso.dex.env.valueFrom`](#obj-specssodexenvvaluefrom)
          * [`obj spec.sso.dex.env.valueFrom.configMapKeyRef`](#obj-specssodexenvvaluefromconfigmapkeyref)
            * [`fn withKey(key)`](#fn-specssodexenvvaluefromconfigmapkeyrefwithkey)
            * [`fn withName(name)`](#fn-specssodexenvvaluefromconfigmapkeyrefwithname)
            * [`fn withOptional(optional)`](#fn-specssodexenvvaluefromconfigmapkeyrefwithoptional)
          * [`obj spec.sso.dex.env.valueFrom.fieldRef`](#obj-specssodexenvvaluefromfieldref)
            * [`fn withApiVersion(apiVersion)`](#fn-specssodexenvvaluefromfieldrefwithapiversion)
            * [`fn withFieldPath(fieldPath)`](#fn-specssodexenvvaluefromfieldrefwithfieldpath)
          * [`obj spec.sso.dex.env.valueFrom.resourceFieldRef`](#obj-specssodexenvvaluefromresourcefieldref)
            * [`fn withContainerName(containerName)`](#fn-specssodexenvvaluefromresourcefieldrefwithcontainername)
            * [`fn withDivisor(divisor)`](#fn-specssodexenvvaluefromresourcefieldrefwithdivisor)
            * [`fn withResource(resource)`](#fn-specssodexenvvaluefromresourcefieldrefwithresource)
          * [`obj spec.sso.dex.env.valueFrom.secretKeyRef`](#obj-specssodexenvvaluefromsecretkeyref)
            * [`fn withKey(key)`](#fn-specssodexenvvaluefromsecretkeyrefwithkey)
            * [`fn withName(name)`](#fn-specssodexenvvaluefromsecretkeyrefwithname)
            * [`fn withOptional(optional)`](#fn-specssodexenvvaluefromsecretkeyrefwithoptional)
